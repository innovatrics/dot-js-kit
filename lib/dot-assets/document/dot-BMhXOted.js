const Ir = /* @__PURE__ */ Symbol("Comlink.proxy"), Co = /* @__PURE__ */ Symbol("Comlink.endpoint"), ko = /* @__PURE__ */ Symbol("Comlink.releaseProxy"), We = /* @__PURE__ */ Symbol("Comlink.finalizer"), Ve = /* @__PURE__ */ Symbol("Comlink.thrown"), jr = (y) => typeof y == "object" && y !== null || typeof y == "function", To = {
  canHandle: (y) => jr(y) && y[Ir],
  serialize(y) {
  ...
  canHandle: (y) => jr(y) && Ve in y,
  serialize({ value: y }) {
    let s;
    return y instanceof Error ? s = {
      isError: !0,
      value: {
        message: y.message,
        name: y.name,
...
function yt(y, s = globalThis, r = ["*"]) {
  s.addEventListener("message", function t(e) {
    ...
    let g;
    try {
      const j = u.slice(0, -1).reduce((v, I) => v[I], y), h = u.reduce((v, I) => v[I], y);
      switch (o) {
        case "GET":
          g = h;
          break;
        case "SET":
          j[u.slice(-1)[0]] = ce(e.data.value), g = !0;
          break;
        case "APPLY":
          g = h.apply(j, a);
          break;
    ...
    Promise.resolve(g).catch((j) => ({ value: j, [Ve]: 0 })).then((j) => {
      const [h, v] = Ge(j);
      s.postMessage(Object.assign(Object.assign({}, h), { id: n }), v), o === "RELEASE" && (s.removeEventListener("message", t), Cr(s), We in y && typeof y[We] == "function" && y[We]());
    }).catch((j) => {
      const [h, v] = Ge({
...
const ze = /* @__PURE__ */ new WeakMap(), Ue = "FinalizationRegistry" in globalThis && new FinalizationRegistry((y) => {
  const s = (ze.get(y) || 0) - 1;
  ze.set(y, s), s === 0 && kr(y);
});
function Ro(y, s) {
  const r = (ze.get(s) || 0) + 1;
  ze.set(s, r), Ue && Ue.register(y, s, y);
}
function Lo(y) {
  Ue && Ue.unregister(y);
}
function mt(y, s, r = [], t = function() {
}) {
  let e = !1;
  const n = new Proxy(t, {
    get(o, u) {
...
function ce(y) {
  switch (y.type) {
    case "HANDLER":
      return Sr.get(y.name).deserialize(y.value);
    case "RAW":
      return y.value;
  }
}
function ge(y, s, r, t) {
  return new Promise((e) => {
    const n = No();
    s.set(n, e), y.start && y.start(), y.postMessage(Object.assign({ id: n }, r), t);
  });
}
function No() {
...
class Uo {
  ...
  async getOptimalRegionForCompressionDetectionFromDetectionCorners(s, r, t) {
    ...
    const e = this.convertToSamColorImage(s, r), { bottomLeft: n, topLeft: o, topRight: u } = t, a = [
      ...
      n.y - o.y
      // height
    ], { height: g, width: j, x: h, y: v } = await this.samWasmModule.selectDetailRegion(
      r.width,
      r.height,
      e.bgr0ImagePointer,
      a
...
const Ne = (y, s) => Math.hypot(s.x - y.x, s.y - y.y), Go = (y) => {
  const { bottomLeft: s, bottomRight: r, topLeft: t, topRight: e } = y, n = Ne(t, e), o = Ne(e, r), u = Ne(s, r), a = Ne(t, s);
  return Math.min(n, o, u, a);
};
var ye = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Xt = {}, rt = {}, nt, Qt;
function $o() {
  if (Qt) return nt;
  Qt = 1, nt = y;
  function y(s, r) {
...
function Bo() {
  return tr || (tr = 1, (function(y) {
    ...
    s.encode = function(o, u, a) {
      for (var g = null, j = [], h = 0, v = 0, I; u < a; ) {
        var S = o[u++];
        switch (v) {
          case 0:
        ...
        h > 8191 && ((g || (g = [])).push(String.fromCharCode.apply(String, j)), h = 0);
      }
      return v && (j[h++] = r[I], j[h++] = 61, v === 1 && (j[h++] = 61)), g ? (h && g.push(String.fromCharCode.apply(String, j.slice(0, h))), g.join("")) : String.fromCharCode.apply(String, j.slice(0, h));
    };
    var n = "invalid encoding";
    s.decode = function(o, u, a) {
      for (var g = a, j = 0, h, v = 0; v < o.length; ) {
...
function Ho() {
  ...
  return y.prototype.on = function(s, r, t) {
    return (this._listeners[s] || (this._listeners[s] = [])).push({
      fn: r,
      ctx: t || this
    }), this;
  }, y.prototype.off = function(s, r) {
    if (s === void 0)
      this._listeners = {};
    else if (r === void 0)
      this._listeners[s] = [];
...
function Yo() {
  ...
  function y(n) {
    return typeof Float32Array < "u" ? (function() {
      ...
      n.writeFloatLE = a ? g : j, n.writeFloatBE = a ? j : g;
      function h(I, S) {
      ...
      function o(a, g, j, h) {
        ...
        if (v && (g = -g), g === 0)
          ...
          a((v << 31 | Math.round(g / 1401298464324817e-60)) >>> 0, j, h);
        else {
          var I = Math.floor(Math.log(g) / Math.LN2), S = Math.round(g * Math.pow(2, -I) * 8388608) & 8388607;
          a((v << 31 | I + 127 << 23 | S) >>> 0, j, h);
        }
      }
      n.writeFloatLE = o.bind(null, s), n.writeFloatBE = o.bind(null, r);
      function u(a, g, j) {
        var h = a(g, j), v = (h >> 31) * 2 + 1, I = h >>> 23 & 255, S = h & 8388607;
      ...
      n.writeDoubleLE = a ? g : j, n.writeDoubleBE = a ? j : g;
      function h(I, S) {
      ...
      function o(a, g, j, h, v, I) {
        ...
        if (S && (h = -h), h === 0)
          ...
          a(0, v, I + g), a(2146959360, v, I + j);
        else if (h > 17976931348623157e292)
          a(0, v, I + g), a((S << 31 | 2146435072) >>> 0, v, I + j);
        else {
          var R;
          if (h < 22250738585072014e-324)
            R = h / 5e-324, a(R >>> 0, v, I + g), a((S << 31 | R / 4294967296) >>> 0, v, I + j);
          else {
            var P = Math.floor(Math.log(h) / Math.LN2);
            P === 1024 && (P = 1023), R = h * Math.pow(2, -P), a(R * 4503599627370496 >>> 0, v, I + g), a((S << 31 | P + 1023 << 20 | R * 1048576 & 1048575) >>> 0, v, I + j);
          }
        }
      }
      n.writeDoubleLE = o.bind(null, s, 0, 4), n.writeDoubleBE = o.bind(null, r, 4, 0);
      function u(a, g, j, h, v) {
        var I = a(h, v + g), S = a(h, v + j), R = (S >> 31) * 2 + 1, P = S >>> 20 & 2047, D = 4294967296 * (S & 1048575) + I;
        return P === 2047 ? D ? NaN : R * (1 / 0) : P === 0 ? R * 5e-324 * D : R * Math.pow(2, P - 1075) * (D + 4503599627370496);
      }
  ...
  return sr || (sr = 1, (function(y) {
    ...
    s.length = function(r) {
      ...
      for (var o = null, u = [], a = 0, g; t < e; )
        g = r[t++], g < 128 ? u[a++] = g : g > 191 && g < 224 ? u[a++] = (g & 31) << 6 | r[t++] & 63 : g > 239 && g < 365 ? (g = ((g & 7) << 18 | (r[t++] & 63) << 12 | (r[t++] & 63) << 6 | r[t++] & 63) - 65536, u[a++] = 55296 + (g >> 10), u[a++] = 56320 + (g & 1023)) : u[a++] = (g & 15) << 12 | (r[t++] & 63) << 6 | r[t++] & 63, a > 8191 && ((o || (o = [])).push(String.fromCharCode.apply(String, u)), a = 0);
...
var ur;
function ue() {
  return ur || (ur = 1, (function(y) {
    var s = y;
    s.asPromise = $o(), s.base64 = Bo(), s.EventEmitter = Ho(), s.float = Yo(), s.inquire = Jo(), s.utf8 = Zo(), s.pool = Ko(), s.LongBits = qo(), s.isNode = !!(typeof ye < "u" && ye && ye.process && ye.process.versions && ye.process.versions.node), s.global = s.isNode && ye || typeof window < "u" && window || typeof self < "u" && self || rt, s.emptyArray = Object.freeze ? Object.freeze([]) : (
...
function Dr() {
  if (dr) return ct;
  dr = 1, ct = a;
  var y = ue(), s, r = y.LongBits, t = y.base64, e = y.utf8;
  function n(P, D, F) {
    this.fn = P, this.len = D, this.next = void 0, this.val = F;
  }
  function o() {
  }
  function u(P) {
  ...
  a.create = g(), a.alloc = function(P) {
    return new y.Array(P);
  }, y.Array !== Array && (a.alloc = y.pool(a.alloc, y.Array.prototype.subarray)), a.prototype._push = function(P, D, F) {
    return this.tail = this.tail.next = new n(P, D, F), this.len += D, this;
  };
  function j(P, D, F) {
    D[F] = P & 255;
  }
  ...
  function I(P, D, F) {
    for (; P.hi; )
      D[F++] = P.lo & 127 | 128, P.lo = (P.lo >>> 7 | P.hi << 25) >>> 0, P.hi >>>= 7;
    for (; P.lo > 127; )
      D[F++] = P.lo & 127 | 128, P.lo = P.lo >>> 7;
    D[F++] = P.lo;
  }
  a.prototype.uint64 = function(P) {
    ...
    var D = r.from(P).zzEncode();
    return this._push(I, D.length(), D);
  }, a.prototype.bool = function(P) {
    return this._push(j, 1, P ? 1 : 0);
  };
  function S(P, D, F) {
    D[F] = P & 255, D[F + 1] = P >>> 8 & 255, D[F + 2] = P >>> 16 & 255, D[F + 3] = P >>> 24;
  }
  a.prototype.fixed32 = function(P) {
    ...
    var D = r.from(P);
    return this._push(S, 4, D.lo)._push(S, 4, D.hi);
  }, a.prototype.sfixed64 = a.prototype.fixed64, a.prototype.float = function(P) {
    return this._push(y.float.writeFloatLE, 4, P);
  }, a.prototype.double = function(P) {
    return this._push(y.float.writeDoubleLE, 8, P);
  };
  var R = y.Array.prototype.set ? function(P, D, F) {
    D.set(P, F);
  } : function(P, D, F) {
  ...
  return a.prototype.bytes = function(P) {
    ...
    if (y.isString(P)) {
      var F = a.alloc(D = t.length(P));
      t.decode(P, F, 0), P = F;
    }
    return this.uint32(D)._push(R, D, P);
  }, a.prototype.string = function(P) {
    var D = e.length(P);
    return D ? this.uint32(D)._push(e.write, D, P) : this._push(j, 1, 0);
    ...
    var P = this.head, D = this.tail, F = this.len;
    return this.reset().uint32(F), F && (this.tail.next = P.next, this.tail = D, this.len += F), this;
  }, a.prototype.finish = function() {
    for (var P = this.head.next, D = this.constructor.alloc(this.len), F = 0; P; )
      P.fn(P.val, D, F), F += P.len, P = P.next;
    return D;
  }, a._configure = function(P) {
    s = P, a.create = g(), s._configure();
  }, ct;
}
var ut, pr;
function Xo() {
...
function Ar() {
  if (fr) return dt;
  fr = 1, dt = n;
  var y = ue(), s, r = y.LongBits, t = y.utf8;
  function e(h, v) {
  ...
  var o = typeof Uint8Array < "u" ? function(h) {
    ...
    return y.Buffer ? function(h) {
      return (n.create = function(v) {
        return y.Buffer.isBuffer(v) ? new s(v) : o(v);
      })(h);
    } : o;
  };
  ...
  return n.prototype.float = function() {
    if (this.pos + 4 > this.len)
      throw e(this, 4);
    var h = y.float.readFloatLE(this.buf, this.pos);
    return this.pos += 4, h;
  }, n.prototype.double = function() {
    if (this.pos + 8 > this.len)
      throw e(this, 4);
    var h = y.float.readDoubleLE(this.buf, this.pos);
    return this.pos += 8, h;
...
function ei() {
  ...
  gr = 1, ft = s;
  var y = ue();
  (s.prototype = Object.create(y.EventEmitter.prototype)).constructor = s;
  function s(r, t, e) {
  ...
  return s.prototype.rpcCall = function r(t, e, n, o, u) {
    ...
    var a = this;
    if (!u)
      return y.asPromise(r, a, t, e, n, o);
    if (!a.rpcImpl) {
      setTimeout(function() {
...
function ni() {
  return Or || (Or = 1, (function(y) {
    var s = y;
    s.build = "minimal", s.Writer = Dr(), s.BufferWriter = Xo(), s.Reader = Ar(), s.BufferReader = Qo(), s.util = ue(), s.rpc = ti(), s.roots = ri(), s.configure = r;
    function r() {
...
var T = oi();
const f = T.Reader, E = T.Writer, d = T.util, i = T.roots.default || (T.roots.default = {});
i.dot = (() => {
  const y = {};
  return y.Content = (function() {
    ...
    return s.MagnifEyeLivenessContent = (function() {
      ...
      return Object.defineProperty(r.prototype, "_device", {
        ...
        e instanceof f || (e = f.create(e));
        let u = n === void 0 ? e.len : e.pos + n, a = new i.dot.v4.AndroidMetadata(), g, j;
        for (; e.pos < u; ) {
          let h = e.uint32();
          if (h === o)
            break;
          switch (h >>> 3) {
            ...
            case 4: {
              ...
              a.dynamicCameraFrameProperties[g] = j;
              break;
            }
            case 8: {
      ...
      r.prototype.cameraModelId = "", r.prototype.architectureInfo = d.emptyObject, r.prototype.camera = null, r.prototype.detectionNormalizedRectangle = null, r.prototype.digests = d.emptyArray, r.prototype.digestsWithTimestamp = d.emptyArray, r.prototype.isoValues = d.emptyArray, r.prototype.croppedYuv420Image = null, r.prototype.yuv420ImageCrop = null, r.prototype.identifierForVendor = null, r.prototype.tamperingIndicators = null;
      let t;
      return Object.defineProperty(r.prototype, "_camera", {
        ...
        return e.camera != null && Object.hasOwnProperty.call(e, "camera") && i.dot.v4.IosCamera.encode(e.camera, n.uint32(
          ...
          /* id 10, wireType 2 =*/
          82
        ).string(e.identifierForVendor), e.tamperingIndicators != null && Object.hasOwnProperty.call(e, "tamperingIndicators") && n.uint32(
          /* id 11, wireType 2 =*/
          90
        ).bytes(e.tamperingIndicators), n;
      }, r.encodeDelimited = function(e, n) {
        return this.encode(e, n).ldelim();
      }, r.decode = function(e, n, o) {
        e instanceof f || (e = f.create(e));
        let u = n === void 0 ? e.len : e.pos + n, a = new i.dot.v4.IosMetadata(), g, j;
        for (; e.pos < u; ) {
          let h = e.uint32();
          if (h === o)
            break;
          switch (h >>> 3) {
            ...
            case 10: {
              a.identifierForVendor = e.string();
              break;
            }
            case 11: {
              a.tamperingIndicators = e.bytes();
        ...
        return e.identifierForVendor != null && e.hasOwnProperty("identifierForVendor") && !d.isString(e.identifierForVendor) ? "identifierForVendor: string expected" : e.tamperingIndicators != null && e.hasOwnProperty("tamperingIndicators") && !(e.tamperingIndicators && typeof e.tamperingIndicators.length == "number" || d.isString(e.tamperingIndicators)) ? "tamperingIndicators: buffer expected" : null;
      }, r.fromObject = function(e) {
        ...
        return e.identifierForVendor != null && (n.identifierForVendor = String(e.identifierForVendor)), e.tamperingIndicators != null && (typeof e.tamperingIndicators == "string" ? d.base64.decode(e.tamperingIndicators, n.tamperingIndicators = d.newBuffer(d.base64.length(e.tamperingIndicators)), 0) : e.tamperingIndicators.length >= 0 && (n.tamperingIndicators = e.tamperingIndicators)), n;
      }, r.toObject = function(e, n) {
        n || (n = {});
        let o = {};
        ...
        return e.camera != null && e.hasOwnProperty("camera") && (o.camera = i.dot.v4.IosCamera.toObject(e.camera, n), n.oneofs && (o._camera = "camera")), e.detectionNormalizedRectangle != null && e.hasOwnProperty("detectionNormalizedRectangle") && (o.detectionNormalizedRectangle = i.dot.RectangleDouble.toObject(e.detectionNormalizedRectangle, n), n.oneofs && (o._detectionNormalizedRectangle = "detectionNormalizedRectangle")), e.croppedYuv420Image != null && e.hasOwnProperty("croppedYuv420Image") && (o.croppedYuv420Image = i.dot.v4.IosYuv420Image.toObject(e.croppedYuv420Image, n), n.oneofs && (o._croppedYuv420Image = "croppedYuv420Image")), e.yuv420ImageCrop != null && e.hasOwnProperty("yuv420ImageCrop") && (o.yuv420ImageCrop = i.dot.v4.IosYuv420ImageCrop.toObject(e.yuv420ImageCrop, n), n.oneofs && (o._yuv420ImageCrop = "yuv420ImageCrop")), e.identifierForVendor != null && e.hasOwnProperty("identifierForVendor") && (o.identifierForVendor = e.identifierForVendor, n.oneofs && (o._identifierForVendor = "identifierForVendor")), e.tamperingIndicators != null && e.hasOwnProperty("tamperingIndicators") && (o.tamperingIndicators = n.bytes === String ? d.base64.encode(e.tamperingIndicators, 0, e.tamperingIndicators.length) : n.bytes === Array ? Array.prototype.slice.call(e.tamperingIndicators) : e.tamperingIndicators, n.oneofs && (o._tamperingIndicators = "tamperingIndicators")), o;
      }, r.prototype.toJSON = function() {
        return this.constructor.toObject(this, T.util.toJSONOptions);
      }, r.getTypeUrl = function(e) {
      ...
      return Object.defineProperty(r.prototype, "_croppedImage", {
        ...
        if (e.croppedImage != null && Object.hasOwnProperty.call(e, "croppedImage") && i.dot.Image.encode(e.croppedImage, n.uint32(
          /* id 6, wireType 2 =*/
          50
          ...
          /* id 8, wireType 2 =*/
          66
        ).fork()).ldelim(), e.optCheckResults != null && e.optCheckResults.length)
          for (let o = 0; o < e.optCheckResults.length; ++o)
            i.dot.v4.CameraEvaluationResult.encode(e.optCheckResults[o], n.uint32(
              /* id 9, wireType 2 =*/
              74
            ).fork()).ldelim();
        return n;
        ...
        for (; e.pos < u; ) {
          ...
          switch (g >>> 3) {
            ...
            case 9: {
              a.optCheckResults && a.optCheckResults.length || (a.optCheckResults = []), a.optCheckResults.push(i.dot.v4.CameraEvaluationResult.decode(e, e.uint32()));
              break;
            }
            default:
              e.skipType(g & 7);
        ...
        if (e.optCheckResults != null && e.hasOwnProperty("optCheckResults")) {
          if (!Array.isArray(e.optCheckResults))
            return "optCheckResults: array expected";
          for (let n = 0; n < e.optCheckResults.length; ++n) {
            let o = i.dot.v4.CameraEvaluationResult.verify(e.optCheckResults[n]);
            if (o)
              return "optCheckResults." + o;
          }
        }
        return null;
      }, r.fromObject = function(e) {
        ...
        if (e.optCheckResults) {
          if (!Array.isArray(e.optCheckResults))
            throw TypeError(".dot.v4.WebMetadata.optCheckResults: array expected");
          n.optCheckResults = [];
          for (let o = 0; o < e.optCheckResults.length; ++o) {
            if (typeof e.optCheckResults[o] != "object")
              throw TypeError(".dot.v4.WebMetadata.optCheckResults: object expected");
            n.optCheckResults[o] = i.dot.v4.CameraEvaluationResult.fromObject(e.optCheckResults[o]);
          }
        }
        return n;
      }, r.toObject = function(e, n) {
        n || (n = {});
        let o = {};
        if ((n.arrays || n.defaults) && (o.availableCameraProperties = [], o.hashedDetectedImages = [], o.detectionRecord = [], o.hashedDetectedImagesWithTimestamp = [], o.optCheckResults = []), n.defaults && (o.currentCameraProperties = null), e.currentCameraProperties != null && e.hasOwnProperty("currentCameraProperties") && (o.currentCameraProperties = i.dot.v4.MediaTrackSettings.toObject(e.currentCameraProperties, n)), e.availableCameraProperties && e.availableCameraProperties.length) {
        ...
        if (e.croppedImage != null && e.hasOwnProperty("croppedImage") && (o.croppedImage = i.dot.Image.toObject(e.croppedImage, n), n.oneofs && (o._croppedImage = "croppedImage")), e.croppedImageWithPosition != null && e.hasOwnProperty("croppedImageWithPosition") && (o.croppedImageWithPosition = i.dot.v4.ImageCrop.toObject(e.croppedImageWithPosition, n), n.oneofs && (o._croppedImageWithPosition = "croppedImageWithPosition")), e.platformDetails != null && e.hasOwnProperty("platformDetails") && (o.platformDetails = i.dot.v4.PlatformDetails.toObject(e.platformDetails, n), n.oneofs && (o._platformDetails = "platformDetails")), e.optCheckResults && e.optCheckResults.length) {
          o.optCheckResults = [];
          for (let u = 0; u < e.optCheckResults.length; ++u)
            o.optCheckResults[u] = i.dot.v4.CameraEvaluationResult.toObject(e.optCheckResults[u], n);
        }
        return o;
      }, r.prototype.toJSON = function() {
        return this.constructor.toObject(this, T.util.toJSONOptions);
    ...
    })(), s.CameraEvaluationResult = (function() {
      function r(e) {
        if (e)
          for (let n = Object.keys(e), o = 0; o < n.length; ++o)
            e[n[o]] != null && (this[n[o]] = e[n[o]]);
      }
      r.prototype.optSetting = null, r.prototype.afterOpt = null, r.prototype.beforeOpt = null;
      let t;
      return Object.defineProperty(r.prototype, "_optSetting", {
        get: d.oneOfGetter(t = ["optSetting"]),
        set: d.oneOfSetter(t)
      }), Object.defineProperty(r.prototype, "_afterOpt", {
        get: d.oneOfGetter(t = ["afterOpt"]),
        set: d.oneOfSetter(t)
      }), Object.defineProperty(r.prototype, "_beforeOpt", {
        get: d.oneOfGetter(t = ["beforeOpt"]),
        set: d.oneOfSetter(t)
      }), r.create = function(e) {
        return new r(e);
      }, r.encode = function(e, n) {
        return n || (n = E.create()), e.optSetting != null && Object.hasOwnProperty.call(e, "optSetting") && n.uint32(
          /* id 1, wireType 2 =*/
          10
        ).string(e.optSetting), e.afterOpt != null && Object.hasOwnProperty.call(e, "afterOpt") && n.uint32(
          /* id 2, wireType 0 =*/
          16
        ).int32(e.afterOpt), e.beforeOpt != null && Object.hasOwnProperty.call(e, "beforeOpt") && n.uint32(
          /* id 3, wireType 0 =*/
          24
        ).int32(e.beforeOpt), n;
      }, r.encodeDelimited = function(e, n) {
        ...
        e instanceof f || (e = f.create(e));
        let u = n === void 0 ? e.len : e.pos + n, a = new i.dot.v4.CameraEvaluationResult();
        for (; e.pos < u; ) {
          let g = e.uint32();
          if (g === o)
            break;
        ...
        return typeof e != "object" || e === null ? "object expected" : e.optSetting != null && e.hasOwnProperty("optSetting") && !d.isString(e.optSetting) ? "optSetting: string expected" : e.afterOpt != null && e.hasOwnProperty("afterOpt") && !d.isInteger(e.afterOpt) ? "afterOpt: integer expected" : e.beforeOpt != null && e.hasOwnProperty("beforeOpt") && !d.isInteger(e.beforeOpt) ? "beforeOpt: integer expected" : null;
      }, r.fromObject = function(e) {
        if (e instanceof i.dot.v4.CameraEvaluationResult)
          return e;
        let n = new i.dot.v4.CameraEvaluationResult();
        return e.optSetting != null && (n.optSetting = String(e.optSetting)), e.afterOpt != null && (n.afterOpt = e.afterOpt | 0), e.beforeOpt != null && (n.beforeOpt = e.beforeOpt | 0), n;
      }, r.toObject = function(e, n) {
        n || (n = {});
        let o = {};
        return e.optSetting != null && e.hasOwnProperty("optSetting") && (o.optSetting = e.optSetting, n.oneofs && (o._optSetting = "optSetting")), e.afterOpt != null && e.hasOwnProperty("afterOpt") && (o.afterOpt = e.afterOpt, n.oneofs && (o._afterOpt = "afterOpt")), e.beforeOpt != null && e.hasOwnProperty("beforeOpt") && (o.beforeOpt = e.beforeOpt, n.oneofs && (o._beforeOpt = "beforeOpt")), o;
      }, r.prototype.toJSON = function() {
        return this.constructor.toObject(this, T.util.toJSONOptions);
      }, r.getTypeUrl = function(e) {
        return e === void 0 && (e = "type.googleapis.com"), e + "/dot.v4.CameraEvaluationResult";
      }, r;
      ...
      return r.prototype.lds1eMrtdApplication = null, r.create = function(t) {
        ...
        for (; t.pos < o; ) {
          ...
          if (a === n)
            break;
          a >>> 3 === 1 ? u.lds1eMrtdApplication = i.dot.v4.Lds1eMrtdApplication.decode(t, t.uint32()) : t.skipType(a & 7);
        }
        return u;
      }, r.decodeDelimited = function(t) {
        return t instanceof f || (t = new f(t)), this.decode(t, t.uint32());
      ...
      return r.prototype.detections = d.emptyArray, r.create = function(t) {
        ...
        for (; t.pos < o; ) {
          ...
          if (a === n)
            break;
          a >>> 3 === 1 ? (u.detections && u.detections.length || (u.detections = []), u.detections.push(i.dot.v4.FaceDetection.decode(t, t.uint32()))) : t.skipType(a & 7);
        }
        return u;
      }, r.decodeDelimited = function(t) {
        return t instanceof f || (t = new f(t)), this.decode(t, t.uint32());
    ...
    s.prototype.bytes = null, s.prototype.containerMp4 = null, s.prototype.streamH264 = null;
    let r;
    return Object.defineProperty(s.prototype, "_bytes", {
      get: d.oneOfGetter(r = ["bytes"]),
      set: d.oneOfSetter(r)
    }), Object.defineProperty(s.prototype, "content", {
    ...
    return s.prototype.bytes = d.newBuffer([]), s.prototype.frameRate = 0, s.create = function(r) {
      return new s(r);
    }, s.encode = function(r, t) {
      return t || (t = E.create()), r.bytes != null && Object.hasOwnProperty.call(r, "bytes") && t.uint32(
        /* id 1, wireType 2 =*/
...
var ii = (() => {
  ...
  return (async function(s = {}) {
    ...
    var g = Object.assign({}, t), j = "./this.program", h = (c, l) => {
      throw l;
    }, v = "";
    function I(c) {
    ...
    var S, R;
    (u || a) && (a ? v = self.location.href : typeof document < "u" && document.currentScript && (v = document.currentScript.src), y && (v = y), v.startsWith("blob:") ? v = "" : v = v.slice(0, v.replace(/[?#].*/, "").lastIndexOf("/") + 1), a && (R = (c) => {
    ...
    Object.assign(t, g), g = null, t.arguments && t.arguments, t.thisProgram && (j = t.thisProgram);
    var D = t.wasmBinary, F, B = !1, Ie, Z, G, de, he, te, N, gt, ht, bt, vt, Ot = (c) => c.startsWith("file://");
    function wt() {
      var c = F.buffer;
      t.HEAP8 = Z = new Int8Array(c), t.HEAP16 = de = new Int16Array(c), t.HEAPU8 = G = new Uint8Array(c), t.HEAPU16 = he = new Uint16Array(c), t.HEAP32 = te = new Int32Array(c), t.HEAPU32 = N = new Uint32Array(c), t.HEAPF32 = gt = new Float32Array(c), t.HEAPF64 = vt = new Float64Array(c), t.HEAP64 = ht = new BigInt64Array(c), t.HEAPU64 = bt = new BigUint64Array(c);
    }
    function Er() {
      if (t.preRun)
    ...
    function je(c) {
      t.onAbort?.(c), c = "Aborted(" + c + ")", P(c), B = !0, c += ". Build with -sASSERTIONS for more info.";
    ...
    async function Wr(c, l) {
      try {
        var p = await Nr(c), m = await WebAssembly.instantiate(p, l);
        return m;
      } catch (b) {
        P(`failed to asynchronously prepare wasm: ${b}`), je(b);
      }
    }
    async function Vr(c, l, p) {
      if (!c && typeof WebAssembly.instantiateStreaming == "function" && !Ot(l))
        try {
    ...
    async function Ur() {
      function c(w, C) {
        return _ = w.exports, _ = A.instrumentWasmExports(_), F = _.D, wt(), _.J, _r(), _;
      }
      Lr();
      function l(w) {
        return c(w.instance);
    ...
    var It = (c) => {
      for (; c.length > 0; )
        c.shift()(t);
    }, jt = [], Gr = (c) => jt.unshift(c), St = [], $r = (c) => St.unshift(c), Ct = t.noExitRuntime || !0;
    class Br {
      constructor(l) {
    ...
    var kt = 0, Hr = (c, l, p) => {
      ...
      function m(O) {
        var k = p(O);
        k.length !== c.length && ke("Mismatched type converter count");
        for (var L = 0; L < c.length; ++L)
          Y(c[L], k[L]);
      }
      var b = new Array(l.length), w = [], C = 0;
      l.forEach((O, k) => {
        le.hasOwnProperty(O) ? b[k] = le[O] : (w.push(O), pe.hasOwnProperty(O) || (pe[O] = []), pe[O].push(() => {
          b[k] = le[O], ++C, C === w.length && m(b);
        }));
      }), w.length === 0 && m(b);
    };
    function Zr(c, l, p = {}) {
      ...
      if (le[c] = l, delete Ce[c], pe.hasOwnProperty(c)) {
        var b = pe[c];
        delete pe[c], b.forEach((w) => w());
      }
    }
    function Y(c, l, p = {}) {
      return Zr(c, l, p);
    ...
    var At = (c, l, p) => {
      switch (l) {
        ...
        case 4:
          return p ? (m) => te[m >> 2] : (m) => N[m >> 2];
        case 8:
          return p ? (m) => ht[m >> 3] : (m) => bt[m >> 3];
        default:
      ...
      Y(c, { name: l, fromWireType: (C) => C, toWireType: function(C, O) {
        if (typeof O != "bigint" && typeof O != "number")
          throw new TypeError(`Cannot convert "${Se(O)}" to ${this.name}`);
        return typeof O == "number" && (O = BigInt(O)), O;
      }, argPackAdvance: K, readValueFromPointer: At(l, p, !w), destructorFunction: null });
    }, K = 8, qr = (c, l, p, m) => {
    ...
    }, Xr = (c) => ({ count: c.count, deleteScheduled: c.deleteScheduled, preservePointerOnDelete: c.preservePointerOnDelete, ptr: c.ptr, ptrType: c.ptrType, smartPtr: c.smartPtr, smartPtrType: c.smartPtrType }), Be = (c) => {
      function l(p) {
      ...
      if (p.baseClass === void 0)
        return null;
      var m = Rt(c, l, p.baseClass);
      return m === null ? null : p.downcast(m);
    }, Lt = {}, en = {}, tn = (c, l) => {
      for (l === void 0 && x("ptr should not be undefined"); c.baseClass; )
        l = c.upcast(l), c = c.baseClass;
      return l;
    }, rn = (c, l) => (l = tn(c, l), en[l]), Te = (c, l) => {
      (!l.ptrType || !l.ptr) && ke("makeClassHandle requires ptr and ptrType");
      var p = !!l.smartPtrType, m = !!l.smartPtr;
      return p !== m && ke("Both smartPtrType and smartPtr must be specified"), l.count = { value: 1 }, ve(Object.create(c, { $$: { value: l, writable: !0 } }));
    };
    function nn(c) {
      var l = this.getPointee(c);
      if (!l)
        return this.destructor(c), null;
      var p = rn(this.registeredClass, l);
      if (p !== void 0) {
        if (p.$$.count.value === 0)
      ...
      function b() {
        return this.isSmartPointer ? Te(this.registeredClass.instancePrototype, { ptrType: this.pointeeType, ptr: l, smartPtrType: this, smartPtr: c }) : Te(this.registeredClass.instancePrototype, { ptrType: this, ptr: c });
      }
      var w = this.registeredClass.getActualType(l), C = Lt[w];
      if (!C)
        return b.call(this);
      var O;
      this.isConst ? O = C.constPointerType : O = C.pointerType;
      var k = Rt(l, this.registeredClass, O.registeredClass);
      return k === null ? b.call(this) : this.isSmartPointer ? Te(O.registeredClass.instancePrototype, { ptrType: O, ptr: k, smartPtrType: this, smartPtr: c }) : Te(O.registeredClass.instancePrototype, { ptrType: O, ptr: k });
    }
    var ve = (c) => typeof FinalizationRegistry > "u" ? (ve = (l) => l, c) : (He = new FinalizationRegistry((l) => {
      Mt(l.$$);
    }), ve = (l) => {
      ...
      return l;
    }, Et = (l) => He.unregister(l), ve(c)), on = () => {
      Object.assign(De.prototype, { isAliasOf(c) {
        if (!(this instanceof De) || !(c instanceof De))
          return !1;
        ...
        var c = ve(Object.create(Object.getPrototypeOf(this), { $$: { value: Xr(this.$$) } }));
        return c.$$.count.value += 1, c.$$.deleteScheduled = !1, c;
      }, delete() {
        this.$$.ptr || Be(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && x("Object already scheduled for deletion"), Et(this), Mt(this.$$), this.$$.preservePointerOnDelete || (this.$$.smartPtr = void 0, this.$$.ptr = void 0);
      }, isDeleted() {
        return !this.$$.ptr;
      }, deleteLater() {
        return this.$$.ptr || Be(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && x("Object already scheduled for deletion"), this.$$.deleteScheduled = !0, this;
      } });
    };
    function De() {
    }
    var Ae = (c, l) => Object.defineProperty(l, "name", { value: c }), an = (c, l, p) => {
      ...
      t.hasOwnProperty(c) ? ((p === void 0 || t[c].overloadTable !== void 0 && t[c].overloadTable[p] !== void 0) && x(`Cannot register public name '${c}' twice`), an(t, c, c), t[c].overloadTable.hasOwnProperty(p) && x(`Cannot register multiple overloads of a function with the same number of arguments (${p})!`), t[c].overloadTable[p] = l) : (t[c] = l, t[c].argCount = p);
    }, sn = 48, ln = 57, cn = (c) => {
      c = c.replace(/[^a-zA-Z0-9_]/g, "$");
      var l = c.charCodeAt(0);
      return l >= sn && l <= ln ? `_${c}` : c;
    };
    function un(c, l, p, m, b, w, C, O) {
    ...
    function dn(c, l) {
      ...
      l.$$ || x(`Cannot pass "${Se(l)}" as a ${this.name}`), l.$$.ptr || x(`Cannot pass deleted object as a pointer of type ${this.name}`);
      var p = l.$$.ptrType.registeredClass, m = Ee(l.$$.ptr, p, this.registeredClass);
      return m;
    }
    function pn(c, l) {
      var p;
      ...
      (!l || !l.$$) && x(`Cannot pass "${Se(l)}" as a ${this.name}`), l.$$.ptr || x(`Cannot pass deleted object as a pointer of type ${this.name}`), !this.isConst && l.$$.ptrType.isConst && x(`Cannot convert argument of type ${l.$$.smartPtrType ? l.$$.smartPtrType.name : l.$$.ptrType.name} to parameter type ${this.name}`);
      var m = l.$$.ptrType.registeredClass;
      if (p = Ee(l.$$.ptr, m, this.registeredClass), this.isSmartPointer)
    ...
    function fn(c, l) {
      if (l === null)
        return this.isReference && x(`null is not a valid ${this.name}`), 0;
      l.$$ || x(`Cannot pass "${Se(l)}" as a ${this.name}`), l.$$.ptr || x(`Cannot pass deleted object as a pointer of type ${this.name}`), l.$$.ptrType.isConst && x(`Cannot convert argument of type ${l.$$.ptrType.name} to parameter type ${this.name}`);
      var p = l.$$.ptrType.registeredClass, m = Ee(l.$$.ptr, p, this.registeredClass);
      return m;
    }
    function Me(c) {
    ...
    var mn = () => {
      Object.assign(Re.prototype, { getPointee(c) {
        return this.rawGetPointee && (c = this.rawGetPointee(c)), c;
      }, destructor(c) {
        this.rawDestructor?.(c);
      }, argPackAdvance: K, readValueFromPointer: Me, fromWireType: nn });
    };
    function Re(c, l, p, m, b, w, C, O, k, L, M) {
      this.name = c, this.registeredClass = l, this.isReference = p, this.isConst = m, this.isSmartPointer = b, this.pointeeType = w, this.sharingPolicy = C, this.rawGetPointee = O, this.rawConstructor = k, this.rawShare = L, this.rawDestructor = M, !b && l.baseClass === void 0 ? m ? (this.toWireType = dn, this.destructorFunction = null) : (this.toWireType = fn, this.destructorFunction = null) : this.toWireType = pn;
    }
    var _t = (c, l, p) => {
      t.hasOwnProperty(c) || ke("Replacing nonexistent public symbol"), t[c].overloadTable !== void 0 && p !== void 0 ? t[c].overloadTable[p] = l : (t[c] = l, t[c].argCount = p);
    }, yn = (c, l, p) => {
      c = c.replace(/p/g, "i");
      var m = t["dynCall_" + c];
      return m(l, ...p);
...
` + b.replace(/^Error(:[^\n]*)?\n/, ""));
      ...
      throw l.forEach(b), new Ft(`${c}: ` + p.map(xt).join([", "]));
    }, vn = (c, l, p, m, b, w, C, O, k, L, M, W, z) => {
      M = V(M), w = re(b, w), O &&= re(C, O), L &&= re(k, L), z = re(W, z);
      var q = cn(M);
      Ye(q, function() {
        ...
        X = X[0];
        var oe, H;
        m ? (oe = X.registeredClass, H = oe.instancePrototype) : H = De.prototype;
        var Q = Ae(M, function(...tt) {
          ...
          var Zt = U.constructor_body[tt.length];
          if (Zt === void 0)
            throw new fe(`Tried to invoke ctor of ${M} with invalid number of parameters (${tt.length}) - expected (${Object.keys(U.constructor_body).toString()}) parameters instead!`);
          return Zt.apply(this, tt);
        }), ie = Object.create(H, { constructor: { value: Q } });
        Q.prototype = ie;
        var U = new un(M, Q, ie, z, oe, w, O, L);
        U.baseClass && (U.baseClass.__derivedClasses ??= [], U.baseClass.__derivedClasses.push(U));
        var ae = new Re(M, U, !0, !1, !1), _e = new Re(M + "*", U, !1, !1, !1), Jt = new Re(M + " const*", U, !1, !0, !1);
        return Lt[c] = { pointerType: _e, constPointerType: Jt }, _t(q, Q), [ae, _e, Jt];
      });
    }, Nt = (c, l) => {
      for (var p = [], m = 0; m < c; m++)
        p.push(N[l + m * 4 >> 2]);
    ...
    var Le = (c) => {
      ...
      if (c instanceof Pt || c == "unwind")
        return Ie;
      h(1, c);
    }, Vt = 0, zt = () => Ct || Vt > 0, Ut = (c) => {
      Ie = c, zt() || (t.onExit?.(c), B = !0), h(c, new Pt(c));
    }, wn = (c, l) => {
      Ie = c, Ut(c);
    }, Pn = wn, In = () => {
      if (!zt())
      ...
      A.currData && A.state === A.State.Unwinding && A.exportCallStack.length === 0 && (A.state = A.State.Normal, Le(Io), typeof Fibers < "u" && Fibers.trampoline());
    }, whenDone() {
      return new Promise((c, l) => {
        A.asyncPromiseHandlers = { resolve: c, reject: l };
      });
    }, allocateData() {
      var c = Qe(12 + A.StackSize);
        ...
        if (A.state === A.State.Normal) {
          ...
          c((m = 0) => {
            if (!B && (A.handleSleepReturnValue = m, l = !0, !!p)) {
              A.state = A.State.Rewinding, Le(() => jo(A.currData)), typeof MainLoop < "u" && MainLoop.func && MainLoop.resume();
              var b, w = !1;
              try {
          ...
          }), p = !0, l || (A.state = A.State.Unwinding, A.currData = A.allocateData(), typeof MainLoop < "u" && MainLoop.func && MainLoop.pause(), Le(() => Po(A.currData)));
        } else A.state === A.State.Rewinding ? (A.state = A.State.Normal, Le(So), ee(A.currData), A.currData = null, A.sleepCallbacks.forEach(Gt)) : je(`invalid state: ${A.state}`);
    ...
    function $t(c, l, p, m, b, w) {
      var C = l.length;
      C < 2 && x("argTypes array size mismatch! Must at least get return value and 'this' types!"), l[1];
      var O = On(l), k = l[0].name !== "void", L = C - 2, M = new Array(L), W = [], z = [], q = function(...X) {
        z.length = 0;
        var oe;
        W.length = 1, W[0] = b;
        for (var H = 0; H < L; ++H)
        ...
        function ie(U) {
          if (O)
            ...
            for (var ae = 2; ae < l.length; ae++) {
              var _e = ae === 1 ? oe : M[ae - 2];
              l[ae].destructorFunction !== null && l[ae].destructorFunction(_e);
            }
          if (k)
    ...
    var jn = (c, l, p, m, b, w) => {
      ...
      b = re(m, b), me([], [c], (O) => {
        ...
        if (O.registeredClass.constructor_body === void 0 && (O.registeredClass.constructor_body = []), O.registeredClass.constructor_body[l - 1] !== void 0)
          throw new fe(`Cannot register multiple constructors with identical number of parameters (${l - 1}) for class '${O.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`);
        return O.registeredClass.constructor_body[l - 1] = () => {
          Oe(`Cannot construct ${O.name} due to unbound types`, C);
        }, me([], C, (L) => (L.splice(1, 0, null), O.registeredClass.constructor_body[l - 1] = $t(k, L, null, b, w), [])), [];
      });
    }, Bt = (c, l, p) => (c instanceof Object || x(`${p} with invalid "this": ${c}`), c instanceof l.registeredClass.constructor || x(`${p} incompatible with "this" of type ${c.constructor.name}`), c.$$.ptr || x(`cannot call emscripten binding method ${p} on deleted object`), Ee(c.$$.ptr, c.$$.ptrType.registeredClass, l.registeredClass)), Sn = (c, l, p, m, b, w, C, O, k, L) => {
      l = V(l), b = re(m, b), me([], [c], (M) => {
        M = M[0];
        var W = `${M.name}.${l}`, z = { get() {
          Oe(`Cannot access ${W} due to unbound types`, [p, C]);
        }, enumerable: !0, configurable: !0 };
        return k ? z.set = () => Oe(`Cannot access ${W} due to unbound types`, [p, C]) : z.set = (q) => x(W + " is a read-only property"), Object.defineProperty(M.registeredClass.instancePrototype, l, z), me([], k ? [p, C] : [p], (q) => {
          var X = q[0], oe = { get() {
            var Q = Bt(this, M, W + " getter");
          ...
          if (k) {
            ...
            var H = q[1];
            oe.set = function(Q) {
              var ie = Bt(this, M, W + " setter"), U = [];
              k(L, ie, H.toWireType(U, Q)), Je(U);
            };
          }
      ...
      c > 9 && --ne[c + 1] === 0 && (ne[c] = void 0, Ze.push(c));
    }, Cn = () => ne.length / 2 - 5 - Ze.length, kn = () => {
      ne.push(0, 1, void 0, 1, null, 1, !0, 1, !1, 1), t.count_emval_handles = Cn;
    }, J = { toValue: (c) => (c || x("Cannot use deleted val. handle = " + c), ne[c]), toHandle: (c) => {
      switch (c) {
        case void 0:
          return 2;
        case null:
        ...
        case !1:
          return 8;
        default: {
          const l = Ze.pop() || ne.length;
          return ne[l] = c, ne[l + 1] = 1, l;
        }
      }
    } }, Tn = { name: "emscripten::val", fromWireType: (c) => {
      var l = J.toValue(c);
      return Ke(c), l;
    }, toWireType: (c, l) => J.toHandle(l), argPackAdvance: K, readValueFromPointer: Me, destructorFunction: null }, Dn = (c) => Y(c, Tn), An = (c, l, p) => {
      switch (l) {
        case 1:
          return p ? function(m) {
      ...
      }, toWireType: (w, C) => C.value, argPackAdvance: K, readValueFromPointer: An(l, p, m), destructorFunction: null }), Ye(l, b);
    }, qe = (c, l) => {
      var p = le[c];
      return p === void 0 && x(`${l} has unknown type ${xt(c)}`), p;
    }, Mn = (c, l, p) => {
      var m = qe(c, "enum");
      l = V(l);
      var b = m.constructor, w = Object.create(m.constructor.prototype, { value: { value: p }, constructor: { value: Ae(`${m.name}_${l}`, function() {
      }) } });
      b.values[p] = w, b[l] = w;
    }, Rn = (c, l) => {
      switch (l) {
        case 4:
          return function(p) {
            return this.fromWireType(gt[p >> 2]);
          };
        case 8:
          return function(p) {
            return this.fromWireType(vt[p >> 3]);
          };
        default:
          throw new TypeError(`invalid float width (${l}): ${c}`);
      }
    }, Ln = (c, l, p) => {
      l = V(l), Y(c, { name: l, fromWireType: (m) => m, toWireType: (m, b) => b, argPackAdvance: K, readValueFromPointer: Rn(l, p), destructorFunction: null });
    }, _n = (c) => {
      c = c.trim();
      const l = c.indexOf("(");
      ...
      }, Y(c, { name: l, fromWireType: w, toWireType: L, argPackAdvance: K, readValueFromPointer: At(l, p, m !== 0), destructorFunction: null });
    }, Nn = (c, l, p) => {
      ...
      return l[p] = 0, p - b;
    }, Vn = (c, l, p) => Wn(c, G, l, p), zn = (c) => {
      for (var l = 0, p = 0; p < c.length; ++p) {
        var m = c.charCodeAt(p);
        m <= 127 ? l++ : m <= 2047 ? l += 2 : m >= 55296 && m <= 57343 ? (l += 4, ++p) : l += 3;
      }
      return l;
    }, Ht = typeof TextDecoder < "u" ? new TextDecoder() : void 0, Un = (c, l = 0, p = NaN) => {
      for (var m = l + p, b = l; c[b] && !(b >= m); ) ++b;
      if (b - l > 16 && c.buffer && Ht)
        return Ht.decode(c.subarray(l, b));
      for (var w = ""; l < b; ) {
        var C = c[l++];
        if (!(C & 128)) {
        ...
        if ((C & 240) == 224 ? C = (C & 15) << 12 | O << 6 | k : C = (C & 7) << 18 | O << 12 | k << 6 | c[l++] & 63, C < 65536)
          ...
          var L = C - 65536;
          w += String.fromCharCode(55296 | L >> 10, 56320 | L & 1023);
        }
      }
      return w;
    }, Gn = (c, l) => c ? Un(G, c, l) : "", $n = (c, l) => {
      l = V(l), Y(c, { name: l, fromWireType(p) {
        ...
        var C = Qe(4 + b + 1), O = C + 4;
        if (N[C >> 2] = b, w)
          Vn(m, O, b + 1);
        else if (w)
          for (var k = 0; k < b; ++k) {
            var L = m.charCodeAt(k);
            L > 255 && (ee(C), x("String has UTF-16 code units that do not fit in 8 bits")), G[O + k] = L;
          }
        else
          for (var k = 0; k < b; ++k)
            G[O + k] = m[k];
        return p !== null && p.push(ee, C), C;
      }, argPackAdvance: K, readValueFromPointer: Me, destructorFunction(p) {
        ee(p);
      } });
    }, Yt = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, Bn = (c, l) => {
      for (var p = c, m = p >> 1, b = m + l / 2; !(m >= b) && he[m]; ) ++m;
      if (p = m << 1, p - c > 32 && Yt) return Yt.decode(G.subarray(c, p));
      ...
      p = V(p);
      var m, b, w, C;
      l === 2 ? (m = Bn, b = Hn, C = Yn, w = (O) => he[O >> 1]) : l === 4 && (m = Jn, b = Zn, C = Kn, w = (O) => N[O >> 2]), Y(c, { name: p, fromWireType: (O) => {
        for (var k = N[O >> 2], L, M = O + 4, W = 0; W <= k; ++W) {
          var z = O + 4 + W * l;
          if (W == k || w(z) == 0) {
            var q = z - M, X = m(M, q);
            L === void 0 ? L = X : (L += "\0", L += X), M = z + l;
          }
        }
        return ee(O), L;
      }, toWireType: (O, k) => {
        typeof k != "string" && x(`Cannot pass non-string to C++ string type ${p}`);
        var L = C(k), M = Qe(4 + L + l);
        return N[M >> 2] = L / l, b(k, M + 4, L + l), O !== null && O.push(ee, M), M;
      }, argPackAdvance: K, readValueFromPointer: Me, destructorFunction(O) {
        ee(O);
      } });
    }, Xn = (c, l) => {
    ...
    }, to = (c, l, p) => (c = J.toValue(c), l = qe(l, "emval::as"), eo(l, p, c)), ro = (c, l) => (c = J.toValue(c), l = J.toValue(l), J.toHandle(c[l])), no = {}, oo = (c) => {
      var l = no[c];
      return l === void 0 ? V(c) : l;
    }, io = (c) => J.toHandle(oo(c)), ao = (c) => {
      var l = J.toValue(c);
      Je(l), Ke(c);
    }, so = (c, l) => {
      c = qe(c, "_emval_take_value");
      var p = c.readValueFromPointer(l);
      return J.toHandle(p);
    }, we = {}, lo = () => performance.now(), co = (c, l) => {
      if (we[c] && (clearTimeout(we[c].id), delete we[c]), !l) return 0;
      var p = setTimeout(() => {
        delete we[c], Gt(() => wo(c, lo()));
      }, l);
      return we[c] = { id: p, timeout_ms: l }, 0;
    }, uo = () => 2147483648, po = (c, l) => Math.ceil(c / l) * l, fo = (c) => {
      var l = F.buffer, p = (c - l.byteLength + 65535) / 65536 | 0;
      try {
        return F.grow(p), wt(), 1;
      } catch {
      }
    }, mo = (c) => {
      var l = G.length;
      ...
      for (var m = 1; m <= 4; m *= 2) {
        ...
        var w = Math.min(p, po(Math.max(c, b), 65536)), C = fo(w);
        if (C)
          return !0;
      }
      return !1;
    }, Xe = {}, yo = () => j || "./this.program", Pe = () => {
      if (!Pe.strings) {
        var c = (typeof navigator == "object" && navigator.languages && navigator.languages[0] || "C").replace("-", "_") + ".UTF-8", l = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: c, _: yo() };
        for (var p in Xe)
          Xe[p] === void 0 ? delete l[p] : l[p] = Xe[p];
        var m = [];
        for (var p in l)
          m.push(`${p}=${l[p]}`);
        Pe.strings = m;
      ...
      var p = 0;
      return Pe().forEach((m, b) => {
        var w = l + p;
        N[c + b * 4 >> 2] = w, go(m, w), p += m.length + 1;
      }), 0;
    }, bo = (c, l) => {
      var p = Pe();
      N[c >> 2] = p.length;
    ...
    Jr(), fe = t.BindingError = class extends Error {
      constructor(l) {
        super(l), this.name = "BindingError";
      }
    }, Dt = t.InternalError = class extends Error {
      constructor(l) {
        super(l), this.name = "InternalError";
      }
    }, on(), mn(), Ft = t.UnboundTypeError = bn(Error, "UnboundTypeError"), kn();
    var vo = { g: Hr, u: Yr, n: Kr, y: qr, f: vn, d: jn, a: Sn, w: Dn, l: En, h: Mn, m: Ln, b: Fn, e: xn, c: Nn, x: $n, i: qn, z: Xn, q: Qn, j: to, A: Ke, k: ro, o: io, C: ao, B: so, r: co, v: mo, s: ho, t: bo, p: Ut }, _ = await Ur();
    _.E;
    var Oo = _.F, Qe = t._malloc = _.G, ee = t._free = _.H, wo = _.I;
    ...
    var Po = _.ea, Io = _.fa, jo = _.ga, So = _.ha;
    function et() {
      if (se > 0) {
        be = et;
        return;
      ...
      function c() {
        t.calledRun = !0, !B && (Mr(), e(t), t.onRuntimeInitialized?.(), Rr());
      }
