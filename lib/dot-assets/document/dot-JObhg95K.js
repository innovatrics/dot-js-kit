const jr = /* @__PURE__ */ Symbol("Comlink.proxy"), Co = /* @__PURE__ */ Symbol("Comlink.endpoint"), ko = /* @__PURE__ */ Symbol("Comlink.releaseProxy"), We = /* @__PURE__ */ Symbol("Comlink.finalizer"), Ve = /* @__PURE__ */ Symbol("Comlink.thrown"), Ir = (y) => typeof y == "object" && y !== null || typeof y == "function", To = {
  canHandle: (y) => Ir(y) && y[jr],
  serialize(y) {
...
function yt(y, a = globalThis, r = ["*"]) {
  a.addEventListener("message", function t(e) {
    ...
    let g;
    try {
      const I = u.slice(0, -1).reduce((v, j) => v[j], y), h = u.reduce((v, j) => v[j], y);
      switch (o) {
        case "GET":
          g = h;
          break;
        case "SET":
          I[u.slice(-1)[0]] = ce(e.data.value), g = !0;
          break;
        case "APPLY":
          g = h.apply(I, s);
          break;
    ...
    Promise.resolve(g).catch((I) => ({ value: I, [Ve]: 0 })).then((I) => {
      const [h, v] = Ge(I);
      a.postMessage(Object.assign(Object.assign({}, h), { id: n }), v), o === "RELEASE" && (a.removeEventListener("message", t), Cr(a), We in y && typeof y[We] == "function" && y[We]());
    }).catch((I) => {
      const [h, v] = Ge({
...
const ze = /* @__PURE__ */ new WeakMap(), Ue = "FinalizationRegistry" in globalThis && new FinalizationRegistry((y) => {
  const a = (ze.get(y) || 0) - 1;
  ze.set(y, a), a === 0 && kr(y);
});
function Lo(y, a) {
  const r = (ze.get(a) || 0) + 1;
  ze.set(a, r), Ue && Ue.register(y, a, y);
}
function Ro(y) {
  Ue && Ue.unregister(y);
}
function mt(y, a, r = [], t = function() {
}) {
  let e = !1;
  const n = new Proxy(t, {
    get(o, u) {
...
function Kt(y) {
  const a = y.map(Ge);
  return [a.map((r) => r[0]), _o(a.map((r) => r[1]))];
}
...
class $ extends Error {
  ...
  static fromCameraError(a) {
    if (this.logError(a), a instanceof $)
      return a;
    let r;
    switch (a.name) {
...
const Ne = (y, a) => Math.hypot(a.x - y.x, a.y - y.y), Go = (y) => {
  const { bottomLeft: a, bottomRight: r, topLeft: t, topRight: e } = y, n = Ne(t, e), o = Ne(e, r), u = Ne(a, r), s = Ne(t, a);
...
function ue() {
  return ur || (ur = 1, (function(y) {
    var a = y;
    a.asPromise = $o(), a.base64 = Bo(), a.EventEmitter = Ho(), a.float = Yo(), a.inquire = Jo(), a.utf8 = Zo(), a.pool = Ko(), a.LongBits = qo(), a.isNode = !!(typeof ye < "u" && ye && ye.process && ye.process.versions && ye.process.versions.node), a.global = a.isNode && ye || typeof window < "u" && window || typeof self < "u" && self || rt, a.emptyArray = Object.freeze ? Object.freeze([]) : (
...
function Dr() {
  ...
  }, y.Array !== Array && (s.alloc = y.pool(s.alloc, y.Array.prototype.subarray)), s.prototype._push = function(P, T, F) {
  ...
  var o = typeof Uint8Array < "u" ? function(h) {
    ...
    return y.Buffer ? function(h) {
      return (n.create = function(v) {
        return y.Buffer.isBuffer(v) ? new a(v) : o(v);
      })(h);
    } : o;
  };
...
function ni() {
  return Or || (Or = 1, (function(y) {
    var a = y;
    a.build = "minimal", a.Writer = Dr(), a.BufferWriter = Xo(), a.Reader = Ar(), a.BufferReader = Qo(), a.util = ue(), a.rpc = ti(), a.roots = ri(), a.configure = r;
    function r() {
...
var ii = (() => {
  ...
  return (async function(a = {}) {
    ...
    var S, L;
    (u || s) && (s ? v = self.location.href : typeof document < "u" && document.currentScript && (v = document.currentScript.src), y && (v = y), v.startsWith("blob:") ? v = "" : v = v.slice(0, v.replace(/[?#].*/, "").lastIndexOf("/") + 1), s && (L = (c) => {
    ...
    var T = t.wasmBinary, F, B = !1, je, Z, G, de, he, te, N, gt, ht, bt, vt, Ot = (c) => c.startsWith("file://");
    function wt() {
      var c = F.buffer;
    ...
    async function Wr(c, l) {
      try {
        ...
        P(`failed to asynchronously prepare wasm: ${b}`), Ie(b);
      }
    }
    ...
    var jt = (c) => {
      for (; c.length > 0; )
        c.shift()(t);
    }, It = [], Gr = (c) => It.unshift(c), St = [], $r = (c) => St.unshift(c), Ct = t.noExitRuntime || !0;
    class Br {
      constructor(l) {
    ...
    function nn(c) {
      ...
      var w = this.registeredClass.getActualType(l), C = Rt[w];
      if (!C)
        return b.call(this);
      var O;
    ...
    function Le(c, l, p, m, b, w, C, O, k, R, M) {
      this.name = c, this.registeredClass = l, this.isReference = p, this.isConst = m, this.isSmartPointer = b, this.pointeeType = w, this.sharingPolicy = C, this.rawGetPointee = O, this.rawConstructor = k, this.rawShare = R, this.rawDestructor = M, !b && l.baseClass === void 0 ? m ? (this.toWireType = dn, this.destructorFunction = null) : (this.toWireType = fn, this.destructorFunction = null) : this.toWireType = pn;
    }
    var _t = (c, l, p) => {
...
` + b.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    }, vn = (c, l, p, m, b, w, C, O, k, R, M, W, z) => {
      M = V(M), w = re(b, w), O &&= re(C, O), R &&= re(k, R), z = re(W, z);
      var q = cn(M);
      Ye(q, function() {
        ...
        Q.prototype = ie;
        var U = new un(M, Q, ie, z, oe, w, O, R);
        U.baseClass && (U.baseClass.__derivedClasses ??= [], U.baseClass.__derivedClasses.push(U));
        var ae = new Le(M, U, !0, !1, !1), _e = new Le(M + "*", U, !1, !1, !1), Jt = new Le(M + " const*", U, !1, !0, !1);
        return Rt[c] = { pointerType: _e, constPointerType: Jt }, _t(q, Q), [ae, _e, Jt];
      });
    }, Nt = (c, l) => {
      for (var p = [], m = 0; m < c; m++)
        p.push(N[l + m * 4 >> 2]);
    ...
    var Re = (c) => {
      ...
      je = c, zt() || (t.onExit?.(c), B = !0), h(c, new Pt(c));
    }, wn = (c, l) => {
      je = c, Ut(c);
    }, Pn = wn, jn = () => {
      if (!zt())
      ...
      A.currData && A.state === A.State.Unwinding && A.exportCallStack.length === 0 && (A.state = A.State.Normal, Re(jo), typeof Fibers < "u" && Fibers.trampoline());
    }, whenDone() {
        ...
        if (A.state === A.State.Normal) {
          ...
          c((m = 0) => {
            if (!B && (A.handleSleepReturnValue = m, l = !0, !!p)) {
              A.state = A.State.Rewinding, Re(() => Io(A.currData)), typeof MainLoop < "u" && MainLoop.func && MainLoop.resume();
              var b, w = !1;
              try {
          ...
          }), p = !0, l || (A.state = A.State.Unwinding, A.currData = A.allocateData(), typeof MainLoop < "u" && MainLoop.func && MainLoop.pause(), Re(() => Po(A.currData)));
        } else A.state === A.State.Rewinding ? (A.state = A.State.Normal, Re(So), ee(A.currData), A.currData = null, A.sleepCallbacks.forEach(Gt)) : Ie(`invalid state: ${A.state}`);
    ...
    function $t(c, l, p, m, b, w) {
      ...
      var O = On(l), k = l[0].name !== "void", R = C - 2, M = new Array(R), W = [], z = [], q = function(...X) {
        z.length = 0;
        var oe;
        W.length = 1, W[0] = b;
        for (var H = 0; H < R; ++H)
    ...
    var In = (c, l, p, m, b, w) => {
      ...
      b = re(m, b), me([], [c], (O) => {
        ...
        }, me([], C, (R) => (R.splice(1, 0, null), O.registeredClass.constructor_body[l - 1] = $t(k, R, null, b, w), [])), [];
      });
    }, Bt = (c, l, p) => (c instanceof Object || x(`${p} with invalid "this": ${c}`), c instanceof l.registeredClass.constructor || x(`${p} incompatible with "this" of type ${c.constructor.name}`), c.$$.ptr || x(`cannot call emscripten binding method ${p} on deleted object`), Ee(c.$$.ptr, c.$$.ptrType.registeredClass, l.registeredClass)), Sn = (c, l, p, m, b, w, C, O, k, R) => {
      ...
      }, Y(c, { name: l, fromWireType: w, toWireType: R, argPackAdvance: K, readValueFromPointer: At(l, p, m !== 0), destructorFunction: null });
    }, Nn = (c, l, p) => {
      ...
      l = V(l), Y(c, { name: l, fromWireType(p) {
        ...
        if (N[C >> 2] = b, w)
          ...
          for (var k = 0; k < b; ++k) {
            ...
            R > 255 && (ee(C), x("String has UTF-16 code units that do not fit in 8 bits")), G[O + k] = R;
          }
        else
          for (var k = 0; k < b; ++k)
            G[O + k] = m[k];
      ...
      l === 2 ? (m = Bn, b = Hn, C = Yn, w = (O) => he[O >> 1]) : l === 4 && (m = Jn, b = Zn, C = Kn, w = (O) => N[O >> 2]), Y(c, { name: p, fromWireType: (O) => {
        ...
        var R = C(k), M = Qe(4 + R + l);
        return N[M >> 2] = R / l, b(k, M + 4, R + l), O !== null && O.push(ee, M), M;
    ...
    var vo = { g: Hr, u: Yr, n: Kr, y: qr, f: vn, d: In, a: Sn, w: Dn, l: En, h: Mn, m: Rn, b: Fn, e: xn, c: Nn, x: $n, i: qn, z: Xn, q: Qn, j: to, A: Ke, k: ro, o: io, C: ao, B: so, r: co, v: mo, s: ho, t: bo, p: Ut }, _ = await Ur();
    _.E;
    ...
    var Po = _.ea, jo = _.fa, Io = _.ga, So = _.ha;
    function et() {
      if (se > 0) {
        be = et;
        return;
