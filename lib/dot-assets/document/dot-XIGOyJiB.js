  ...
  return g.Content = (function() {
    ...
    return s.MagnifEyeLivenessContent = (function() {
      ...
      return Object.defineProperty(r.prototype, "_croppedImage", {
        ...
        if (e.croppedImage != null && Object.hasOwnProperty.call(e, "croppedImage") && i.dot.Image.encode(e.croppedImage, n.uint32(
          ...
          for (let o = 0; o < e.cameraEvaluationResults.length; ++o)
            i.dot.v4.CameraEvaluationResult.encode(e.cameraEvaluationResults[o], n.uint32(
              /* id 9, wireType 2 =*/
              74
            ).fork()).ldelim();
        return n;
        ...
        for (; e.pos < u; ) {
          ...
          switch (y >>> 3) {
            ...
            case 9: {
              a.cameraEvaluationResults && a.cameraEvaluationResults.length || (a.cameraEvaluationResults = []), a.cameraEvaluationResults.push(i.dot.v4.CameraEvaluationResult.decode(e, e.uint32()));
              break;
            }
            default:
              e.skipType(y & 7);
        ...
        if (e.cameraEvaluationResults != null && e.hasOwnProperty("cameraEvaluationResults")) {
          ...
          for (let n = 0; n < e.cameraEvaluationResults.length; ++n) {
            let o = i.dot.v4.CameraEvaluationResult.verify(e.cameraEvaluationResults[n]);
            if (o)
        ...
        if (e.cameraEvaluationResults) {
          ...
          for (let o = 0; o < e.cameraEvaluationResults.length; ++o) {
            ...
            n.cameraEvaluationResults[o] = i.dot.v4.CameraEvaluationResult.fromObject(e.cameraEvaluationResults[o]);
          }
        }
        return n;
      }, r.toObject = function(e, n) {
        n || (n = {});
        let o = {};
        if ((n.arrays || n.defaults) && (o.availableCameraProperties = [], o.hashedDetectedImages = [], o.detectionRecord = [], o.hashedDetectedImagesWithTimestamp = [], o.cameraEvaluationResults = []), n.defaults && (o.currentCameraProperties = null), e.currentCameraProperties != null && e.hasOwnProperty("currentCameraProperties") && (o.currentCameraProperties = i.dot.v4.MediaTrackSettings.toObject(e.currentCameraProperties, n)), e.availableCameraProperties && e.availableCameraProperties.length) {
        ...
        if (e.croppedImage != null && e.hasOwnProperty("croppedImage") && (o.croppedImage = i.dot.Image.toObject(e.croppedImage, n), n.oneofs && (o._croppedImage = "croppedImage")), e.croppedImageWithPosition != null && e.hasOwnProperty("croppedImageWithPosition") && (o.croppedImageWithPosition = i.dot.v4.ImageCrop.toObject(e.croppedImageWithPosition, n), n.oneofs && (o._croppedImageWithPosition = "croppedImageWithPosition")), e.platformDetails != null && e.hasOwnProperty("platformDetails") && (o.platformDetails = i.dot.v4.PlatformDetails.toObject(e.platformDetails, n), n.oneofs && (o._platformDetails = "platformDetails")), e.cameraEvaluationResults && e.cameraEvaluationResults.length) {
          o.cameraEvaluationResults = [];
          for (let u = 0; u < e.cameraEvaluationResults.length; ++u)
            o.cameraEvaluationResults[u] = i.dot.v4.CameraEvaluationResult.toObject(e.cameraEvaluationResults[u], n);
        }
        return o;
      }, r.prototype.toJSON = function() {
        return this.constructor.toObject(this, A.util.toJSONOptions);
      ...
      return Object.defineProperty(r.prototype, "_cameraName", {
        get: d.oneOfGetter(t = ["cameraName"]),
        set: d.oneOfSetter(t)
      }), Object.defineProperty(r.prototype, "_fastAvg", {
        get: d.oneOfGetter(t = ["fastAvg"]),
        set: d.oneOfSetter(t)
      }), Object.defineProperty(r.prototype, "_slowAvg", {
        get: d.oneOfGetter(t = ["slowAvg"]),
        set: d.oneOfSetter(t)
      }), r.create = function(e) {
        return new r(e);
      }, r.encode = function(e, n) {
        return n || (n = E.create()), e.cameraName != null && Object.hasOwnProperty.call(e, "cameraName") && n.uint32(
          /* id 1, wireType 2 =*/
          10
        ...
        return typeof e != "object" || e === null ? "object expected" : e.cameraName != null && e.hasOwnProperty("cameraName") && !d.isString(e.cameraName) ? "cameraName: string expected" : e.fastAvg != null && e.hasOwnProperty("fastAvg") && !d.isInteger(e.fastAvg) ? "fastAvg: integer expected" : e.slowAvg != null && e.hasOwnProperty("slowAvg") && !d.isInteger(e.slowAvg) ? "slowAvg: integer expected" : null;
      }, r.fromObject = function(e) {
...
var ii = (() => {
  ...
  return (async function(s = {}) {
    ...
    var S, R;
    (u || a) && (a ? v = self.location.href : typeof document < "u" && document.currentScript && (v = document.currentScript.src), g && (v = g), v.startsWith("blob:") ? v = "" : v = v.slice(0, v.replace(/[?#].*/, "").lastIndexOf("/") + 1), a && (R = (c) => {
    ...
    var T = t.wasmBinary, F, B = !1, Ie, Z, G, de, he, te, N, yt, ht, bt, vt, Ot = (c) => c.startsWith("file://");
    function wt() {
      var c = F.buffer;
      t.HEAP8 = Z = new Int8Array(c), t.HEAP16 = de = new Int16Array(c), t.HEAPU8 = G = new Uint8Array(c), t.HEAPU16 = he = new Uint16Array(c), t.HEAP32 = te = new Int32Array(c), t.HEAPU32 = N = new Uint32Array(c), t.HEAPF32 = yt = new Float32Array(c), t.HEAPF64 = vt = new Float64Array(c), t.HEAP64 = ht = new BigInt64Array(c), t.HEAPU64 = bt = new BigUint64Array(c);
    }
    function Er() {
      if (t.preRun)
    ...
    async function Ur() {
      function c(w, C) {
        return _ = w.exports, _ = D.instrumentWasmExports(_), F = _.D, wt(), _.J, _r(), _;
      }
      Lr();
      function l(w) {
        return c(w.instance);
    ...
    var Dt = (c, l, p) => {
      ...
      }, argPackAdvance: K, readValueFromPointer: Dt(l, p, !w), destructorFunction: null });
    }, K = 8, qr = (c, l, p, m) => {
    ...
    function nn(c) {
      ...
      return k === null ? b.call(this) : this.isSmartPointer ? Ae(O.registeredClass.instancePrototype, { ptrType: O, ptr: k, smartPtrType: this, smartPtr: c }) : Ae(O.registeredClass.instancePrototype, { ptrType: O, ptr: k });
    }
    var ve = (c) => typeof FinalizationRegistry > "u" ? (ve = (l) => l, c) : (He = new FinalizationRegistry((l) => {
      ...
      Object.assign(Te.prototype, { isAliasOf(c) {
        if (!(this instanceof Te) || !(c instanceof Te))
          return !1;
    ...
    var De = (c, l) => Object.defineProperty(l, "name", { value: c }), an = (c, l, p) => {
...
` + b.replace(/^Error(:[^\n]*)?\n/, ""));
      ...
      Ye(q, function() {
        ...
        X = X[0];
        var oe, H;
        m ? (oe = X.registeredClass, H = oe.instancePrototype) : H = Te.prototype;
        var Q = De(M, function(...tt) {
    ...
    var Le = (c) => {
      ...
      for (let [p, m] of Object.entries(c))
        typeof m == "function" ? l[p] = (...b) => {
          D.exportCallStack.push(p);
          try {
            return m(...b);
          } finally {
            B || (D.exportCallStack.pop(), D.maybeStopUnwind());
          }
        } : l[p] = m;
      return l;
      ...
      var l = D.callStackNameToId[c];
      return l === void 0 && (l = D.callStackId++, D.callStackNameToId[c] = l, D.callStackIdToName[l] = c), l;
    }, maybeStopUnwind() {
      D.currData && D.state === D.State.Unwinding && D.exportCallStack.length === 0 && (D.state = D.State.Normal, Le(Io), typeof Fibers < "u" && Fibers.trampoline());
    }, whenDone() {
      return new Promise((c, l) => {
        D.asyncPromiseHandlers = { resolve: c, reject: l };
      });
    }, allocateData() {
      var c = Qe(12 + D.StackSize);
      return D.setDataHeader(c, c + 12, D.StackSize), D.setDataRewindFunc(c), c;
    }, setDataHeader(c, l, p) {
      N[c >> 2] = l, N[c + 4 >> 2] = l + p;
    }, setDataRewindFunc(c) {
      var l = D.exportCallStack[0], p = D.getCallStackId(l);
      te[c + 8 >> 2] = p;
    }, getDataRewindFuncName(c) {
      var l = te[c + 8 >> 2], p = D.callStackIdToName[l];
      return p;
    }, getDataRewindFunc(c) {
      var l = _[c];
      return l;
    }, doRewind(c) {
      var l = D.getDataRewindFuncName(c), p = D.getDataRewindFunc(l);
      return p();
    }, handleSleep(c) {
      if (!B) {
        if (D.state === D.State.Normal) {
          var l = !1, p = !1;
          c((m = 0) => {
            if (!B && (D.handleSleepReturnValue = m, l = !0, !!p)) {
              D.state = D.State.Rewinding, Le(() => jo(D.currData)), typeof MainLoop < "u" && MainLoop.func && MainLoop.resume();
              var b, w = !1;
              try {
              ...
              var C = !1;
              if (!D.currData) {
                var O = D.asyncPromiseHandlers;
                O && (D.asyncPromiseHandlers = null, (w ? O.reject : O.resolve)(b), C = !0);
              }
              if (w && !C)
                throw b;
            }
          }), p = !0, l || (D.state = D.State.Unwinding, D.currData = D.allocateData(), typeof MainLoop < "u" && MainLoop.func && MainLoop.pause(), Le(() => Po(D.currData)));
        } else D.state === D.State.Rewinding ? (D.state = D.State.Normal, Le(So), ee(D.currData), D.currData = null, D.sleepCallbacks.forEach(Gt)) : je(`invalid state: ${D.state}`);
        return D.handleSleepReturnValue;
      }
    }, handleAsync(c) {
      return D.handleSleep((l) => {
        c().then(l);
      });
    } };
    ...
    var jn = (c, l, p, m, b, w) => {
    ...
    } }, An = { name: "emscripten::val", fromWireType: (c) => {
      var l = J.toValue(c);
      return Ke(c), l;
    }, toWireType: (c, l) => J.toHandle(l), argPackAdvance: K, readValueFromPointer: Me, destructorFunction: null }, Tn = (c) => Y(c, An), Dn = (c, l, p) => {
      switch (l) {
        case 1:
          return p ? function(m) {
      ...
      }, toWireType: (w, C) => C.value, argPackAdvance: K, readValueFromPointer: Dn(l, p, m), destructorFunction: null }), Ye(l, b);
    }, qe = (c, l) => {
      var p = le[c];
      ...
      var m = qe(c, "enum");
      l = V(l);
      var b = m.constructor, w = Object.create(m.constructor.prototype, { value: { value: p }, constructor: { value: De(`${m.name}_${l}`, function() {
      }) } });
      b.values[p] = w, b[l] = w;
    }, Rn = (c, l) => {
      switch (l) {
        case 4:
          return function(p) {
            return this.fromWireType(yt[p >> 2]);
          };
        case 8:
          return function(p) {
      ...
      }, Y(c, { name: l, fromWireType: w, toWireType: L, argPackAdvance: K, readValueFromPointer: Dt(l, p, m !== 0), destructorFunction: null });
    }, Nn = (c, l, p) => {
      ...
      return !1;
    }, Xe = {}, go = () => j || "./this.program", Pe = () => {
      if (!Pe.strings) {
        var c = (typeof navigator == "object" && navigator.languages && navigator.languages[0] || "C").replace("-", "_") + ".UTF-8", l = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: c, _: go() };
        for (var p in Xe)
      ...
      return Pe().forEach((m, b) => {
        var w = l + p;
        N[c + b * 4 >> 2] = w, yo(m, w), p += m.length + 1;
      }), 0;
    }, bo = (c, l) => {
      var p = Pe();
      N[c >> 2] = p.length;
    ...
    }, Tt = t.InternalError = class extends Error {
      constructor(l) {
        super(l), this.name = "InternalError";
      }
    }, on(), mn(), Ft = t.UnboundTypeError = bn(Error, "UnboundTypeError"), kn();
    var vo = { g: Hr, u: Yr, n: Kr, y: qr, f: vn, d: jn, a: Sn, w: Tn, l: En, h: Mn, m: Ln, b: Fn, e: xn, c: Nn, x: $n, i: qn, z: Xn, q: Qn, j: to, A: Ke, k: ro, o: io, C: ao, B: so, r: co, v: mo, s: ho, t: bo, p: Ut }, _ = await Ur();
    _.E;
