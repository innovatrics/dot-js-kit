...
function Kt(y) {
  const s = y.map(Ge);
  return [s.map((r) => r[0]), Ro(s.map((r) => r[1]))];
}
      ...
      function o(a, g, j, h, v, I) {
        ...
        if (S && (h = -h), h === 0)
          ...
          if (h < 22250738585072014e-324)
            L = h / 5e-324, a(L >>> 0, v, I + g), a((S << 31 | L / 4294967296) >>> 0, v, I + j);
          else {
            var P = Math.floor(Math.log(h) / Math.LN2);
            P === 1024 && (P = 1023), L = h * Math.pow(2, -P), a(L * 4503599627370496 >>> 0, v, I + g), a((S << 31 | P + 1023 << 20 | L * 1048576 & 1048575) >>> 0, v, I + j);
          }
        }
      }
      n.writeDoubleLE = o.bind(null, s, 0, 4), n.writeDoubleBE = o.bind(null, r, 4, 0);
      function u(a, g, j, h, v) {
        var I = a(h, v + g), S = a(h, v + j), L = (S >> 31) * 2 + 1, P = S >>> 20 & 2047, T = 4294967296 * (S & 1048575) + I;
...
function Dr() {
  ...
  }, y.Array !== Array && (a.alloc = y.pool(a.alloc, y.Array.prototype.subarray)), a.prototype._push = function(P, T, F) {
  ...
  var L = y.Array.prototype.set ? function(P, T, F) {
    T.set(P, F);
  } : function(P, T, F) {
...
var ii = (() => {
  ...
  return (async function(s = {}) {
    ...
    var S, L;
    (u || a) && (a ? v = self.location.href : typeof document < "u" && document.currentScript && (v = document.currentScript.src), y && (v = y), v.startsWith("blob:") ? v = "" : v = v.slice(0, v.replace(/[?#].*/, "").lastIndexOf("/") + 1), a && (L = (c) => {
    ...
    var T = t.wasmBinary, F, B = !1, Ie, Z, G, de, he, te, N, gt, ht, bt, vt, Ot = (c) => c.startsWith("file://");
    function wt() {
      var c = F.buffer;
    ...
    async function Ur() {
      function c(w, C) {
        return R = w.exports, R = A.instrumentWasmExports(R), F = R.D, wt(), R.J, Rr(), R;
      }
      _r();
      function l(w) {
        return c(w.instance);
    ...
    function nn(c) {
      ...
      var w = this.registeredClass.getActualType(l), C = _t[w];
      if (!C)
        return b.call(this);
      var O;
      this.isConst ? O = C.constPointerType : O = C.pointerType;
      var k = Lt(l, this.registeredClass, O.registeredClass);
    ...
    var mn = () => {
      Object.assign(Le.prototype, { getPointee(c) {
    ...
    function Le(c, l, p, m, b, w, C, O, k, _, M) {
      this.name = c, this.registeredClass = l, this.isReference = p, this.isConst = m, this.isSmartPointer = b, this.pointeeType = w, this.sharingPolicy = C, this.rawGetPointee = O, this.rawConstructor = k, this.rawShare = _, this.rawDestructor = M, !b && l.baseClass === void 0 ? m ? (this.toWireType = dn, this.destructorFunction = null) : (this.toWireType = fn, this.destructorFunction = null) : this.toWireType = pn;
    }
    var Rt = (c, l, p) => {
...
` + b.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    }, vn = (c, l, p, m, b, w, C, O, k, _, M, W, z) => {
      M = V(M), w = re(b, w), O &&= re(C, O), _ &&= re(k, _), z = re(W, z);
      var q = cn(M);
      Ye(q, function() {
        ...
        Q.prototype = ie;
        var U = new un(M, Q, ie, z, oe, w, O, _);
        U.baseClass && (U.baseClass.__derivedClasses ??= [], U.baseClass.__derivedClasses.push(U));
        var ae = new Le(M, U, !0, !1, !1), Re = new Le(M + "*", U, !1, !1, !1), Jt = new Le(M + " const*", U, !1, !0, !1);
        return _t[c] = { pointerType: Re, constPointerType: Jt }, Rt(q, Q), [ae, Re, Jt];
      });
    }, Nt = (c, l) => {
      for (var p = [], m = 0; m < c; m++)
        p.push(N[l + m * 4 >> 2]);
    ...
    var _e = (c) => {
      ...
      A.currData && A.state === A.State.Unwinding && A.exportCallStack.length === 0 && (A.state = A.State.Normal, _e(Io), typeof Fibers < "u" && Fibers.trampoline());
    }, whenDone() {
        ...
        if (A.state === A.State.Normal) {
          ...
          c((m = 0) => {
            if (!B && (A.handleSleepReturnValue = m, l = !0, !!p)) {
              A.state = A.State.Rewinding, _e(() => jo(A.currData)), typeof MainLoop < "u" && MainLoop.func && MainLoop.resume();
              var b, w = !1;
              try {
          ...
          }), p = !0, l || (A.state = A.State.Unwinding, A.currData = A.allocateData(), typeof MainLoop < "u" && MainLoop.func && MainLoop.pause(), _e(() => Po(A.currData)));
        } else A.state === A.State.Rewinding ? (A.state = A.State.Normal, _e(So), ee(A.currData), A.currData = null, A.sleepCallbacks.forEach(Gt)) : je(`invalid state: ${A.state}`);
    ...
    function $t(c, l, p, m, b, w) {
      ...
      var O = On(l), k = l[0].name !== "void", _ = C - 2, M = new Array(_), W = [], z = [], q = function(...X) {
        z.length = 0;
        var oe;
        W.length = 1, W[0] = b;
        for (var H = 0; H < _; ++H)
    ...
    var jn = (c, l, p, m, b, w) => {
      ...
      b = re(m, b), me([], [c], (O) => {
        ...
        }, me([], C, (_) => (_.splice(1, 0, null), O.registeredClass.constructor_body[l - 1] = $t(k, _, null, b, w), [])), [];
      });
    }, Bt = (c, l, p) => (c instanceof Object || x(`${p} with invalid "this": ${c}`), c instanceof l.registeredClass.constructor || x(`${p} incompatible with "this" of type ${c.constructor.name}`), c.$$.ptr || x(`cannot call emscripten binding method ${p} on deleted object`), Ee(c.$$.ptr, c.$$.ptrType.registeredClass, l.registeredClass)), Sn = (c, l, p, m, b, w, C, O, k, _) => {
      ...
      l = V(l), Y(c, { name: l, fromWireType: (m) => m, toWireType: (m, b) => b, argPackAdvance: K, readValueFromPointer: Ln(l, p), destructorFunction: null });
    }, Rn = (c) => {
      c = c.trim();
      const l = c.indexOf("(");
      ...
      }, Y(c, { name: l, fromWireType: w, toWireType: _, argPackAdvance: K, readValueFromPointer: At(l, p, m !== 0), destructorFunction: null });
    }, Nn = (c, l, p) => {
      ...
      l = V(l), Y(c, { name: l, fromWireType(p) {
        ...
        if (N[C >> 2] = b, w)
          ...
          for (var k = 0; k < b; ++k) {
            ...
            _ > 255 && (ee(C), x("String has UTF-16 code units that do not fit in 8 bits")), G[O + k] = _;
          }
        else
          for (var k = 0; k < b; ++k)
            G[O + k] = m[k];
      ...
      l === 2 ? (m = Bn, b = Hn, C = Yn, w = (O) => he[O >> 1]) : l === 4 && (m = Jn, b = Zn, C = Kn, w = (O) => N[O >> 2]), Y(c, { name: p, fromWireType: (O) => {
        for (var k = N[O >> 2], _, M = O + 4, W = 0; W <= k; ++W) {
          var z = O + 4 + W * l;
          if (W == k || w(z) == 0) {
            var q = z - M, X = m(M, q);
            _ === void 0 ? _ = X : (_ += "\0", _ += X), M = z + l;
          }
        }
        return ee(O), _;
      }, toWireType: (O, k) => {
        typeof k != "string" && x(`Cannot pass non-string to C++ string type ${p}`);
        var _ = C(k), M = Qe(4 + _ + l);
        return N[M >> 2] = _ / l, b(k, M + 4, _ + l), O !== null && O.push(ee, M), M;
    ...
    var vo = { g: Hr, u: Yr, n: Kr, y: qr, f: vn, d: jn, a: Sn, w: Dn, l: En, h: Mn, m: _n, b: Fn, e: xn, c: Nn, x: $n, i: qn, z: Xn, q: Qn, j: to, A: Ke, k: ro, o: io, C: ao, B: so, r: co, v: mo, s: ho, t: bo, p: Ut }, R = await Ur();
    R.E;
    var Oo = R.F, Qe = t._malloc = R.G, ee = t._free = R.H, wo = R.I;
    ...
    var Po = R.ea, Io = R.fa, jo = R.ga, So = R.ha;
    function et() {
      if (se > 0) {
        be = et;
        return;
      ...
      function c() {
        t.calledRun = !0, !B && (Mr(), e(t), t.onRuntimeInitialized?.(), Lr());
      }
