...
var Ro = (y, c, r) => c in y ? Eo(y, c, { enumerable: !0, configurable: !0, writable: !0, value: r }) : y[c] = r;
var Dt = (y, c, r) => Ro(y, typeof c != "symbol" ? c + "" : c, r), Yn = (y, c, r) => c.has(y) || Bn("Cannot " + r);
var be = (y, c, r) => (Yn(y, c, "read from private field"), r ? r.call(y) : c.get(y)), Et = (y, c, r) => c.has(y) ? Bn("Cannot add the same private member more than once") : c instanceof WeakSet ? c.add(y) : c.set(y, r), Rt = (y, c, r, t) => (Yn(y, c, "write to private field"), t ? t.call(y, r) : c.set(y, r), r);
/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */
const Po = Symbol("Comlink.proxy"), Mo = Symbol("Comlink.endpoint"), Fo = Symbol("Comlink.releaseProxy"), Ft = Symbol("Comlink.finalizer"), Lt = Symbol("Comlink.thrown"), jo = (y) => typeof y == "object" && y !== null || typeof y == "function", Lo = {
...
class Zo {
  constructor(c, r) {
    ...
    Et(this, Ge);
    Et(this, Je);
    Rt(this, _e, c), Rt(this, Ge, this.allocate(r.length * r.BYTES_PER_ELEMENT)), Rt(this, Je, this.allocate(r.length * r.BYTES_PER_ELEMENT));
  }
  ...
  function y(n) {
    return typeof Float32Array < "u" ? function() {
      ...
      function d(u, w, A, v, j) {
        var S = u(v, j + w), k = u(v, j + A), L = (k >> 31) * 2 + 1, I = k >>> 20 & 2047, R = 4294967296 * (k & 1048575) + S;
        return I === 2047 ? R ? NaN : L * (1 / 0) : I === 0 ? L * 5e-324 * R : L * Math.pow(2, I - 1075) * (R + 4503599627370496);
      }
...
function Ao() {
  ...
  function n(I, R, N) {
    this.fn = I, this.len = R, this.next = void 0, this.val = N;
  }
  function o() {
  }
  function d(I) {
  ...
  }, y.Array !== Array && (u.alloc = y.pool(u.alloc, y.Array.prototype.subarray)), u.prototype._push = function(I, R, N) {
    return this.tail = this.tail.next = new n(I, R, N), this.len += R, this;
  };
  function A(I, R, N) {
    R[N] = I & 255;
  }
  ...
  function j(I, R) {
    this.len = I, this.next = void 0, this.val = R;
  }
  ...
  function S(I, R, N) {
    for (; I.hi; )
      R[N++] = I.lo & 127 | 128, I.lo = (I.lo >>> 7 | I.hi << 25) >>> 0, I.hi >>>= 7;
    for (; I.lo > 127; )
      R[N++] = I.lo & 127 | 128, I.lo = I.lo >>> 7;
    R[N++] = I.lo;
  }
  u.prototype.uint64 = function(I) {
    ...
    var R = r.from(I).zzEncode();
    return this._push(S, R.length(), R);
  }, u.prototype.bool = function(I) {
    return this._push(A, 1, I ? 1 : 0);
  };
  function k(I, R, N) {
    R[N] = I & 255, R[N + 1] = I >>> 8 & 255, R[N + 2] = I >>> 16 & 255, R[N + 3] = I >>> 24;
  }
  ...
  var L = y.Array.prototype.set ? function(I, R, N) {
    R.set(I, N);
  } : function(I, R, N) {
  ...
  return u.prototype.bytes = function(I) {
    ...
    if (y.isString(I)) {
      var N = u.alloc(R = t.length(I));
      t.decode(I, N, 0), I = N;
    }
    return this.uint32(R)._push(L, R, I);
  }, u.prototype.string = function(I) {
    var R = e.length(I);
    return R ? this.uint32(R)._push(e.write, R, I) : this._push(A, 1, 0);
    ...
    var I = this.head, R = this.tail, N = this.len;
    return this.reset().uint32(N), N && (this.tail.next = I.next, this.tail = R, this.len += N), this;
  }, u.prototype.finish = function() {
    for (var I = this.head.next, R = this.constructor.alloc(this.len), N = 0; I; )
      I.fn(I.val, R, N), N += I.len, I = I.next;
    return R;
...
var M = pi();
const b = M.Reader, F = M.Writer, p = M.util, s = M.roots.default || (M.roots.default = {});
s.dot = (() => {
  const y = {};
...
var mi = (() => {
  ...
  return async function(c = {}) {
    ...
    var I = t.wasmBinary, R, N = !1, se, X, z, le, pe, Q, $, Ze, Ke, qe, Xe, Qe = (a) => a.startsWith("file://");
    function et() {
      var a = R.buffer;
    ...
    async function qt() {
      function a(h, O) {
        return _ = h.exports, _ = C.instrumentWasmExports(_), R = _.B, et(), _.H, Gt(), _;
      }
      zt();
      function i(h) {
        return a(h.instance);
...
` + m.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    }, It = (a, i, l) => (a instanceof Object || E(`${l} with invalid "this": ${a}`), a instanceof i.registeredClass.constructor || E(`${l} incompatible with "this" of type ${a.constructor.name}`), a.$$.ptr || E(`cannot call emscripten binding method ${l} on deleted object`), Se(a.$$.ptr, a.$$.ptrType.registeredClass, i.registeredClass)), Rr = (a, i, l, f, m, h, O, g, P, D) => {
    ...
    var jn = { i: tr, s: rr, n: ir, w: ar, f: Tr, d: Er, a: Rr, u: xr, l: $r, g: Wr, m: Ur, b: Gr, e: Hr, c: Br, v: Xr, h: an, x: sn, q: ln, j: un, y: Ne, k: dn, o: mn, A: yn, z: gn, r: bn, t: Pn, p: wt }, _ = await qt();
    _.C;
