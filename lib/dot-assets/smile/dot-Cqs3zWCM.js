...
var _o = (h, u, n) => u in h ? ko(h, u, { enumerable: !0, configurable: !0, writable: !0, value: n }) : h[u] = n;
var kt = (h, u, n) => _o(h, typeof u != "symbol" ? u + "" : u, n), Hn = (h, u, n) => u.has(h) || Bn("Cannot " + n);
var ve = (h, u, n) => (Hn(h, u, "read from private field"), n ? n.call(h) : u.get(h)), Et = (h, u, n) => u.has(h) ? Bn("Cannot add the same private member more than once") : u instanceof WeakSet ? u.add(h) : u.set(h, n), Ft = (h, u, n, t) => (Hn(h, u, "write to private field"), t ? t.call(h, n) : u.set(h, n), n);
/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */
const wo = Symbol("Comlink.proxy"), Eo = Symbol("Comlink.endpoint"), Fo = Symbol("Comlink.releaseProxy"), Mt = Symbol("Comlink.finalizer"), Lt = Symbol("Comlink.thrown"), Po = (h) => typeof h == "object" && h !== null || typeof h == "function", Ro = {
  canHandle: (h) => Po(h) && h[wo],
  serialize(h) {
...
function Gn(h, u = globalThis, n = ["*"]) {
  u.addEventListener("message", function t(e) {
    ...
    Promise.resolve(w).catch((D) => ({ value: D, [Lt]: 0 })).then((D) => {
      const [v, I] = Wt(D);
      u.postMessage(Object.assign(Object.assign({}, v), { id: r }), I), a === "RELEASE" && (u.removeEventListener("message", t), Io(u), Mt in h && typeof h[Mt] == "function" && h[Mt]());
    }).catch((D) => {
      const [v, I] = Wt({
...
const xt = /* @__PURE__ */ new WeakMap(), $t = "FinalizationRegistry" in globalThis && new FinalizationRegistry((h) => {
  const u = (xt.get(h) || 0) - 1;
  xt.set(h, u), u === 0 && jo(h);
});
function Wo(h, u) {
  const n = (xt.get(u) || 0) + 1;
  xt.set(u, n), $t && $t.register(h, u, h);
}
function No(h) {
  $t && $t.unregister(h);
}
function zn(h, u, n = [], t = function() {
}) {
  let e = !1;
  const r = new Proxy(t, {
    get(a, d) {
...
function Yn(h) {
  const u = h.map(Wt);
  return [u.map((n) => n[0]), Uo(u.map((n) => n[1]))];
}
...
function ze(h) {
  switch (h.type) {
    case "HANDLER":
      return Co.get(h.name).deserialize(h.value);
    case "RAW":
      return h.value;
  }
}
...
class Yo {
  constructor(u, n) {
    ...
    Et(this, Ge);
    Et(this, Je);
    Ft(this, _e, u), Ft(this, Ge, this.allocate(n.length * n.BYTES_PER_ELEMENT)), Ft(this, Je, this.allocate(n.length * n.BYTES_PER_ELEMENT));
  }
...
class Jo {
  ...
  async getSamWasmFileName() {
    return await Bo() ? Jn.simd : Jn.sam;
  }
  ...
  writeImageToMemory(u) {
    ...
    const n = new Yo(this.samWasmModule, u);
...
const Ko = (h) => Number.parseFloat(h.toFixed(3)), Zo = (h, u) => Math.min(h, u);
var He = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Kn = {}, kn = {}, _n, Zn;
function qo() {
  if (Zn) return _n;
  Zn = 1, _n = h;
  function h(u, n) {
...
var so;
function Be() {
  return so || (so = 1, function(h) {
    var u = h;
    u.asPromise = qo(), u.base64 = Xo(), u.EventEmitter = Qo(), u.float = ei(), u.inquire = ti(), u.utf8 = ri(), u.pool = ni(), u.LongBits = oi(), u.isNode = !!(typeof He < "u" && He && He.process && He.process.versions && He.process.versions.node), u.global = u.isNode && He || typeof window < "u" && window || typeof self < "u" && self || kn, u.emptyArray = Object.freeze ? Object.freeze([]) : (
...
function To() {
  ...
  }, h.Array !== Array && (c.alloc = h.pool(c.alloc, h.Array.prototype.subarray)), c.prototype._push = function(C, F, L) {
  ...
  var R = h.Array.prototype.set ? function(C, F, L) {
    F.set(C, L);
  } : function(C, F, L) {
...
var ho, go;
function ci() {
  return go || (go = 1, ho = {}), ho;
}
var vo;
function ui() {
  return vo || (vo = 1, function(h) {
    var u = h;
    u.build = "minimal", u.Writer = To(), u.BufferWriter = ii(), u.Reader = Ao(), u.BufferReader = ai(), u.util = Be(), u.rpc = li(), u.roots = ci(), u.configure = n;
    function n() {
...
var bo, Oo;
function di() {
  return Oo || (Oo = 1, bo = ui()), bo;
}
var x = di();
const O = x.Reader, W = x.Writer, p = x.util, s = x.roots.default || (x.roots.default = {});
s.dot = (() => {
  const h = {};
  return h.Content = function() {
    ...
    return u.prototype.token = p.newBuffer([]), u.prototype.iv = p.newBuffer([]), u.prototype.schemaVersion = 0, u.prototype.bytes = p.newBuffer([]), u.create = function(n) {
      ...
      return t || (t = W.create()), n.token != null && Object.hasOwnProperty.call(n, "token") && t.uint32(
        /* id 1, wireType 2 =*/
        10
    ...
    return u.MagnifEyeLivenessContent = function() {
      ...
      return Object.defineProperty(n.prototype, "_video", {
        ...
        if (r || (r = W.create()), e.images != null && e.images.length)
      ...
      return Object.defineProperty(n.prototype, "_sessionToken", {
        ...
        return r || (r = W.create()), e.platform != null && Object.hasOwnProperty.call(e, "platform") && r.uint32(
          /* id 1, wireType 0 =*/
          8
      ...
      return Object.defineProperty(n.prototype, "_device", {
        ...
        if (r || (r = W.create()), e.supportedAbis != null && e.supportedAbis.length)
      ...
      return n.prototype.resolution = null, n.prototype.rotationDegrees = 0, n.create = function(t) {
        ...
        return e || (e = W.create()), t.resolution != null && Object.hasOwnProperty.call(t, "resolution") && s.dot.ImageSize.encode(t.resolution, e.uint32(
          /* id 1, wireType 2 =*/
          10
      ...
      return n.prototype.size = null, n.prototype.yPlane = p.newBuffer([]), n.prototype.uPlane = p.newBuffer([]), n.prototype.vPlane = p.newBuffer([]), n.create = function(t) {
        ...
        return e || (e = W.create()), t.size != null && Object.hasOwnProperty.call(t, "size") && s.dot.ImageSize.encode(t.size, e.uint32(
          /* id 1, wireType 2 =*/
          10
      ...
      return n.prototype.image = null, n.prototype.topLeftCorner = null, n.create = function(t) {
        ...
        return e || (e = W.create()), t.image != null && Object.hasOwnProperty.call(t, "image") && s.dot.v4.Yuv420Image.encode(t.image, e.uint32(
          /* id 1, wireType 2 =*/
          10
      ...
      return Object.defineProperty(n.prototype, "_camera", {
        ...
        if (r || (r = W.create()), e.cameraModelId != null && Object.hasOwnProperty.call(e, "cameraModelId") && r.uint32(
          /* id 1, wireType 2 =*/
          10
      ...
      return n.prototype.image = null, n.prototype.topLeftCorner = null, n.create = function(t) {
        ...
        return e || (e = W.create()), t.image != null && Object.hasOwnProperty.call(t, "image") && s.dot.v4.IosYuv420Image.encode(t.image, e.uint32(
          /* id 1, wireType 2 =*/
          10
        ).fork()).ldelim(), t.topLeftCorner != null && Object.hasOwnProperty.call(t, "topLeftCorner") && s.dot.PointInt.encode(t.topLeftCorner, e.uint32(
          /* id 2, wireType 2 =*/
      ...
      return Object.defineProperty(n.prototype, "_croppedImage", {
        ...
        if (r || (r = W.create()), e.currentCameraProperties != null && Object.hasOwnProperty.call(e, "currentCameraProperties") && s.dot.v4.MediaTrackSettings.encode(e.currentCameraProperties, r.uint32(
          /* id 1, wireType 2 =*/
          10
      ...
      return n.prototype.imageHash = "", n.prototype.timestampMillis = p.Long ? p.Long.fromBits(0, 0, !0) : 0, n.create = function(t) {
        ...
        return e || (e = W.create()), t.imageHash != null && Object.hasOwnProperty.call(t, "imageHash") && e.uint32(
          /* id 1, wireType 2 =*/
          10
      ...
      return Object.defineProperty(n.prototype, "_aspectRatio", {
        ...
        return r || (r = W.create()), e.aspectRatio != null && Object.hasOwnProperty.call(e, "aspectRatio") && r.uint32(
          /* id 1, wireType 1 =*/
          9
      ...
      return n.prototype.width = 0, n.prototype.height = 0, n.create = function(t) {
        ...
        return e || (e = W.create()), t.width != null && Object.hasOwnProperty.call(t, "width") && e.uint32(
          /* id 1, wireType 0 =*/
          8
      ...
      return Object.defineProperty(n.prototype, "_cameraInitFrameResolution", {
        ...
        return r || (r = W.create()), e.cameraInitFrameResolution != null && Object.hasOwnProperty.call(e, "cameraInitFrameResolution") && s.dot.v4.ImageBitmap.encode(e.cameraInitFrameResolution, r.uint32(
          /* id 1, wireType 2 =*/
          10
      ...
      return n.prototype.brightness = 0, n.prototype.sharpness = 0, n.prototype.hotspots = 0, n.prototype.confidence = 0, n.prototype.faceSize = 0, n.prototype.faceCenter = null, n.prototype.smallestEdge = 0, n.prototype.bottomLeft = null, n.prototype.bottomRight = null, n.prototype.topLeft = null, n.prototype.topRight = null, n.create = function(t) {
        ...
        return e || (e = W.create()), t.brightness != null && Object.hasOwnProperty.call(t, "brightness") && e.uint32(
          /* id 1, wireType 5 =*/
          13
      ...
      return n.prototype.x = 0, n.prototype.y = 0, n.create = function(t) {
        ...
        return e || (e = W.create()), t.x != null && Object.hasOwnProperty.call(t, "x") && e.uint32(
          /* id 1, wireType 5 =*/
          13
      ...
      return n.prototype.image = null, n.prototype.topLeftCorner = null, n.create = function(t) {
        ...
        return e || (e = W.create()), t.image != null && Object.hasOwnProperty.call(t, "image") && s.dot.Image.encode(t.image, e.uint32(
          /* id 1, wireType 2 =*/
          10
      ...
      return Object.defineProperty(n.prototype, "_platform", {
        ...
        if (r || (r = W.create()), e.userAgent != null && Object.hasOwnProperty.call(e, "userAgent") && r.uint32(
          /* id 1, wireType 2 =*/
          10
      ...
      return n.prototype.name = "", n.prototype.version = "", n.create = function(t) {
        ...
        return e || (e = W.create()), t.name != null && Object.hasOwnProperty.call(t, "name") && e.uint32(
          /* id 1, wireType 2 =*/
          10
      ...
      return Object.defineProperty(n.prototype, "_video", {
        ...
        return r || (r = W.create()), e.image != null && Object.hasOwnProperty.call(e, "image") && s.dot.Image.encode(e.image, r.uint32(
          /* id 1, wireType 2 =*/
          10
      ...
      return Object.defineProperty(n.prototype, "blob", {
        ...
        return r || (r = W.create()), e.documentContent != null && Object.hasOwnProperty.call(e, "documentContent") && s.dot.v4.DocumentContent.encode(e.documentContent, r.uint32(
          /* id 1, wireType 2 =*/
          10
      ...
      return n.prototype.ldsMasterFile = null, n.prototype.accessControlProtocolUsed = 0, n.prototype.authenticationStatus = null, n.prototype.metadata = null, n.create = function(t) {
        ...
        return e || (e = W.create()), t.ldsMasterFile != null && Object.hasOwnProperty.call(t, "ldsMasterFile") && s.dot.v4.LdsMasterFile.encode(t.ldsMasterFile, e.uint32(
          /* id 1, wireType 2 =*/
          10
      ...
      return n.prototype.lds1eMrtdApplication = null, n.create = function(t) {
        ...
        return e || (e = W.create()), t.lds1eMrtdApplication != null && Object.hasOwnProperty.call(t, "lds1eMrtdApplication") && s.dot.v4.Lds1eMrtdApplication.encode(t.lds1eMrtdApplication, e.uint32(
          /* id 1, wireType 2 =*/
          10
        ).fork()).ldelim(), e;
      }, n.encodeDelimited = function(t, e) {
      ...
      return Object.defineProperty(n.prototype, "_dg3AdditionalIdentificationFeatureFingers", {
        ...
        return r || (r = W.create()), e.comHeaderAndDataGroupPresenceInformation != null && Object.hasOwnProperty.call(e, "comHeaderAndDataGroupPresenceInformation") && s.dot.v4.Lds1ElementaryFile.encode(e.comHeaderAndDataGroupPresenceInformation, r.uint32(
          /* id 1, wireType 2 =*/
          10
      ...
      return Object.defineProperty(n.prototype, "_bytes", {
        ...
        return r || (r = W.create()), e.id != null && Object.hasOwnProperty.call(e, "id") && r.uint32(
          /* id 1, wireType 0 =*/
          8
      ...
      return n.prototype.data = null, n.prototype.chip = null, n.create = function(t) {
        ...
        return e || (e = W.create()), t.data != null && Object.hasOwnProperty.call(t, "data") && s.dot.v4.DataAuthenticationStatus.encode(t.data, e.uint32(
          /* id 1, wireType 2 =*/
          10
      ...
      return n.prototype.status = 0, n.prototype.protocol = 0, n.create = function(t) {
        ...
        return e || (e = W.create()), t.status != null && Object.hasOwnProperty.call(t, "status") && e.uint32(
          /* id 1, wireType 0 =*/
          8
      ...
      return Object.defineProperty(n.prototype, "_protocol", {
        ...
        return r || (r = W.create()), e.status != null && Object.hasOwnProperty.call(e, "status") && r.uint32(
          /* id 1, wireType 0 =*/
          8
      ...
      return Object.defineProperty(n.prototype, "_image", {
        ...
        if (r || (r = W.create()), e.segments != null && e.segments.length)
      ...
      return n.prototype.corner = 0, n.prototype.image = null, n.create = function(t) {
        ...
        return e || (e = W.create()), t.corner != null && Object.hasOwnProperty.call(t, "corner") && e.uint32(
          /* id 1, wireType 0 =*/
          8
      ...
      return Object.defineProperty(n.prototype, "_video", {
        ...
        return r || (r = W.create()), e.neutralExpressionFaceImage != null && Object.hasOwnProperty.call(e, "neutralExpressionFaceImage") && s.dot.Image.encode(e.neutralExpressionFaceImage, r.uint32(
          /* id 1, wireType 2 =*/
          10
    ...
    return u.prototype.bytes = p.newBuffer([]), u.create = function(n) {
      ...
      return t || (t = W.create()), n.bytes != null && Object.hasOwnProperty.call(n, "bytes") && t.uint32(
        /* id 1, wireType 2 =*/
        10
      ).bytes(n.bytes), t;
    }, u.encodeDelimited = function(n, t) {
    ...
    return u.prototype.width = 0, u.prototype.height = 0, u.create = function(n) {
      ...
      return t || (t = W.create()), n.width != null && Object.hasOwnProperty.call(n, "width") && t.uint32(
        /* id 1, wireType 0 =*/
        8
    ...
    return u.prototype.items = p.emptyArray, u.create = function(n) {
      ...
      if (t || (t = W.create()), n.items != null && n.items.length) {
        t.uint32(
          /* id 1, wireType 2 =*/
          10
        ).fork();
    ...
    return u.prototype.left = 0, u.prototype.top = 0, u.prototype.right = 0, u.prototype.bottom = 0, u.create = function(n) {
      ...
      return t || (t = W.create()), n.left != null && Object.hasOwnProperty.call(n, "left") && t.uint32(
        /* id 1, wireType 1 =*/
        9
    ...
    return u.prototype.digest = p.newBuffer([]), u.prototype.timestampMillis = p.Long ? p.Long.fromBits(0, 0, !0) : 0, u.create = function(n) {
      ...
      return t || (t = W.create()), n.digest != null && Object.hasOwnProperty.call(n, "digest") && t.uint32(
        /* id 1, wireType 2 =*/
        10
    ...
    return u.prototype.x = 0, u.prototype.y = 0, u.create = function(n) {
      ...
      return t || (t = W.create()), n.x != null && Object.hasOwnProperty.call(n, "x") && t.uint32(
        /* id 1, wireType 0 =*/
        8
...
var fi = (() => {
  ...
  return async function(u = {}) {
    ...
    var C = t.wasmBinary, F, L = !1, se, X, z, le, pe, Q, $, Ke, Ze, qe, Xe, Qe = (i) => i.startsWith("file://");
    function et() {
      var i = F.buffer;
      t.HEAP8 = X = new Int8Array(i), t.HEAP16 = le = new Int16Array(i), t.HEAPU8 = z = new Uint8Array(i), t.HEAPU16 = pe = new Uint16Array(i), t.HEAP32 = Q = new Int32Array(i), t.HEAPU32 = $ = new Uint32Array(i), t.HEAPF32 = Ke = new Float32Array(i), t.HEAPF64 = Xe = new Float64Array(i), t.HEAP64 = Ze = new BigInt64Array(i), t.HEAPU64 = qe = new BigUint64Array(i);
    }
    function Nt() {
      if (t.preRun)
    ...
    async function Jt(i, o) {
      try {
        var l = await Yt(i), f = await WebAssembly.instantiate(l, o);
        return f;
      } catch (m) {
        R(`failed to asynchronously prepare wasm: ${m}`), be(m);
      }
    }
    async function Kt(i, o, l) {
    ...
    async function qt() {
      function i(g, b) {
        return _ = g.exports, _ = j.instrumentWasmExports(_), F = _.B, et(), _.H, Gt(), _;
      }
      zt();
      function o(g) {
        return i(g.instance);
    ...
    var rt = (i) => {
      for (; i.length > 0; )
        i.shift()(t);
    }, nt = [], Xt = (i) => nt.unshift(i), ot = [], Qt = (i) => ot.unshift(i), it = t.noExitRuntime || !0;
    class er {
      constructor(o) {
    ...
    var ct = (i, o, l) => {
      ...
      o = N(o), B(i, { name: o, fromWireType: function(m) {
        return !!m;
    ...
    }, sr = (i) => ({ count: i.count, deleteScheduled: i.deleteScheduled, preservePointerOnDelete: i.preservePointerOnDelete, ptr: i.ptr, ptrType: i.ptrType, smartPtr: i.smartPtr, smartPtrType: i.smartPtrType }), Fe = (i) => {
      function o(l) {
    ...
    function fr(i) {
      ...
      var l = dr(this.registeredClass, o);
      if (l !== void 0) {
        if (l.$$.count.value === 0)
    ...
    var ye = (i) => typeof FinalizationRegistry > "u" ? (ye = (o) => o, i) : (Re = new FinalizationRegistry((o) => {
      ...
      Object.assign(Ie.prototype, { isAliasOf(i) {
        ...
        var i = ye(Object.create(Object.getPrototypeOf(this), { $$: { value: sr(this.$$) } }));
    ...
    var je = (i, o) => Object.defineProperty(o, "name", { value: i }), mr = (i, o, l) => {
      ...
      t.hasOwnProperty(i) ? ((l === void 0 || t[i].overloadTable !== void 0 && t[i].overloadTable[l] !== void 0) && E(`Cannot register public name '${i}' twice`), mr(t, i, i), t[i].overloadTable.hasOwnProperty(l) && E(`Cannot register multiple overloads of a function with the same number of arguments (${l})!`), t[i].overloadTable[l] = o) : (t[i] = o, t[i].argCount = l);
    }, yr = 48, hr = 57, gr = (i) => {
      i = i.replace(/[^a-zA-Z0-9_]/g, "$");
      var o = i.charCodeAt(0);
      return o >= yr && o <= hr ? `_${i}` : i;
    };
    function vr(i, o, l, f, m, g, b, y) {
    ...
    function Ae(i, o, l, f, m, g, b, y, P, k, T) {
      this.name = i, this.registeredClass = o, this.isReference = l, this.isConst = f, this.isSmartPointer = m, this.pointeeType = g, this.sharingPolicy = b, this.rawGetPointee = y, this.rawConstructor = P, this.rawShare = k, this.rawDestructor = T, !m && o.baseClass === void 0 ? f ? (this.toWireType = br, this.destructorFunction = null) : (this.toWireType = wr, this.destructorFunction = null) : this.toWireType = Or;
    }
    var mt = (i, o, l) => {
...
` + m.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    }, Tr = (i, o, l, f, m, g, b, y, P, k, T, M, U) => {
      T = N(T), g = ee(m, g), y && (y = ee(b, y)), k && (k = ee(P, k)), U = ee(M, U);
      var J = gr(T);
      Me(J, function() {
        ...
        K = K[0];
        var re, G;
        f ? (re = K.registeredClass, G = re.instancePrototype) : G = Ie.prototype;
        var Z = je(T, function(...Ve) {
        ...
        }), ne = Object.create(G, { constructor: { value: Z } });
        Z.prototype = ne;
        var V = new vr(T, Z, ne, U, re, g, y, k);
        ...
        return pt[i] = { pointerType: ke, constPointerType: Tt }, mt(J, Z), [oe, ke, Tt];
      });
    }, gt = (i, o) => {
      for (var l = [], f = 0; f < i; f++)
        l.push($[o + f * 4 >> 2]);
    ...
    var De = (i) => {
      ...
      var o;
      se = i, Ot() || ((o = t.onExit) == null || o.call(t, i), L = !0), D(i, new tt(i));
    }, Dr = (i, o) => {
      se = i, wt(i);
    }, kr = Dr, _r = () => {
      if (!Ot())
      ...
      for (let [l, f] of Object.entries(i))
        typeof f == "function" ? o[l] = (...m) => {
          ...
          try {
            ...
            L || (j.exportCallStack.pop(), j.maybeStopUnwind());
          }
        } : o[l] = f;
      return o;
      ...
      if (!L) {
        if (j.state === j.State.Normal) {
          var o = !1, l = !1;
          i((f = 0) => {
            if (!L && (j.handleSleepReturnValue = f, o = !0, !!l)) {
              j.state = j.State.Rewinding, De(() => An(j.currData)), typeof MainLoop < "u" && MainLoop.func && MainLoop.resume();
              var m, g = !1;
              try {
          ...
          }), l = !0, o || (j.state = j.State.Unwinding, j.currData = j.allocateData(), typeof MainLoop < "u" && MainLoop.func && MainLoop.pause(), De(() => Sn(j.currData)));
    ...
    function Ct(i, o, l, f, m, g) {
      ...
      var y = Ar(o), P = o[0].name !== "void", k = b - 2, T = new Array(k), M = [], U = [], J = function(...K) {
        U.length = 0;
        var re;
        M.length = 1, M[0] = m;
        for (var G = 0; G < k; ++G)
          T[G] = o[G + 2].toWireType(U, K[G]), M.push(T[G]);
        var Z = f(...M);
        function ne(V) {
          if (y)
            Le(U);
        ...
        return j.currData ? j.whenDone().then(ne) : ne(Z);
      };
      return je(i, J);
    }
    var Er = (i, o, l, f, m, g) => {
    ...
    }, It = (i, o, l) => (i instanceof Object || E(`${l} with invalid "this": ${i}`), i instanceof o.registeredClass.constructor || E(`${l} incompatible with "this" of type ${i.constructor.name}`), i.$$.ptr || E(`cannot call emscripten binding method ${l} on deleted object`), Se(i.$$.ptr, i.$$.ptrType.registeredClass, o.registeredClass)), Fr = (i, o, l, f, m, g, b, y, P, k) => {
      o = N(o), m = ee(f, m), de([], [i], (T) => {
        T = T[0];
        var M = `${T.name}.${o}`, U = { get() {
          he(`Cannot access ${M} due to unbound types`, [l, b]);
        }, enumerable: !0, configurable: !0 };
        return P ? U.set = () => he(`Cannot access ${M} due to unbound types`, [l, b]) : U.set = (J) => E(M + " is a read-only property"), Object.defineProperty(T.registeredClass.instancePrototype, o, U), de([], P ? [l, b] : [l], (J) => {
          var K = J[0], re = { get() {
            var Z = It(this, T, M + " getter");
            return K.fromWireType(m(g, Z));
          }, enumerable: !0 };
          if (P) {
            P = ee(y, P);
            var G = J[1];
            re.set = function(Z) {
              var ne = It(this, T, M + " setter"), V = [];
              P(k, ne, G.toWireType(V, Z)), Le(V);
            };
          }
    ...
    } }, Lr = { name: "emscripten::val", fromWireType: (i) => {
      var o = H.toValue(i);
      return $e(i), o;
    }, toWireType: (i, o) => H.toHandle(o), argPackAdvance: Y, readValueFromPointer: Te, destructorFunction: null }, xr = (i) => B(i, Lr), $r = (i, o, l) => {
      switch (o) {
        case 1:
          return l ? function(f) {
      ...
      }, toWireType: (g, b) => b.value, argPackAdvance: Y, readValueFromPointer: $r(o, l, f), destructorFunction: null }), Me(o, m);
    }, We = (i, o) => {
      var l = ae[i];
      ...
      switch (o) {
        case 4:
          return function(l) {
            return this.fromWireType(Ke[l >> 2]);
          };
        case 8:
          return function(l) {
      ...
      o = N(o), B(i, { name: o, fromWireType: (f) => f, toWireType: (f, m) => m, argPackAdvance: Y, readValueFromPointer: Ur(o, l), destructorFunction: null });
    }, zr = (i) => {
      i = i.trim();
      const o = i.indexOf("(");
      ...
      var P = gt(o, l);
      i = N(i), i = zr(i), m = ee(f, m), Me(i, function() {
      ...
      var y = o.includes("unsigned"), P = (T, M) => {
      }, k;
      y ? k = function(T, M) {
      ...
      l = N(l), B(i, { name: l, fromWireType: g, argPackAdvance: Y, readValueFromPointer: g }, { ignoreDuplicateRegistrations: !0 });
    }, Yr = (i, o, l, f) => {
      if (!(f > 0)) return 0;
      ...
      return g;
    }, qr = (i, o) => i ? Zr(z, i, o) : "", Xr = (i, o) => {
      o = N(o), B(i, { name: o, fromWireType(l) {
        ...
        g || f instanceof Uint8Array || f instanceof Uint8ClampedArray || f instanceof Int8Array || E("Cannot pass non-string to std::string"), g ? m = Kr(f) : m = f.length;
        var b = Ne(4 + m + 1), y = b + 4;
        if ($[b >> 2] = m, g)
          Jr(f, y, m + 1);
        else if (g)
          for (var P = 0; P < m; ++P) {
      ...
      l = N(l);
      var f, m, g, b;
      o === 2 ? (f = Qr, m = en, b = tn, g = (y) => pe[y >> 1]) : o === 4 && (f = rn, m = nn, b = on, g = (y) => $[y >> 2]), B(i, { name: l, fromWireType: (y) => {
        for (var P = $[y >> 2], k, T = y + 4, M = 0; M <= P; ++M) {
          var U = y + 4 + M * o;
          if (M == P || g(U) == 0) {
            var J = U - T, K = f(T, J);
            k === void 0 ? k = K : (k += "\0", k += K), T = U + o;
          }
        }
        return q(y), k;
      }, toWireType: (y, P) => {
        typeof P != "string" && E(`Cannot pass non-string to C++ string type ${l}`);
        var k = b(P), T = Ne(4 + k + o);
        return $[T >> 2] = k / o, m(P, T + 4, k + o), y !== null && y.push(q, T), T;
      }, argPackAdvance: Y, readValueFromPointer: Te, destructorFunction(y) {
        q(y);
      } });
    }, sn = (i, o) => {
      o = N(o), B(i, { isVoid: !0, name: o, argPackAdvance: 0, fromWireType: () => {
      }, toWireType: (l, f) => {
      } });
    }, ln = () => {
      it = !1, bt = 0;
    ...
    }, un = (i, o, l) => (i = H.toValue(i), o = We(o, "emval::as"), cn(o, l, i)), dn = (i, o) => (i = H.toValue(i), o = H.toValue(o), H.toHandle(i[o])), fn = {}, pn = (i) => {
      var o = fn[i];
      return o === void 0 ? N(i) : o;
    }, mn = (i) => H.toHandle(pn(i)), yn = (i) => {
      var o = H.toValue(i);
      Le(o), $e(i);
    }, hn = (i, o) => {
      i = We(i, "_emval_take_value");
      var l = i.readValueFromPointer(o);
      return H.toHandle(l);
    }, ge = {}, gn = () => performance.now(), vn = (i, o) => {
      if (ge[i] && (clearTimeout(ge[i].id), delete ge[i]), !o) return 0;
      var l = setTimeout(() => {
        delete ge[i], Pt(() => jn(i, gn()));
      }, o);
      return ge[i] = { id: l, timeout_ms: o }, 0;
    }, bn = () => 2147483648, On = (i, o) => Math.ceil(i / o) * o, wn = (i) => {
      ...
      for (var f = 1; f <= 4; f *= 2) {
        ...
        var g = Math.min(l, On(Math.max(i, m), 65536)), b = wn(g);
        if (b)
          return !0;
      }
      return !1;
    ...
    }, pr(), Pr(), yt = t.UnboundTypeError = Sr(Error, "UnboundTypeError"), Mr();
    var Cn = { n: tr, u: rr, m: ir, x: ar, f: Tr, e: Er, a: Fr, v: xr, k: Wr, g: Nr, l: Vr, b: Gr, d: Br, c: Hr, w: Xr, h: an, y: sn, r: ln, i: un, z: $e, j: dn, p: mn, o: yn, A: hn, s: vn, t: Pn, q: wt }, _ = await qt();
    _.C;
    var In = _.D, Ne = t._malloc = _.E, q = t._free = _.F, jn = _.G;
    ...
    var Sn = _.ca, Tn = _.da, An = _.ea, Dn = _.fa;
    function Ue() {
      if (ie > 0) {
        me = Ue;
        return;
      ...
      function i() {
        var o;
        t.calledRun = !0, !L && (Ut(), e(t), (o = t.onRuntimeInitialized) == null || o.call(t), Vt());
      }
...
function mi(h, u) {
  if (h.confidence <= 0 || u.confidence <= 0)
    return { x: 0, y: 0 };
  const n = Do(h.center, u.center), t = pi(h.center, u.center);
  return {
    x: t.x,
    y: t.y + n / 4
...
function yi(h, u, n) {
  if (h.confidence <= 0 || u.confidence <= 0)
    return 0;
  const t = Do(h.center, u.center), e = Zo(n.width, n.height);
  return Ko(t / e);
}
function Vn(h) {
...
class hi extends Jo {
  ...
  parseRawData(u, n) {
    const { brightness: t, sharpness: e } = u.params, { bottomRightX: r, bottomRightY: a, leftEye: d, mouth: c, rightEye: w, topLeftX: D, topLeftY: v } = u, I = Vn(d), S = Vn(w), A = Vn(c);
    return {
