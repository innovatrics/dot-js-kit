const fo = /* @__PURE__ */ Symbol("Comlink.proxy"), Po = /* @__PURE__ */ Symbol("Comlink.endpoint"), Io = /* @__PURE__ */ Symbol("Comlink.releaseProxy"), Tt = /* @__PURE__ */ Symbol("Comlink.finalizer"), At = /* @__PURE__ */ Symbol("Comlink.thrown"), po = (g) => typeof g == "object" && g !== null || typeof g == "function", jo = {
...
function Ln(g, c = globalThis, r = ["*"]) {
  c.addEventListener("message", function t(e) {
    ...
    let O;
    try {
      const k = d.slice(0, -1).reduce((I, S) => I[S], g), b = d.reduce((I, S) => I[S], g);
      switch (o) {
        case "GET":
          O = b;
          break;
        case "SET":
          k[d.slice(-1)[0]] = Ve(e.data.value), O = !0;
          break;
        case "APPLY":
          O = b.apply(k, u);
          break;
    ...
    Promise.resolve(O).catch((k) => ({ value: k, [At]: 0 })).then((k) => {
      const [b, I] = Et(k);
      c.postMessage(Object.assign(Object.assign({}, b), { id: n }), I), o === "RELEASE" && (c.removeEventListener("message", t), yo(c), Tt in g && typeof g[Tt] == "function" && g[Tt]());
    }).catch((k) => {
      const [b, I] = Et({
        value: new TypeError("Unserializable return value"),
        [At]: 0
      });
      c.postMessage(Object.assign(Object.assign({}, b), { id: n }), I);
    });
  }), c.start && c.start();
}
function To(g) {
...
const kt = /* @__PURE__ */ new WeakMap(), Dt = "FinalizationRegistry" in globalThis && new FinalizationRegistry((g) => {
  const c = (kt.get(g) || 0) - 1;
  kt.set(g, c), c === 0 && go(g);
});
function ko(g, c) {
  const r = (kt.get(c) || 0) + 1;
  kt.set(c, r), Dt && Dt.register(g, c, g);
}
function Do(g) {
  Dt && Dt.unregister(g);
}
...
function Nn(g) {
  const c = g.map(Et);
  return [c.map((r) => r[0]), Eo(c.map((r) => r[1]))];
}
...
class No {
  ...
  async getOptimalRegionForCompressionDetectionFromDetectionCorners(c, r, t) {
    ...
    const e = this.convertToSamColorImage(c, r), { bottomLeft: n, topLeft: o, topRight: d } = t, u = [
      ...
      n.y - o.y
      // height
    ], { height: O, width: k, x: b, y: I } = await this.samWasmModule.selectDetailRegion(
      r.width,
      r.height,
      e.bgr0ImagePointer,
      u
...
const xn = (g) => Number.parseFloat(g.toFixed(3)), vo = (g, c) => Math.min(g, c);
function $o(g, c) {
  const r = vo(c.width, c.height);
  return xn(g * r);
}
      ...
      t[e] = function(O) {
        if (o)
          if (o = !1, O)
            ...
            for (var k = new Array(arguments.length - 1), b = 0; b < k.length; )
              k[b++] = arguments[b];
            d.apply(null, k);
          }
      };
...
function Uo() {
  return zn || (zn = 1, (function(g) {
    ...
    c.encode = function(o, d, u) {
      for (var O = null, k = [], b = 0, I = 0, S; d < u; ) {
        var A = o[d++];
        switch (I) {
          case 0:
            k[b++] = r[A >> 2], S = (A & 3) << 4, I = 1;
            break;
          case 1:
            k[b++] = r[S | A >> 4], S = (A & 15) << 2, I = 2;
            break;
          case 2:
            k[b++] = r[S | A >> 6], k[b++] = r[A & 63], I = 0;
            break;
        }
        b > 8191 && ((O || (O = [])).push(String.fromCharCode.apply(String, k)), b = 0);
      }
      return I && (k[b++] = r[S], k[b++] = 61, I === 1 && (k[b++] = 61)), O ? (b && O.push(String.fromCharCode.apply(String, k.slice(0, b))), O.join("")) : String.fromCharCode.apply(String, k.slice(0, b));
    };
    var n = "invalid encoding";
    c.decode = function(o, d, u) {
      for (var O = u, k = 0, b, I = 0; I < o.length; ) {
        ...
        switch (k) {
          case 0:
            ...
            break;
          case 1:
            d[u++] = b << 2 | (S & 48) >> 4, b = S, k = 2;
            break;
          case 2:
            d[u++] = (b & 15) << 4 | (S & 60) >> 2, b = S, k = 3;
            break;
          case 3:
            d[u++] = (b & 3) << 6 | S, k = 0;
            break;
...
function Go() {
  ...
  function g(n) {
    return typeof Float32Array < "u" ? (function() {
      ...
      function O(S, A, L) {
        o[0] = S, A[L] = d[0], A[L + 1] = d[1], A[L + 2] = d[2], A[L + 3] = d[3];
      }
      function k(S, A, L) {
        o[0] = S, A[L] = d[3], A[L + 1] = d[2], A[L + 2] = d[1], A[L + 3] = d[0];
      }
      n.writeFloatLE = u ? O : k, n.writeFloatBE = u ? k : O;
      function b(S, A) {
        return d[0] = S[A], d[1] = S[A + 1], d[2] = S[A + 2], d[3] = S[A + 3], o[0];
      }
      function I(S, A) {
        return d[3] = S[A], d[2] = S[A + 1], d[1] = S[A + 2], d[0] = S[A + 3], o[0];
      }
      n.readFloatLE = u ? b : I, n.readFloatBE = u ? I : b;
    })() : (function() {
      function o(u, O, k, b) {
        var I = O < 0 ? 1 : 0;
        if (I && (O = -O), O === 0)
          ...
          u((I << 31 | 2139095040) >>> 0, k, b);
        else if (O < 11754943508222875e-54)
          u((I << 31 | Math.round(O / 1401298464324817e-60)) >>> 0, k, b);
        else {
          var S = Math.floor(Math.log(O) / Math.LN2), A = Math.round(O * Math.pow(2, -S) * 8388608) & 8388607;
          u((I << 31 | S + 127 << 23 | A) >>> 0, k, b);
        }
      }
      n.writeFloatLE = o.bind(null, c), n.writeFloatBE = o.bind(null, r);
      function d(u, O, k) {
        var b = u(O, k), I = (b >> 31) * 2 + 1, S = b >>> 23 & 255, A = b & 8388607;
      ...
      function O(S, A, L) {
        o[0] = S, A[L] = d[0], A[L + 1] = d[1], A[L + 2] = d[2], A[L + 3] = d[3], A[L + 4] = d[4], A[L + 5] = d[5], A[L + 6] = d[6], A[L + 7] = d[7];
      }
      function k(S, A, L) {
        o[0] = S, A[L] = d[7], A[L + 1] = d[6], A[L + 2] = d[5], A[L + 3] = d[4], A[L + 4] = d[3], A[L + 5] = d[2], A[L + 6] = d[1], A[L + 7] = d[0];
      }
      n.writeDoubleLE = u ? O : k, n.writeDoubleBE = u ? k : O;
      function b(S, A) {
        return d[0] = S[A], d[1] = S[A + 1], d[2] = S[A + 2], d[3] = S[A + 3], d[4] = S[A + 4], d[5] = S[A + 5], d[6] = S[A + 6], d[7] = S[A + 7], o[0];
      }
      function I(S, A) {
        return d[7] = S[A], d[6] = S[A + 1], d[5] = S[A + 2], d[4] = S[A + 3], d[3] = S[A + 4], d[2] = S[A + 5], d[1] = S[A + 6], d[0] = S[A + 7], o[0];
      }
      n.readDoubleLE = u ? b : I, n.readDoubleBE = u ? I : b;
    })() : (function() {
      function o(u, O, k, b, I, S) {
        var A = b < 0 ? 1 : 0;
        if (A && (b = -b), b === 0)
          u(0, I, S + O), u(1 / b > 0 ? (
            /* positive */
          ...
          u(0, I, S + O), u(2146959360, I, S + k);
        else if (b > 17976931348623157e292)
          u(0, I, S + O), u((A << 31 | 2146435072) >>> 0, I, S + k);
        else {
          var L;
          if (b < 22250738585072014e-324)
            L = b / 5e-324, u(L >>> 0, I, S + O), u((A << 31 | L / 4294967296) >>> 0, I, S + k);
          else {
            var j = Math.floor(Math.log(b) / Math.LN2);
            j === 1024 && (j = 1023), L = b * Math.pow(2, -j), u(L * 4503599627370496 >>> 0, I, S + O), u((A << 31 | j + 1023 << 20 | L * 1048576 & 1048575) >>> 0, I, S + k);
          }
        }
      }
      n.writeDoubleLE = o.bind(null, c, 0, 4), n.writeDoubleBE = o.bind(null, r, 4, 0);
      function d(u, O, k, b, I) {
        var S = u(b, I + O), A = u(b, I + k), L = (A >> 31) * 2 + 1, j = A >>> 20 & 2047, R = 4294967296 * (A & 1048575) + S;
        return j === 2047 ? R ? NaN : L * (1 / 0) : j === 0 ? L * 5e-324 * R : L * Math.pow(2, j - 1075) * (R + 4503599627370496);
      }
...
function Bo() {
  return Zn || (Zn = 1, (function(g) {
    ...
    c.length = function(r) {
      ...
      if (n < 1)
        return "";
      for (var o = null, d = [], u = 0, O; t < e; )
        O = r[t++], O < 128 ? d[u++] = O : O > 191 && O < 224 ? d[u++] = (O & 31) << 6 | r[t++] & 63 : O > 239 && O < 365 ? (O = ((O & 7) << 18 | (r[t++] & 63) << 12 | (r[t++] & 63) << 6 | r[t++] & 63) - 65536, d[u++] = 55296 + (O >> 10), d[u++] = 56320 + (O & 1023)) : d[u++] = (O & 15) << 12 | (r[t++] & 63) << 6 | r[t++] & 63, u > 8191 && ((o || (o = [])).push(String.fromCharCode.apply(String, d)), u = 0);
...
function bo() {
  ...
  function n(j, R, N) {
    this.fn = j, this.len = R, this.next = void 0, this.val = N;
  }
  function o() {
  }
  function d(j) {
  ...
  u.create = O(), u.alloc = function(j) {
    return new g.Array(j);
  }, g.Array !== Array && (u.alloc = g.pool(u.alloc, g.Array.prototype.subarray)), u.prototype._push = function(j, R, N) {
    return this.tail = this.tail.next = new n(j, R, N), this.len += R, this;
  };
  function k(j, R, N) {
    R[N] = j & 255;
  }
  ...
  function I(j, R) {
    this.len = j, this.next = void 0, this.val = R;
  }
  I.prototype = Object.create(n.prototype), I.prototype.fn = b, u.prototype.uint32 = function(j) {
  ...
  function S(j, R, N) {
    for (; j.hi; )
      R[N++] = j.lo & 127 | 128, j.lo = (j.lo >>> 7 | j.hi << 25) >>> 0, j.hi >>>= 7;
    for (; j.lo > 127; )
      R[N++] = j.lo & 127 | 128, j.lo = j.lo >>> 7;
    R[N++] = j.lo;
  }
  u.prototype.uint64 = function(j) {
    ...
    var R = r.from(j).zzEncode();
    return this._push(S, R.length(), R);
  }, u.prototype.bool = function(j) {
    return this._push(k, 1, j ? 1 : 0);
  };
  function A(j, R, N) {
    R[N] = j & 255, R[N + 1] = j >>> 8 & 255, R[N + 2] = j >>> 16 & 255, R[N + 3] = j >>> 24;
  }
  u.prototype.fixed32 = function(j) {
    return this._push(A, 4, j >>> 0);
  }, u.prototype.sfixed32 = u.prototype.fixed32, u.prototype.fixed64 = function(j) {
    var R = r.from(j);
    return this._push(A, 4, R.lo)._push(A, 4, R.hi);
  ...
  var L = g.Array.prototype.set ? function(j, R, N) {
    R.set(j, N);
  } : function(j, R, N) {
  ...
  return u.prototype.bytes = function(j) {
    var R = j.length >>> 0;
    if (!R)
      return this._push(k, 1, 0);
    if (g.isString(j)) {
      var N = u.alloc(R = t.length(j));
      t.decode(j, N, 0), j = N;
    }
    return this.uint32(R)._push(L, R, j);
  }, u.prototype.string = function(j) {
    var R = e.length(j);
    return R ? this.uint32(R)._push(e.write, R, j) : this._push(k, 1, 0);
    ...
    var j = this.head, R = this.tail, N = this.len;
    return this.reset().uint32(N), N && (this.tail.next = j.next, this.tail = R, this.len += N), this;
  }, u.prototype.finish = function() {
    for (var j = this.head.next, R = this.constructor.alloc(this.len), N = 0; j; )
      j.fn(j.val, R, N), N += j.len, j = j.next;
    return R;
  }, u._configure = function(j) {
    c = j, u.create = O(), c._configure();
  }, kn;
}
var Dn, eo;
function Zo() {
...
function Oo() {
  ...
  function k() {
    if (this.pos + 8 > this.len)
      throw e(this, 8);
    return new r(O(this.buf, this.pos += 4), O(this.buf, this.pos += 4));
  }
  return n.prototype.float = function() {
    ...
    g.merge(n.prototype, {
      ...
      fixed64: function() {
        return k.call(this)[I](!0);
      },
      sfixed64: function() {
        return k.call(this)[I](!1);
      }
    });
  }, En;
}
    ...
    try {
      return u.rpcImpl(
        ...
        function(O, k) {
          ...
          if (!(k instanceof n))
            try {
              k = n[u.responseDelimited ? "decodeDelimited" : "decode"](k);
            } catch (b) {
              return u.emit("error", b, t), d(b);
            }
          return u.emit("data", k, t), d(null, k);
        }
      );
    } catch (O) {
      u.emit("error", O, t), setTimeout(function() {
        d(O);
      }, 0);
      return;
    }
...
function ei() {
  return lo || (lo = 1, (function(g) {
    var c = g;
    c.build = "minimal", c.Writer = bo(), c.BufferWriter = Zo(), c.Reader = Oo(), c.BufferReader = Ko(), c.util = Ue(), c.rpc = Xo(), c.roots = Qo(), c.configure = r;
    function r() {
...
var M = ti();
const h = M.Reader, F = M.Writer, p = M.util, s = M.roots.default || (M.roots.default = {});
s.dot = (() => {
  const g = {};
  return g.Content = (function() {
    ...
    return c.MagnifEyeLivenessContent = (function() {
      ...
      return Object.defineProperty(r.prototype, "_device", {
        ...
        e instanceof h || (e = h.create(e));
        let d = n === void 0 ? e.len : e.pos + n, u = new s.dot.v4.AndroidMetadata(), O, k;
        for (; e.pos < d; ) {
          let b = e.uint32();
          if (b === o)
            break;
          switch (b >>> 3) {
            ...
            case 4: {
              ...
              for (O = "", k = null; e.pos < I; ) {
                ...
                switch (S >>> 3) {
                  case 1:
                    ...
                    break;
                  case 2:
                    k = s.dot.Int32List.decode(e, e.uint32());
                    break;
                  default:
                    e.skipType(S & 7);
                    break;
              ...
              u.dynamicCameraFrameProperties[O] = k;
              break;
            }
            case 8: {
      ...
      return Object.defineProperty(r.prototype, "_camera", {
        ...
        e instanceof h || (e = h.create(e));
        let d = n === void 0 ? e.len : e.pos + n, u = new s.dot.v4.IosMetadata(), O, k;
        for (; e.pos < d; ) {
          let b = e.uint32();
          if (b === o)
            break;
          switch (b >>> 3) {
            ...
            case 4: {
              if (u.isoValues && u.isoValues.length || (u.isoValues = []), (b & 7) === 2) {
                let I = e.uint32() + e.pos;
                for (; e.pos < I; )
        ...
        return e.identifierForVendor != null && e.hasOwnProperty("identifierForVendor") && !p.isString(e.identifierForVendor) ? "identifierForVendor: string expected" : e.tamperingIndicators != null && e.hasOwnProperty("tamperingIndicators") && !(e.tamperingIndicators && typeof e.tamperingIndicators.length == "number" || p.isString(e.tamperingIndicators)) ? "tamperingIndicators: buffer expected" : null;
      }, r.fromObject = function(e) {
        ...
        return e.identifierForVendor != null && (n.identifierForVendor = String(e.identifierForVendor)), e.tamperingIndicators != null && (typeof e.tamperingIndicators == "string" ? p.base64.decode(e.tamperingIndicators, n.tamperingIndicators = p.newBuffer(p.base64.length(e.tamperingIndicators)), 0) : e.tamperingIndicators.length >= 0 && (n.tamperingIndicators = e.tamperingIndicators)), n;
      }, r.toObject = function(e, n) {
        n || (n = {});
        let o = {};
        ...
        return e.camera != null && e.hasOwnProperty("camera") && (o.camera = s.dot.v4.IosCamera.toObject(e.camera, n), n.oneofs && (o._camera = "camera")), e.detectionNormalizedRectangle != null && e.hasOwnProperty("detectionNormalizedRectangle") && (o.detectionNormalizedRectangle = s.dot.RectangleDouble.toObject(e.detectionNormalizedRectangle, n), n.oneofs && (o._detectionNormalizedRectangle = "detectionNormalizedRectangle")), e.croppedYuv420Image != null && e.hasOwnProperty("croppedYuv420Image") && (o.croppedYuv420Image = s.dot.v4.IosYuv420Image.toObject(e.croppedYuv420Image, n), n.oneofs && (o._croppedYuv420Image = "croppedYuv420Image")), e.yuv420ImageCrop != null && e.hasOwnProperty("yuv420ImageCrop") && (o.yuv420ImageCrop = s.dot.v4.IosYuv420ImageCrop.toObject(e.yuv420ImageCrop, n), n.oneofs && (o._yuv420ImageCrop = "yuv420ImageCrop")), e.identifierForVendor != null && e.hasOwnProperty("identifierForVendor") && (o.identifierForVendor = e.identifierForVendor, n.oneofs && (o._identifierForVendor = "identifierForVendor")), e.tamperingIndicators != null && e.hasOwnProperty("tamperingIndicators") && (o.tamperingIndicators = n.bytes === String ? p.base64.encode(e.tamperingIndicators, 0, e.tamperingIndicators.length) : n.bytes === Array ? Array.prototype.slice.call(e.tamperingIndicators) : e.tamperingIndicators, n.oneofs && (o._tamperingIndicators = "tamperingIndicators")), o;
      }, r.prototype.toJSON = function() {
        return this.constructor.toObject(this, M.util.toJSONOptions);
      }, r.getTypeUrl = function(e) {
      ...
      return Object.defineProperty(r.prototype, "_croppedImage", {
        ...
        if (e.croppedImage != null && Object.hasOwnProperty.call(e, "croppedImage") && s.dot.Image.encode(e.croppedImage, n.uint32(
          /* id 6, wireType 2 =*/
          50
          ...
          /* id 8, wireType 2 =*/
          66
        ).fork()).ldelim(), e.cameraEvaluationResults != null && e.cameraEvaluationResults.length)
          for (let o = 0; o < e.cameraEvaluationResults.length; ++o)
            s.dot.v4.CameraEvaluationResult.encode(e.cameraEvaluationResults[o], n.uint32(
              /* id 9, wireType 2 =*/
              74
            ).fork()).ldelim();
        return n;
        ...
        for (; e.pos < d; ) {
          ...
          switch (O >>> 3) {
            ...
            case 9: {
              u.cameraEvaluationResults && u.cameraEvaluationResults.length || (u.cameraEvaluationResults = []), u.cameraEvaluationResults.push(s.dot.v4.CameraEvaluationResult.decode(e, e.uint32()));
              break;
            }
            default:
              e.skipType(O & 7);
        ...
        if (e.cameraEvaluationResults != null && e.hasOwnProperty("cameraEvaluationResults")) {
          if (!Array.isArray(e.cameraEvaluationResults))
            return "cameraEvaluationResults: array expected";
          for (let n = 0; n < e.cameraEvaluationResults.length; ++n) {
            let o = s.dot.v4.CameraEvaluationResult.verify(e.cameraEvaluationResults[n]);
            if (o)
              return "cameraEvaluationResults." + o;
          }
        }
        return null;
      }, r.fromObject = function(e) {
        ...
        if (e.cameraEvaluationResults) {
          if (!Array.isArray(e.cameraEvaluationResults))
            throw TypeError(".dot.v4.WebMetadata.cameraEvaluationResults: array expected");
          n.cameraEvaluationResults = [];
          for (let o = 0; o < e.cameraEvaluationResults.length; ++o) {
            if (typeof e.cameraEvaluationResults[o] != "object")
              throw TypeError(".dot.v4.WebMetadata.cameraEvaluationResults: object expected");
            n.cameraEvaluationResults[o] = s.dot.v4.CameraEvaluationResult.fromObject(e.cameraEvaluationResults[o]);
          }
        }
        return n;
      }, r.toObject = function(e, n) {
        n || (n = {});
        let o = {};
        if ((n.arrays || n.defaults) && (o.availableCameraProperties = [], o.hashedDetectedImages = [], o.detectionRecord = [], o.hashedDetectedImagesWithTimestamp = [], o.cameraEvaluationResults = []), n.defaults && (o.currentCameraProperties = null), e.currentCameraProperties != null && e.hasOwnProperty("currentCameraProperties") && (o.currentCameraProperties = s.dot.v4.MediaTrackSettings.toObject(e.currentCameraProperties, n)), e.availableCameraProperties && e.availableCameraProperties.length) {
        ...
        if (e.croppedImage != null && e.hasOwnProperty("croppedImage") && (o.croppedImage = s.dot.Image.toObject(e.croppedImage, n), n.oneofs && (o._croppedImage = "croppedImage")), e.croppedImageWithPosition != null && e.hasOwnProperty("croppedImageWithPosition") && (o.croppedImageWithPosition = s.dot.v4.ImageCrop.toObject(e.croppedImageWithPosition, n), n.oneofs && (o._croppedImageWithPosition = "croppedImageWithPosition")), e.platformDetails != null && e.hasOwnProperty("platformDetails") && (o.platformDetails = s.dot.v4.PlatformDetails.toObject(e.platformDetails, n), n.oneofs && (o._platformDetails = "platformDetails")), e.cameraEvaluationResults && e.cameraEvaluationResults.length) {
          o.cameraEvaluationResults = [];
          for (let d = 0; d < e.cameraEvaluationResults.length; ++d)
            o.cameraEvaluationResults[d] = s.dot.v4.CameraEvaluationResult.toObject(e.cameraEvaluationResults[d], n);
        }
        return o;
      }, r.prototype.toJSON = function() {
        return this.constructor.toObject(this, M.util.toJSONOptions);
    ...
    })(), c.CameraEvaluationResult = (function() {
      function r(e) {
        if (e)
          for (let n = Object.keys(e), o = 0; o < n.length; ++o)
            e[n[o]] != null && (this[n[o]] = e[n[o]]);
      }
      r.prototype.cameraName = null, r.prototype.fastAvg = null, r.prototype.slowAvg = null;
      let t;
      return Object.defineProperty(r.prototype, "_cameraName", {
        get: p.oneOfGetter(t = ["cameraName"]),
        set: p.oneOfSetter(t)
      }), Object.defineProperty(r.prototype, "_fastAvg", {
        get: p.oneOfGetter(t = ["fastAvg"]),
        set: p.oneOfSetter(t)
      }), Object.defineProperty(r.prototype, "_slowAvg", {
        get: p.oneOfGetter(t = ["slowAvg"]),
        set: p.oneOfSetter(t)
      }), r.create = function(e) {
        return new r(e);
      }, r.encode = function(e, n) {
        return n || (n = F.create()), e.cameraName != null && Object.hasOwnProperty.call(e, "cameraName") && n.uint32(
          /* id 1, wireType 2 =*/
          10
        ).string(e.cameraName), e.fastAvg != null && Object.hasOwnProperty.call(e, "fastAvg") && n.uint32(
          /* id 2, wireType 0 =*/
          16
        ).int32(e.fastAvg), e.slowAvg != null && Object.hasOwnProperty.call(e, "slowAvg") && n.uint32(
          /* id 3, wireType 0 =*/
          24
        ).int32(e.slowAvg), n;
      }, r.encodeDelimited = function(e, n) {
        ...
        e instanceof h || (e = h.create(e));
        let d = n === void 0 ? e.len : e.pos + n, u = new s.dot.v4.CameraEvaluationResult();
        for (; e.pos < d; ) {
          let O = e.uint32();
          if (O === o)
            break;
        ...
        return typeof e != "object" || e === null ? "object expected" : e.cameraName != null && e.hasOwnProperty("cameraName") && !p.isString(e.cameraName) ? "cameraName: string expected" : e.fastAvg != null && e.hasOwnProperty("fastAvg") && !p.isInteger(e.fastAvg) ? "fastAvg: integer expected" : e.slowAvg != null && e.hasOwnProperty("slowAvg") && !p.isInteger(e.slowAvg) ? "slowAvg: integer expected" : null;
      }, r.fromObject = function(e) {
        if (e instanceof s.dot.v4.CameraEvaluationResult)
          return e;
        let n = new s.dot.v4.CameraEvaluationResult();
        return e.cameraName != null && (n.cameraName = String(e.cameraName)), e.fastAvg != null && (n.fastAvg = e.fastAvg | 0), e.slowAvg != null && (n.slowAvg = e.slowAvg | 0), n;
      }, r.toObject = function(e, n) {
        n || (n = {});
        let o = {};
        return e.cameraName != null && e.hasOwnProperty("cameraName") && (o.cameraName = e.cameraName, n.oneofs && (o._cameraName = "cameraName")), e.fastAvg != null && e.hasOwnProperty("fastAvg") && (o.fastAvg = e.fastAvg, n.oneofs && (o._fastAvg = "fastAvg")), e.slowAvg != null && e.hasOwnProperty("slowAvg") && (o.slowAvg = e.slowAvg, n.oneofs && (o._slowAvg = "slowAvg")), o;
      }, r.prototype.toJSON = function() {
        return this.constructor.toObject(this, M.util.toJSONOptions);
      }, r.getTypeUrl = function(e) {
...
var ri = (() => {
  ...
  return (async function(c = {}) {
    ...
    var S, A;
    (d || u) && (u ? b = self.location.href : typeof document < "u" && document.currentScript && (b = document.currentScript.src), g && (b = g), b.startsWith("blob:") ? b = "" : b = b.slice(0, b.replace(/[?#].*/, "").lastIndexOf("/") + 1), u && (A = (a) => {
    ...
    var j = t.wasmBinary, R, N = !1, se, X, z, le, pe, Q, $, He, Be, Ye, Je, Ze = (a) => a.startsWith("file://");
    function Ke() {
      var a = R.buffer;
    ...
    async function Vt(a, i, l) {
      if (!a && typeof WebAssembly.instantiateStreaming == "function" && !Ze(i))
        try {
          ...
          L(`wasm streaming compile failed: ${v}`), L("falling back to ArrayBuffer instantiation");
        }
      return Wt(i, l);
    }
    function Ut() {
    ...
    async function zt() {
      function a(v, w) {
        return E = v.exports, E = C.instrumentWasmExports(E), R = E.B, Ke(), E.H, Lt(), E;
      }
      Ft();
      function i(v) {
        return a(v.instance);
    ...
    var rt = 0, Yt = (a, i, l) => {
      ...
      var m = new Array(i.length), v = [], w = 0;
      i.forEach((y, P) => {
        ae.hasOwnProperty(y) ? m[P] = ae[y] : (v.push(y), ce.hasOwnProperty(y) || (ce[y] = []), ce[y].push(() => {
          m[P] = ae[y], ++w, w === v.length && f(m);
        }));
      }), v.length === 0 && f(m);
    };
    function Kt(a, i, l = {}) {
      var f = i.name;
      if (a || _(`type "${f}" must have a positive integer typeid pointer`), ae.hasOwnProperty(a)) {
        if (l.ignoreDuplicateRegistrations)
          return;
        _(`Cannot register type '${f}' twice`);
      }
      if (ae[a] = i, delete Oe[a], ce.hasOwnProperty(a)) {
        var m = ce[a];
        delete ce[a], m.forEach((v) => v());
      }
    }
    function H(a, i, l = {}) {
      return Kt(a, i, l);
    ...
    var it = (a, i, l) => {
      ...
      i = W(i);
      var v = i.indexOf("u") != -1;
      H(a, { name: i, fromWireType: (w) => w, toWireType: function(w, y) {
        if (typeof y != "bigint" && typeof y != "number")
          throw new TypeError(`Cannot convert "${be(y)}" to ${this.name}`);
        return typeof y == "number" && (y = BigInt(y)), y;
      }, argPackAdvance: Y, readValueFromPointer: it(i, l, !v), destructorFunction: null });
    }, Y = 8, Xt = (a, i, l, f) => {
      i = W(i), H(a, { name: i, fromWireType: function(m) {
        return !!m;
      }, toWireType: function(m, v) {
        return v ? l : f;
      }, argPackAdvance: Y, readValueFromPointer: function(m) {
        return this.fromWireType(z[m]);
      }, destructorFunction: null });
    }, Qt = (a) => ({ count: a.count, deleteScheduled: a.deleteScheduled, preservePointerOnDelete: a.preservePointerOnDelete, ptr: a.ptr, ptrType: a.ptrType, smartPtr: a.smartPtr, smartPtrType: a.smartPtrType }), Ee = (a) => {
      function i(l) {
        return l.$$.ptrType.registeredClass.name;
      }
      _(i(a) + " instance already deleted");
    }, _e = !1, at = (a) => {
    }, er = (a) => {
      ...
      for (i === void 0 && _("ptr should not be undefined"); a.baseClass; )
    ...
    function or(a) {
      ...
      var v = this.registeredClass.getActualType(i), w = ct[v];
      if (!w)
        return m.call(this);
      var y;
      this.isConst ? y = w.constPointerType : y = w.pointerType;
    ...
    var ye = (a) => typeof FinalizationRegistry > "u" ? (ye = (i) => i, a) : (_e = new FinalizationRegistry((i) => {
      st(i.$$);
    }), ye = (i) => {
      ...
      Object.assign(Ie.prototype, { isAliasOf(a) {
        ...
        this.$$.ptr || Ee(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && _("Object already scheduled for deletion"), at(this), st(this.$$), this.$$.preservePointerOnDelete || (this.$$.smartPtr = void 0, this.$$.ptr = void 0);
      }, isDeleted() {
        return !this.$$.ptr;
      }, deleteLater() {
        return this.$$.ptr || Ee(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && _("Object already scheduled for deletion"), this.$$.deleteScheduled = !0, this;
      } });
    };
    function Ie() {
    }
    var je = (a, i) => Object.defineProperty(i, "name", { value: a }), ar = (a, i, l) => {
      if (a[i].overloadTable === void 0) {
        var f = a[i];
        a[i] = function(...m) {
          return a[i].overloadTable.hasOwnProperty(m.length) || _(`Function '${l}' called with an invalid number of arguments (${m.length}) - expects one of (${a[i].overloadTable})!`), a[i].overloadTable[m.length].apply(this, m);
        }, a[i].overloadTable = [], a[i].overloadTable[f.argCount] = f;
      }
    }, Re = (a, i, l) => {
      t.hasOwnProperty(a) ? ((l === void 0 || t[a].overloadTable !== void 0 && t[a].overloadTable[l] !== void 0) && _(`Cannot register public name '${a}' twice`), ar(t, a, a), t[a].overloadTable.hasOwnProperty(l) && _(`Cannot register multiple overloads of a function with the same number of arguments (${l})!`), t[a].overloadTable[l] = i) : (t[a] = i, t[a].argCount = l);
    }, sr = 48, lr = 57, cr = (a) => {
      a = a.replace(/[^a-zA-Z0-9_]/g, "$");
      var i = a.charCodeAt(0);
      return i >= sr && i <= lr ? `_${a}` : a;
    };
    function ur(a, i, l, f, m, v, w, y) {
      this.name = a, this.constructor = i, this.instancePrototype = l, this.rawDestructor = f, this.baseClass = m, this.getActualType = v, this.upcast = w, this.downcast = y, this.pureVirtualFunctions = [];
    }
    var Ce = (a, i, l) => {
      for (; i !== l; )
        i.upcast || _(`Expected null or instance of ${l.name}, got an instance of ${i.name}`), a = i.upcast(a), i = i.baseClass;
      return a;
    };
    function dr(a, i) {
      if (i === null)
        return this.isReference && _(`null is not a valid ${this.name}`), 0;
      i.$$ || _(`Cannot pass "${be(i)}" as a ${this.name}`), i.$$.ptr || _(`Cannot pass deleted object as a pointer of type ${this.name}`);
    ...
    function fr(a, i) {
      var l;
      if (i === null)
        return this.isReference && _(`null is not a valid ${this.name}`), this.isSmartPointer ? (l = this.rawConstructor(), a !== null && a.push(this.rawDestructor, l), l) : 0;
      (!i || !i.$$) && _(`Cannot pass "${be(i)}" as a ${this.name}`), i.$$.ptr || _(`Cannot pass deleted object as a pointer of type ${this.name}`), !this.isConst && i.$$.ptrType.isConst && _(`Cannot convert argument of type ${i.$$.smartPtrType ? i.$$.smartPtrType.name : i.$$.ptrType.name} to parameter type ${this.name}`);
      var f = i.$$.ptrType.registeredClass;
      if (l = Ce(i.$$.ptr, f, this.registeredClass), this.isSmartPointer)
        switch (i.$$.smartPtr === void 0 && _("Passing raw pointer to smart pointer is illegal"), this.sharingPolicy) {
          case 0:
            i.$$.smartPtrType === this ? l = i.$$.smartPtr : _(`Cannot convert argument of type ${i.$$.smartPtrType ? i.$$.smartPtrType.name : i.$$.ptrType.name} to parameter type ${this.name}`);
            break;
          case 1:
            l = i.$$.smartPtr;
            break;
    ...
    function pr(a, i) {
      if (i === null)
        return this.isReference && _(`null is not a valid ${this.name}`), 0;
      i.$$ || _(`Cannot pass "${be(i)}" as a ${this.name}`), i.$$.ptr || _(`Cannot pass deleted object as a pointer of type ${this.name}`), i.$$.ptrType.isConst && _(`Cannot convert argument of type ${i.$$.ptrType.name} to parameter type ${this.name}`);
      var l = i.$$.ptrType.registeredClass, f = Ce(i.$$.ptr, l, this.registeredClass);
      return f;
    }
    function Se(a) {
    ...
    function Te(a, i, l, f, m, v, w, y, P, D, T) {
      this.name = a, this.registeredClass = i, this.isReference = l, this.isConst = f, this.isSmartPointer = m, this.pointeeType = v, this.sharingPolicy = w, this.rawGetPointee = y, this.rawConstructor = P, this.rawShare = D, this.rawDestructor = T, !m && i.baseClass === void 0 ? f ? (this.toWireType = dr, this.destructorFunction = null) : (this.toWireType = pr, this.destructorFunction = null) : this.toWireType = fr;
    }
    var ut = (a, i, l) => {
      ...
      var f = l();
      return typeof f != "function" && _(`unknown function pointer with signature ${a}: ${i}`), f;
    }, vr = (a, i) => {
...
` + m.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    }, br = (a, i, l, f, m, v, w, y, P, D, T, x, V) => {
      T = W(T), v = ee(m, v), y &&= ee(w, y), D &&= ee(P, D), V = ee(x, V);
      var J = cr(T);
      Re(J, function() {
        ...
        K.prototype = ne;
        var U = new ur(T, K, ne, V, re, v, y, D);
        U.baseClass && (U.baseClass.__derivedClasses ??= [], U.baseClass.__derivedClasses.push(U));
        var oe = new Te(T, U, !0, !1, !1), ke = new Te(T + "*", U, !1, !1, !1), It = new Te(T + " const*", U, !1, !0, !1);
        return ct[a] = { pointerType: ke, constPointerType: It }, ut(J, K), [oe, ke, It];
      });
    }, pt = (a, i) => {
      for (var l = [], f = 0; f < a; f++)
        l.push($[i + f * 4 >> 2]);
    ...
    var Ae = (a) => {
      ...
      se = a, gt() || (t.onExit?.(a), N = !0), k(a, new qe(a));
    }, wr = (a, i) => {
      se = a, ht(a);
    }, Pr = wr, Ir = () => {
      if (!gt())
      ...
      C.currData && C.state === C.State.Unwinding && C.exportCallStack.length === 0 && (C.state = C.State.Normal, Ae(bn), typeof Fibers < "u" && Fibers.trampoline());
    }, whenDone() {
        ...
        if (C.state === C.State.Normal) {
          ...
          a((f = 0) => {
            if (!N && (C.handleSleepReturnValue = f, i = !0, !!l)) {
              C.state = C.State.Rewinding, Ae(() => On(C.currData)), typeof MainLoop < "u" && MainLoop.func && MainLoop.resume();
              var m, v = !1;
              try {
              ...
              if (!C.currData) {
                ...
                y && (C.asyncPromiseHandlers = null, (v ? y.reject : y.resolve)(m), w = !0);
              }
              if (v && !w)
                throw m;
            }
          }), l = !0, i || (C.state = C.State.Unwinding, C.currData = C.allocateData(), typeof MainLoop < "u" && MainLoop.func && MainLoop.pause(), Ae(() => vn(C.currData)));
        } else C.state === C.State.Rewinding ? (C.state = C.State.Normal, Ae(wn), q(C.currData), C.currData = null, C.sleepCallbacks.forEach(vt)) : ve(`invalid state: ${C.state}`);
    ...
    function bt(a, i, l, f, m, v) {
      var w = i.length;
      w < 2 && _("argTypes array size mismatch! Must at least get return value and 'this' types!"), i[1];
      var y = Or(i), P = i[0].name !== "void", D = w - 2, T = new Array(D), x = [], V = [], J = function(...Z) {
        V.length = 0;
        var re;
        x.length = 1, x[0] = m;
        for (var G = 0; G < D; ++G)
        ...
        function ne(U) {
          if (y)
            ...
            for (var oe = 2; oe < i.length; oe++) {
              ...
              i[oe].destructorFunction !== null && i[oe].destructorFunction(ke);
            }
          if (P)
    ...
    var jr = (a, i, l, f, m, v) => {
      ...
      m = ee(f, m), de([], [a], (y) => {
        ...
        return y.registeredClass.constructor_body[i - 1] = () => {
          ge(`Cannot construct ${y.name} due to unbound types`, w);
        }, de([], w, (D) => (D.splice(1, 0, null), y.registeredClass.constructor_body[i - 1] = bt(P, D, null, m, v), [])), [];
      });
    }, Ot = (a, i, l) => (a instanceof Object || _(`${l} with invalid "this": ${a}`), a instanceof i.registeredClass.constructor || _(`${l} incompatible with "this" of type ${a.constructor.name}`), a.$$.ptr || _(`cannot call emscripten binding method ${l} on deleted object`), Ce(a.$$.ptr, a.$$.ptrType.registeredClass, i.registeredClass)), Cr = (a, i, l, f, m, v, w, y, P, D) => {
      i = W(i), m = ee(f, m), de([], [a], (T) => {
        T = T[0];
        var x = `${T.name}.${i}`, V = { get() {
          ge(`Cannot access ${x} due to unbound types`, [l, w]);
        }, enumerable: !0, configurable: !0 };
        return P ? V.set = () => ge(`Cannot access ${x} due to unbound types`, [l, w]) : V.set = (J) => _(x + " is a read-only property"), Object.defineProperty(T.registeredClass.instancePrototype, i, V), de([], P ? [l, w] : [l], (J) => {
          var Z = J[0], re = { get() {
            var K = Ot(this, T, x + " getter");
            return Z.fromWireType(m(v, K));
          }, enumerable: !0 };
          if (P) {
            P = ee(y, P);
            var G = J[1];
    ...
    }, B = { toValue: (a) => (a || _("Cannot use deleted val. handle = " + a), te[a]), toHandle: (a) => {
      switch (a) {
        case void 0:
          return 2;
        case null:
    ...
    } }, Ar = { name: "emscripten::val", fromWireType: (a) => {
      var i = B.toValue(a);
      return Le(a), i;
    }, toWireType: (a, i) => B.toHandle(i), argPackAdvance: Y, readValueFromPointer: Se, destructorFunction: null }, kr = (a) => H(a, Ar), Dr = (a, i, l) => {
      switch (i) {
        case 1:
          return l ? function(f) {
      ...
      m.values = {}, H(a, { name: i, constructor: m, fromWireType: function(v) {
        return this.constructor.values[v];
      }, toWireType: (v, w) => w.value, argPackAdvance: Y, readValueFromPointer: Dr(i, l, f), destructorFunction: null }), Re(i, m);
    }, xe = (a, i) => {
      var l = ae[a];
      return l === void 0 && _(`${i} has unknown type ${ft(a)}`), l;
    }, _r = (a, i, l) => {
      var f = xe(a, "enum");
      i = W(i);
      var m = f.constructor, v = Object.create(f.constructor.prototype, { value: { value: l }, constructor: { value: je(`${f.name}_${i}`, function() {
      }) } });
      m.values[l] = v, m[i] = v;
    }, Rr = (a, i) => {
      switch (i) {
      ...
      i = W(i), H(a, { name: i, fromWireType: (f) => f, toWireType: (f, m) => m, argPackAdvance: Y, readValueFromPointer: Rr(i, l), destructorFunction: null });
    }, Fr = (a) => {
      a = a.trim();
      const i = a.indexOf("(");
      ...
      }, H(a, { name: i, fromWireType: v, toWireType: D, argPackAdvance: Y, readValueFromPointer: it(i, l, f !== 0), destructorFunction: null });
    }, Nr = (a, i, l) => {
      ...
      l = W(l), H(a, { name: l, fromWireType: v, argPackAdvance: Y, readValueFromPointer: v }, { ignoreDuplicateRegistrations: !0 });
    }, $r = (a, i, l, f) => {
      if (!(f > 0)) return 0;
      for (var m = l, v = l + f - 1, w = 0; w < a.length; ++w) {
        var y = a.charCodeAt(w);
        if (y >= 55296 && y <= 57343) {
          var P = a.charCodeAt(++w);
      ...
      for (var v = ""; i < m; ) {
        ...
        var y = a[i++] & 63;
        if ((w & 224) == 192) {
          v += String.fromCharCode((w & 31) << 6 | y);
          continue;
        }
        var P = a[i++] & 63;
        if ((w & 240) == 224 ? w = (w & 15) << 12 | y << 6 | P : w = (w & 7) << 18 | y << 12 | P << 6 | a[i++] & 63, w < 65536)
          v += String.fromCharCode(w);
        else {
          var D = w - 65536;
          v += String.fromCharCode(55296 | D >> 10, 56320 | D & 1023);
        }
      }
      return v;
    }, zr = (a, i) => a ? Ur(z, a, i) : "", Gr = (a, i) => {
      i = W(i), H(a, { name: i, fromWireType(l) {
        for (var f = $[l >> 2], m = l + 4, v, w, y = m, w = 0; w <= f; ++w) {
          var P = m + w;
          if (w == f || z[P] == 0) {
            var D = P - y, T = zr(y, D);
            v === void 0 ? v = T : (v += "\0", v += T), y = P + 1;
          }
        }
        return q(l), v;
      }, toWireType(l, f) {
        f instanceof ArrayBuffer && (f = new Uint8Array(f));
        var m, v = typeof f == "string";
        v || f instanceof Uint8Array || f instanceof Uint8ClampedArray || f instanceof Int8Array || _("Cannot pass non-string to std::string"), v ? m = Vr(f) : m = f.length;
        var w = Ne(4 + m + 1), y = w + 4;
        if ($[w >> 2] = m, v)
          Wr(f, y, m + 1);
        else if (v)
          for (var P = 0; P < m; ++P) {
            var D = f.charCodeAt(P);
            D > 255 && (q(w), _("String has UTF-16 code units that do not fit in 8 bits")), z[y + P] = D;
          }
        else
          for (var P = 0; P < m; ++P)
            z[y + P] = f[P];
        return l !== null && l.push(q, w), w;
      ...
      l -= 2;
      for (var f = i, m = l < a.length * 2 ? l / 2 : a.length, v = 0; v < m; ++v) {
        var w = a.charCodeAt(v);
        le[i >> 1] = w, i += 2;
      }
      return le[i >> 1] = 0, i - f;
      ...
      for (var f = i, m = f + l - 4, v = 0; v < a.length; ++v) {
        var w = a.charCodeAt(v);
        if (w >= 55296 && w <= 57343) {
          var y = a.charCodeAt(++v);
          w = 65536 + ((w & 1023) << 10) | y & 1023;
        }
        if (Q[i >> 2] = w, i += 4, i + 4 > m) break;
      }
      return Q[i >> 2] = 0, i - f;
    }, Kr = (a) => {
      for (var i = 0, l = 0; l < a.length; ++l) {
      ...
      l = W(l);
      var f, m, v, w;
      i === 2 ? (f = Hr, m = Br, w = Yr, v = (y) => pe[y >> 1]) : i === 4 && (f = Jr, m = Zr, w = Kr, v = (y) => $[y >> 2]), H(a, { name: l, fromWireType: (y) => {
        ...
        typeof P != "string" && _(`Cannot pass non-string to C++ string type ${l}`);
        var D = w(P), T = Ne(4 + D + i);
      ...
      for (var f = 1; f <= 4; f *= 2) {
        ...
        var v = Math.min(l, fn(Math.max(a, m), 65536)), w = pn(v);
        if (w)
          return !0;
      }
      return !1;
    ...
    }, ir(), mr(), dt = t.UnboundTypeError = vr(Error, "UnboundTypeError"), Tr();
    var yn = { i: Yt, s: Jt, n: qt, w: Xt, f: br, d: jr, a: Cr, u: kr, l: Er, g: _r, m: Mr, b: Lr, e: xr, c: Nr, v: Gr, h: qr, x: Xr, q: Qr, j: tn, y: Le, k: rn, o: an, A: sn, z: ln, r: un, t: mn, p: ht }, E = await zt();
    E.C;
    var gn = E.D, Ne = t._malloc = E.E, q = t._free = E.F, hn = E.G;
    t.dynCall_v = E.I, t.dynCall_ii = E.J, t.dynCall_vi = E.K, t.dynCall_i = E.L, t.dynCall_iii = E.M, t.dynCall_viii = E.N, t.dynCall_fii = E.O, t.dynCall_viif = E.P, t.dynCall_viiii = E.Q, t.dynCall_viiiiii = E.R, t.dynCall_iiiiii = E.S, t.dynCall_viiiii = E.T, t.dynCall_iiiiiii = E.U, t.dynCall_iiiiiiii = E.V, t.dynCall_viiiiiii = E.W, t.dynCall_viiiiiiiiidi = E.X, t.dynCall_viiiiiiiidi = E.Y, t.dynCall_viiiiiiiiii = E.Z, t.dynCall_viiiiiiiii = E._, t.dynCall_viiiiiiii = E.$, t.dynCall_iiiii = E.aa, t.dynCall_iiii = E.ba;
    var vn = E.ca, bn = E.da, On = E.ea, wn = E.fa;
    function $e() {
      if (ie > 0) {
        me = $e;
        return;
      ...
      function a() {
        t.calledRun = !0, !N && (Rt(), e(t), t.onRuntimeInitialized?.(), Mt());
      }
...
function ii(g, c, r) {
  if (g.confidence <= 0 || c.confidence <= 0)
    return 0;
  const t = wo(g.center, c.center), e = vo(r.width, r.height);
  return xn(t / e);
}
function Mn(g) {
...
class si extends No {
  ...
  parseRawData(c, r) {
    const { brightness: t, sharpness: e } = c.params, { bottomRightX: n, bottomRightY: o, leftEye: d, mouth: u, rightEye: O, topLeftX: k, topLeftY: b } = c, I = Mn(d), S = Mn(O), A = Mn(u);
    return {
