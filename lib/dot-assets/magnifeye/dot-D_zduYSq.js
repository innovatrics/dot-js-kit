const fo = /* @__PURE__ */ Symbol("Comlink.proxy"), Po = /* @__PURE__ */ Symbol("Comlink.endpoint"), Io = /* @__PURE__ */ Symbol("Comlink.releaseProxy"), Tt = /* @__PURE__ */ Symbol("Comlink.finalizer"), kt = /* @__PURE__ */ Symbol("Comlink.thrown"), po = (g) => typeof g == "object" && g !== null || typeof g == "function", Co = {
...
function Ln(g, c = globalThis, r = ["*"]) {
  c.addEventListener("message", function t(e) {
    ...
    try {
      ...
      switch (o) {
        case "GET":
          ...
          break;
        case "SET":
          A[d.slice(-1)[0]] = Ve(e.data.value), O = !0;
          break;
        case "APPLY":
          O = v.apply(A, u);
          break;
    ...
    Promise.resolve(O).catch((A) => ({ value: A, [kt]: 0 })).then((A) => {
      const [v, I] = _t(A);
...
class No {
  ...
  async getOptimalRegionForCompressionDetectionFromDetectionCorners(c, r, t) {
    ...
    const e = this.convertToSamColorImage(c, r), { bottomLeft: n, topLeft: o, topRight: d } = t, u = [
      ...
      n.y - o.y
      // height
    ], { height: O, width: A, x: v, y: I } = await this.samWasmModule.selectDetailRegion(
      r.width,
      r.height,
      e.bgr0ImagePointer,
      u
...
function Uo() {
  return zn || (zn = 1, (function(g) {
    ...
    c.encode = function(o, d, u) {
      for (var O = null, A = [], v = 0, I = 0, S; d < u; ) {
        var k = o[d++];
        switch (I) {
          case 0:
        ...
        v > 8191 && ((O || (O = [])).push(String.fromCharCode.apply(String, A)), v = 0);
      }
      return I && (A[v++] = r[S], A[v++] = 61, I === 1 && (A[v++] = 61)), O ? (v && O.push(String.fromCharCode.apply(String, A.slice(0, v))), O.join("")) : String.fromCharCode.apply(String, A.slice(0, v));
    };
    var n = "invalid encoding";
    c.decode = function(o, d, u) {
      for (var O = u, A = 0, v, I = 0; I < o.length; ) {
...
function Go() {
  ...
  function g(n) {
    return typeof Float32Array < "u" ? (function() {
      ...
      n.writeFloatLE = u ? O : A, n.writeFloatBE = u ? A : O;
      function v(S, k) {
      ...
      function o(u, O, A, v) {
        ...
        if (I && (O = -O), O === 0)
          ...
          u((I << 31 | Math.round(O / 1401298464324817e-60)) >>> 0, A, v);
        else {
          var S = Math.floor(Math.log(O) / Math.LN2), k = Math.round(O * Math.pow(2, -S) * 8388608) & 8388607;
          u((I << 31 | S + 127 << 23 | k) >>> 0, A, v);
        }
      }
      n.writeFloatLE = o.bind(null, c), n.writeFloatBE = o.bind(null, r);
      function d(u, O, A) {
        var v = u(O, A), I = (v >> 31) * 2 + 1, S = v >>> 23 & 255, k = v & 8388607;
      ...
      n.writeDoubleLE = u ? O : A, n.writeDoubleBE = u ? A : O;
      function v(S, k) {
      ...
      function o(u, O, A, v, I, S) {
        ...
        if (k && (v = -v), v === 0)
          ...
          u(0, I, S + O), u(2146959360, I, S + A);
        else if (v > 17976931348623157e292)
          u(0, I, S + O), u((k << 31 | 2146435072) >>> 0, I, S + A);
        else {
          var L;
          if (v < 22250738585072014e-324)
            L = v / 5e-324, u(L >>> 0, I, S + O), u((k << 31 | L / 4294967296) >>> 0, I, S + A);
          else {
            var C = Math.floor(Math.log(v) / Math.LN2);
            C === 1024 && (C = 1023), L = v * Math.pow(2, -C), u(L * 4503599627370496 >>> 0, I, S + O), u((k << 31 | C + 1023 << 20 | L * 1048576 & 1048575) >>> 0, I, S + A);
          }
        }
      }
      n.writeDoubleLE = o.bind(null, c, 0, 4), n.writeDoubleBE = o.bind(null, r, 4, 0);
      function d(u, O, A, v, I) {
        var S = u(v, I + O), k = u(v, I + A), L = (k >> 31) * 2 + 1, C = k >>> 20 & 2047, R = 4294967296 * (k & 1048575) + S;
        return C === 2047 ? R ? NaN : L * (1 / 0) : C === 0 ? L * 5e-324 * R : L * Math.pow(2, C - 1075) * (R + 4503599627370496);
      }
...
function vo() {
  ...
  u.create = O(), u.alloc = function(C) {
    return new g.Array(C);
  }, g.Array !== Array && (u.alloc = g.pool(u.alloc, g.Array.prototype.subarray)), u.prototype._push = function(C, R, N) {
  ...
  I.prototype = Object.create(n.prototype), I.prototype.fn = v, u.prototype.uint32 = function(C) {
  ...
  u.prototype.fixed32 = function(C) {
    ...
    return this._push(g.float.writeFloatLE, 4, C);
  }, u.prototype.double = function(C) {
    return this._push(g.float.writeDoubleLE, 8, C);
  };
  var L = g.Array.prototype.set ? function(C, R, N) {
    R.set(C, N);
  } : function(C, R, N) {
    for (var se = 0; se < C.length; ++se)
      R[N + se] = C[se];
  };
  return u.prototype.bytes = function(C) {
    var R = C.length >>> 0;
    if (!R)
      return this._push(A, 1, 0);
    if (g.isString(C)) {
      var N = u.alloc(R = t.length(C));
      t.decode(C, N, 0), C = N;
    }
    return this.uint32(R)._push(L, R, C);
  }, u.prototype.string = function(C) {
    var R = e.length(C);
    return R ? this.uint32(R)._push(e.write, R, C) : this._push(A, 1, 0);
  ...
  return g.Content = (function() {
    ...
    return c.MagnifEyeLivenessContent = (function() {
      ...
      return Object.defineProperty(r.prototype, "_device", {
        ...
        e instanceof h || (e = h.create(e));
        let d = n === void 0 ? e.len : e.pos + n, u = new s.dot.v4.AndroidMetadata(), O, A;
        for (; e.pos < d; ) {
          let v = e.uint32();
          if (v === o)
            break;
          switch (v >>> 3) {
            ...
            case 4: {
              ...
              u.dynamicCameraFrameProperties[O] = A;
              break;
            }
            case 8: {
      ...
      return Object.defineProperty(r.prototype, "_camera", {
        ...
        e instanceof h || (e = h.create(e));
        let d = n === void 0 ? e.len : e.pos + n, u = new s.dot.v4.IosMetadata(), O, A;
        for (; e.pos < d; ) {
          let v = e.uint32();
          if (v === o)
            break;
      ...
      return Object.defineProperty(r.prototype, "_croppedImage", {
        ...
        if (e.croppedImage != null && Object.hasOwnProperty.call(e, "croppedImage") && s.dot.Image.encode(e.croppedImage, n.uint32(
          ...
          for (let o = 0; o < e.optCheckResults.length; ++o)
            s.dot.v4.CameraEvaluationResult.encode(e.optCheckResults[o], n.uint32(
              /* id 9, wireType 2 =*/
              74
            ).fork()).ldelim();
        return n;
        ...
        for (; e.pos < d; ) {
          ...
          switch (O >>> 3) {
            ...
            case 9: {
              u.optCheckResults && u.optCheckResults.length || (u.optCheckResults = []), u.optCheckResults.push(s.dot.v4.CameraEvaluationResult.decode(e, e.uint32()));
              break;
            }
            default:
              e.skipType(O & 7);
        ...
        if (e.optCheckResults != null && e.hasOwnProperty("optCheckResults")) {
          ...
          for (let n = 0; n < e.optCheckResults.length; ++n) {
            let o = s.dot.v4.CameraEvaluationResult.verify(e.optCheckResults[n]);
            if (o)
        ...
        if (e.optCheckResults) {
          ...
          for (let o = 0; o < e.optCheckResults.length; ++o) {
            ...
            n.optCheckResults[o] = s.dot.v4.CameraEvaluationResult.fromObject(e.optCheckResults[o]);
          }
        }
        return n;
      }, r.toObject = function(e, n) {
        n || (n = {});
        let o = {};
        if ((n.arrays || n.defaults) && (o.availableCameraProperties = [], o.hashedDetectedImages = [], o.detectionRecord = [], o.hashedDetectedImagesWithTimestamp = [], o.optCheckResults = []), n.defaults && (o.currentCameraProperties = null), e.currentCameraProperties != null && e.hasOwnProperty("currentCameraProperties") && (o.currentCameraProperties = s.dot.v4.MediaTrackSettings.toObject(e.currentCameraProperties, n)), e.availableCameraProperties && e.availableCameraProperties.length) {
        ...
        if (e.croppedImage != null && e.hasOwnProperty("croppedImage") && (o.croppedImage = s.dot.Image.toObject(e.croppedImage, n), n.oneofs && (o._croppedImage = "croppedImage")), e.croppedImageWithPosition != null && e.hasOwnProperty("croppedImageWithPosition") && (o.croppedImageWithPosition = s.dot.v4.ImageCrop.toObject(e.croppedImageWithPosition, n), n.oneofs && (o._croppedImageWithPosition = "croppedImageWithPosition")), e.platformDetails != null && e.hasOwnProperty("platformDetails") && (o.platformDetails = s.dot.v4.PlatformDetails.toObject(e.platformDetails, n), n.oneofs && (o._platformDetails = "platformDetails")), e.optCheckResults && e.optCheckResults.length) {
          o.optCheckResults = [];
          for (let d = 0; d < e.optCheckResults.length; ++d)
            o.optCheckResults[d] = s.dot.v4.CameraEvaluationResult.toObject(e.optCheckResults[d], n);
        }
        return o;
      }, r.prototype.toJSON = function() {
        return this.constructor.toObject(this, M.util.toJSONOptions);
      ...
      return Object.defineProperty(r.prototype, "_optSetting", {
        get: p.oneOfGetter(t = ["optSetting"]),
        set: p.oneOfSetter(t)
      }), Object.defineProperty(r.prototype, "_afterOpt", {
        get: p.oneOfGetter(t = ["afterOpt"]),
        set: p.oneOfSetter(t)
      }), Object.defineProperty(r.prototype, "_beforeOpt", {
        get: p.oneOfGetter(t = ["beforeOpt"]),
        set: p.oneOfSetter(t)
      }), r.create = function(e) {
        return new r(e);
      }, r.encode = function(e, n) {
        return n || (n = F.create()), e.optSetting != null && Object.hasOwnProperty.call(e, "optSetting") && n.uint32(
          /* id 1, wireType 2 =*/
          10
        ...
        return typeof e != "object" || e === null ? "object expected" : e.optSetting != null && e.hasOwnProperty("optSetting") && !p.isString(e.optSetting) ? "optSetting: string expected" : e.afterOpt != null && e.hasOwnProperty("afterOpt") && !p.isInteger(e.afterOpt) ? "afterOpt: integer expected" : e.beforeOpt != null && e.hasOwnProperty("beforeOpt") && !p.isInteger(e.beforeOpt) ? "beforeOpt: integer expected" : null;
      }, r.fromObject = function(e) {
...
var ri = (() => {
  ...
  return (async function(c = {}) {
    ...
    var C = t.wasmBinary, R, N = !1, se, X, z, le, pe, Q, $, He, Be, Ye, Je, Ze = (a) => a.startsWith("file://");
    function Ke() {
      var a = R.buffer;
    ...
    async function Vt(a, i, l) {
      if (!a && typeof WebAssembly.instantiateStreaming == "function" && !Ze(i))
        try {
          ...
          L(`wasm streaming compile failed: ${b}`), L("falling back to ArrayBuffer instantiation");
        }
      return Wt(i, l);
    }
    function Ut() {
    ...
    async function zt() {
      function a(b, w) {
        return _ = b.exports, _ = j.instrumentWasmExports(_), R = _.B, Ke(), _.H, Lt(), _;
      }
      Ft();
      function i(b) {
        return a(b.instance);
      ...
      De ??= xt();
      try {
        var f = await Vt(C, De, l), m = i(f);
        return m;
      } catch (b) {
        return n(b), Promise.reject(b);
      }
    }
    class qe {
      name = "ExitStatus";
    ...
    var rt = 0, Yt = (a, i, l) => {
      ...
      var m = new Array(i.length), b = [], w = 0;
      i.forEach((y, P) => {
        ae.hasOwnProperty(y) ? m[P] = ae[y] : (b.push(y), ce.hasOwnProperty(y) || (ce[y] = []), ce[y].push(() => {
          m[P] = ae[y], ++w, w === b.length && f(m);
        }));
      }), b.length === 0 && f(m);
    };
    function Kt(a, i, l = {}) {
    ...
    var it = (a, i, l) => {
      ...
      }, argPackAdvance: Y, readValueFromPointer: it(i, l, !b), destructorFunction: null });
    }, Y = 8, Xt = (a, i, l, f) => {
    ...
    function or(a) {
      ...
      var b = this.registeredClass.getActualType(i), w = ct[b];
      if (!w)
        return m.call(this);
      var y;
    ...
    var Ce = (a, i) => Object.defineProperty(i, "name", { value: a }), ar = (a, i, l) => {
    ...
    function ur(a, i, l, f, m, b, w, y) {
      this.name = a, this.constructor = i, this.instancePrototype = l, this.rawDestructor = f, this.baseClass = m, this.getActualType = b, this.upcast = w, this.downcast = y, this.pureVirtualFunctions = [];
    }
    var je = (a, i, l) => {
      for (; i !== l; )
    ...
    function dr(a, i) {
      ...
      var l = i.$$.ptrType.registeredClass, f = je(i.$$.ptr, l, this.registeredClass);
      return f;
    }
    function fr(a, i) {
      var l;
      ...
      if (l = je(i.$$.ptr, f, this.registeredClass), this.isSmartPointer)
    ...
    function Te(a, i, l, f, m, b, w, y, P, D, T) {
      this.name = a, this.registeredClass = i, this.isReference = l, this.isConst = f, this.isSmartPointer = m, this.pointeeType = b, this.sharingPolicy = w, this.rawGetPointee = y, this.rawConstructor = P, this.rawShare = D, this.rawDestructor = T, !m && i.baseClass === void 0 ? f ? (this.toWireType = dr, this.destructorFunction = null) : (this.toWireType = pr, this.destructorFunction = null) : this.toWireType = fr;
    }
    var ut = (a, i, l) => {
...
` + m.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    }, vr = (a, i, l, f, m, b, w, y, P, D, T, x, V) => {
      T = W(T), b = ee(m, b), y &&= ee(w, y), D &&= ee(P, D), V = ee(x, V);
      var J = cr(T);
      Re(J, function() {
        ...
        var K = Ce(T, function(...We) {
          ...
          var Ct = U.constructor_body[We.length];
          if (Ct === void 0)
          ...
          return Ct.apply(this, We);
        }), ne = Object.create(G, { constructor: { value: K } });
        K.prototype = ne;
        var U = new ur(T, K, ne, V, re, b, y, D);
    ...
    var ke = (a) => {
      ...
      j.currData && j.state === j.State.Unwinding && j.exportCallStack.length === 0 && (j.state = j.State.Normal, ke(vn), typeof Fibers < "u" && Fibers.trampoline());
    }, whenDone() {
      return new Promise((a, i) => {
        j.asyncPromiseHandlers = { resolve: a, reject: i };
      });
    }, allocateData() {
      var a = Ne(12 + j.StackSize);
        ...
        if (j.state === j.State.Normal) {
          ...
          a((f = 0) => {
            if (!N && (j.handleSleepReturnValue = f, i = !0, !!l)) {
              j.state = j.State.Rewinding, ke(() => On(j.currData)), typeof MainLoop < "u" && MainLoop.func && MainLoop.resume();
              var m, b = !1;
              try {
              ...
              if (!j.currData) {
                ...
                y && (j.asyncPromiseHandlers = null, (b ? y.reject : y.resolve)(m), w = !0);
              }
              if (b && !w)
                throw m;
            }
          }), l = !0, i || (j.state = j.State.Unwinding, j.currData = j.allocateData(), typeof MainLoop < "u" && MainLoop.func && MainLoop.pause(), ke(() => bn(j.currData)));
        } else j.state === j.State.Rewinding ? (j.state = j.State.Normal, ke(wn), q(j.currData), j.currData = null, j.sleepCallbacks.forEach(bt)) : be(`invalid state: ${j.state}`);
    ...
    function vt(a, i, l, f, m, b) {
      var w = i.length;
      w < 2 && E("argTypes array size mismatch! Must at least get return value and 'this' types!"), i[1];
    ...
    var Cr = (a, i, l, f, m, b) => {
      ...
      m = ee(f, m), de([], [a], (y) => {
        ...
        }, de([], w, (D) => (D.splice(1, 0, null), y.registeredClass.constructor_body[i - 1] = vt(P, D, null, m, b), [])), [];
      });
    }, Ot = (a, i, l) => (a instanceof Object || E(`${l} with invalid "this": ${a}`), a instanceof i.registeredClass.constructor || E(`${l} incompatible with "this" of type ${a.constructor.name}`), a.$$.ptr || E(`cannot call emscripten binding method ${l} on deleted object`), je(a.$$.ptr, a.$$.ptrType.registeredClass, i.registeredClass)), jr = (a, i, l, f, m, b, w, y, P, D) => {
      i = W(i), m = ee(f, m), de([], [a], (T) => {
        T = T[0];
        var x = `${T.name}.${i}`, V = { get() {
          ge(`Cannot access ${x} due to unbound types`, [l, w]);
        }, enumerable: !0, configurable: !0 };
        return P ? V.set = () => ge(`Cannot access ${x} due to unbound types`, [l, w]) : V.set = (J) => E(x + " is a read-only property"), Object.defineProperty(T.registeredClass.instancePrototype, i, V), de([], P ? [l, w] : [l], (J) => {
          var Z = J[0], re = { get() {
            var K = Ot(this, T, x + " getter");
            return Z.fromWireType(m(b, K));
          }, enumerable: !0 };
          if (P) {
            P = ee(y, P);
            var G = J[1];
      ...
      m.values = {}, H(a, { name: i, constructor: m, fromWireType: function(b) {
        return this.constructor.values[b];
      }, toWireType: (b, w) => w.value, argPackAdvance: Y, readValueFromPointer: Dr(i, l, f), destructorFunction: null }), Re(i, m);
    }, xe = (a, i) => {
      var l = ae[a];
      ...
      var f = xe(a, "enum");
      i = W(i);
      var m = f.constructor, b = Object.create(f.constructor.prototype, { value: { value: l }, constructor: { value: Ce(`${f.name}_${i}`, function() {
      }) } });
      m.values[l] = b, m[i] = b;
    }, Rr = (a, i) => {
      switch (i) {
      ...
      a = W(a), a = Fr(a), m = ee(f, m), Re(a, function() {
        ...
        return ut(a, vt(a, T, null, m, b), i - 1), [];
      });
    }, xr = (a, i, l, f, m) => {
      i = W(i);
      var b = (T) => T;
      ...
      }, H(a, { name: i, fromWireType: b, toWireType: D, argPackAdvance: Y, readValueFromPointer: it(i, l, f !== 0), destructorFunction: null });
    }, Nr = (a, i, l) => {
      ...
      l = W(l), H(a, { name: l, fromWireType: b, argPackAdvance: Y, readValueFromPointer: b }, { ignoreDuplicateRegistrations: !0 });
    }, $r = (a, i, l, f) => {
      if (!(f > 0)) return 0;
      for (var m = l, b = l + f - 1, w = 0; w < a.length; ++w) {
      ...
      for (var b = ""; i < m; ) {
        ...
        var y = a[i++] & 63;
        if ((w & 224) == 192) {
          b += String.fromCharCode((w & 31) << 6 | y);
          continue;
        }
        var P = a[i++] & 63;
        if ((w & 240) == 224 ? w = (w & 15) << 12 | y << 6 | P : w = (w & 7) << 18 | y << 12 | P << 6 | a[i++] & 63, w < 65536)
          ...
          var D = w - 65536;
          b += String.fromCharCode(55296 | D >> 10, 56320 | D & 1023);
        }
      }
      return b;
    }, zr = (a, i) => a ? Ur(z, a, i) : "", Gr = (a, i) => {
      i = W(i), H(a, { name: i, fromWireType(l) {
        for (var f = $[l >> 2], m = l + 4, b, w, y = m, w = 0; w <= f; ++w) {
          var P = m + w;
          if (w == f || z[P] == 0) {
            var D = P - y, T = zr(y, D);
            b === void 0 ? b = T : (b += "\0", b += T), y = P + 1;
          }
        }
        return q(l), b;
      }, toWireType(l, f) {
        f instanceof ArrayBuffer && (f = new Uint8Array(f));
        var m, b = typeof f == "string";
        b || f instanceof Uint8Array || f instanceof Uint8ClampedArray || f instanceof Int8Array || E("Cannot pass non-string to std::string"), b ? m = Vr(f) : m = f.length;
        ...
        if ($[w >> 2] = m, b)
          ...
          for (var P = 0; P < m; ++P) {
            ...
            D > 255 && (q(w), E("String has UTF-16 code units that do not fit in 8 bits")), z[y + P] = D;
          }
        else
          for (var P = 0; P < m; ++P)
            z[y + P] = f[P];
      ...
      l -= 2;
      for (var f = i, m = l < a.length * 2 ? l / 2 : a.length, b = 0; b < m; ++b) {
      ...
      for (var f = i, m = f + l - 4, b = 0; b < a.length; ++b) {
        var w = a.charCodeAt(b);
        if (w >= 55296 && w <= 57343) {
      ...
      l = W(l);
      var f, m, b, w;
      i === 2 ? (f = Hr, m = Br, w = Yr, b = (y) => pe[y >> 1]) : i === 4 && (f = Jr, m = Zr, w = Kr, b = (y) => $[y >> 2]), H(a, { name: l, fromWireType: (y) => {
      ...
      for (var f = 1; f <= 4; f *= 2) {
        ...
        var b = Math.min(l, fn(Math.max(a, m), 65536)), w = pn(b);
        if (w)
          return !0;
      }
      return !1;
    ...
    var yn = { i: Yt, s: Jt, n: qt, w: Xt, f: vr, d: Cr, a: jr, u: Ar, l: _r, g: Er, m: Mr, b: Lr, e: xr, c: Nr, v: Gr, h: qr, x: Xr, q: Qr, j: tn, y: Le, k: rn, o: an, A: sn, z: ln, r: un, t: mn, p: ht }, _ = await zt();
    _.C;
...
class si extends No {
  ...
  parseRawData(c, r) {
    const { brightness: t, sharpness: e } = c.params, { bottomRightX: n, bottomRightY: o, leftEye: d, mouth: u, rightEye: O, topLeftX: A, topLeftY: v } = c, I = Mn(d), S = Mn(O), k = Mn(u);
    return {
      confidence: c.confidence / jt,
      topLeft: {
        x: A,
        y: v
      },
