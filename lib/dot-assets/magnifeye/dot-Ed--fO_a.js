const fo = /* @__PURE__ */ Symbol("Comlink.proxy"), Po = /* @__PURE__ */ Symbol("Comlink.endpoint"), jo = /* @__PURE__ */ Symbol("Comlink.releaseProxy"), Tt = /* @__PURE__ */ Symbol("Comlink.finalizer"), kt = /* @__PURE__ */ Symbol("Comlink.thrown"), po = (g) => typeof g == "object" && g !== null || typeof g == "function", Io = {
...
function Ln(g, c = globalThis, r = ["*"]) {
  c.addEventListener("message", function t(e) {
    ...
    let w;
    try {
      const A = d.slice(0, -1).reduce((j, S) => j[S], g), v = d.reduce((j, S) => j[S], g);
      switch (o) {
        case "GET":
          w = v;
          break;
    ...
    Promise.resolve(w).catch((A) => ({ value: A, [kt]: 0 })).then((A) => {
      const [v, j] = _t(A);
      c.postMessage(Object.assign(Object.assign({}, v), { id: n }), j), o === "RELEASE" && (c.removeEventListener("message", t), yo(c), Tt in g && typeof g[Tt] == "function" && g[Tt]());
    }).catch((A) => {
      const [v, j] = _t({
...
var ze = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Wn = {}, Pn = {}, jn, Vn;
function Vo() {
  if (Vn) return jn;
  Vn = 1, jn = g;
  function g(c, r) {
...
function vo() {
  ...
  u.create = w(), u.alloc = function(I) {
    return new g.Array(I);
  }, g.Array !== Array && (u.alloc = g.pool(u.alloc, g.Array.prototype.subarray)), u.prototype._push = function(I, M, N) {
  ...
  u.prototype.fixed32 = function(I) {
    ...
    return this._push(g.float.writeFloatLE, 4, I);
  }, u.prototype.double = function(I) {
    return this._push(g.float.writeDoubleLE, 8, I);
  };
  var L = g.Array.prototype.set ? function(I, M, N) {
    M.set(I, N);
  } : function(I, M, N) {
  ...
  var o = typeof Uint8Array < "u" ? function(v) {
    ...
    return g.Buffer ? function(v) {
      return (n.create = function(j) {
        return g.Buffer.isBuffer(j) ? new c(j) : o(j);
      })(v);
    } : o;
  };
...
var ri = (() => {
  ...
  return (async function(c = {}) {
    ...
    var I = t.wasmBinary, M, N = !1, se, X, z, le, pe, Q, $, He, Be, Ye, Je, Ze = (a) => a.startsWith("file://");
    function Ke() {
      var a = M.buffer;
    ...
    var ye = (a) => typeof FinalizationRegistry > "u" ? (ye = (i) => i, a) : (Ee = new FinalizationRegistry((i) => {
      ...
      Object.assign(je.prototype, { isAliasOf(a) {
        if (!(this instanceof je) || !(a instanceof je))
          return !1;
    ...
    var Ie = (a, i) => Object.defineProperty(i, "name", { value: a }), ar = (a, i, l) => {
...
` + m.replace(/^Error(:[^\n]*)?\n/, ""));
      ...
      Me(J, function() {
        ...
        Z = Z[0];
        var re, G;
        f ? (re = Z.registeredClass, G = re.instancePrototype) : G = je.prototype;
        var K = Ie(T, function(...We) {
          ...
          var It = U.constructor_body[We.length];
          if (It === void 0)
        ...
        var oe = new Te(T, U, !0, !1, !1), Ae = new Te(T + "*", U, !1, !1, !1), jt = new Te(T + " const*", U, !1, !0, !1);
        return ct[a] = { pointerType: Ae, constPointerType: jt }, ut(J, K), [oe, Ae, jt];
      });
    }, pt = (a, i) => {
      for (var l = [], f = 0; f < a; f++)
        l.push($[i + f * 4 >> 2]);
    ...
    var Ir = (a, i, l, f, m, h) => {
      ...
      var f = xe(a, "enum");
      i = W(i);
      var m = f.constructor, h = Object.create(f.constructor.prototype, { value: { value: l }, constructor: { value: Ie(`${f.name}_${i}`, function() {
      }) } });
      m.values[l] = h, m[i] = h;
    }, Mr = (a, i) => {
      switch (i) {
    ...
    var yn = { i: Yt, s: Jt, n: qt, w: Xt, f: vr, d: Ir, a: Cr, u: Ar, l: _r, g: Er, m: Rr, b: Lr, e: xr, c: Nr, v: Gr, h: qr, x: Xr, q: Qr, j: tn, y: Le, k: rn, o: an, A: sn, z: ln, r: un, t: mn, p: ht }, _ = await zt();
    _.C;
...
class si extends No {
  ...
  parseRawData(c, r) {
    const { brightness: t, sharpness: e } = c.params, { bottomRightX: n, bottomRightY: o, leftEye: d, mouth: u, rightEye: w, topLeftX: A, topLeftY: v } = c, j = Rn(d), S = Rn(w), k = Rn(u);
    return {
