...
function pt(y, s = globalThis, r = ["*"]) {
  s.addEventListener("message", function t(e) {
    ...
    Promise.resolve(h).catch((S) => ({ value: S, [Ne]: 0 })).then((S) => {
      const [g, w] = ze(S);
      s.postMessage(Object.assign(Object.assign({}, g), { id: n }), w), o === "RELEASE" && (s.removeEventListener("message", t), Sr(s), xe in y && typeof y[xe] == "function" && y[xe]());
    }).catch((S) => {
      const [g, w] = ze({
        value: new TypeError("Unserializable return value"),
        [Ne]: 0
      });
      s.postMessage(Object.assign(Object.assign({}, g), { id: n }), w);
    });
  }), s.start && s.start();
}
function Co(y) {
...
const We = /* @__PURE__ */ new WeakMap(), Ve = "FinalizationRegistry" in globalThis && new FinalizationRegistry((y) => {
  const s = (We.get(y) || 0) - 1;
  We.set(y, s), s === 0 && Cr(y);
});
function Ao(y, s) {
  const r = (We.get(s) || 0) + 1;
  We.set(s, r), Ve && Ve.register(y, s, y);
}
function To(y) {
  Ve && Ve.unregister(y);
}
function dt(y, s, r = [], t = function() {
}) {
  let e = !1;
  const n = new Proxy(t, {
    get(o, u) {
...
function Yt(y) {
  const s = y.map(ze);
  return [s.map((r) => r[0]), Do(s.map((r) => r[1]))];
}
...
const _e = 1e3, Jt = {
  simd: "sam_simd.wasm",
  sam: "sam.wasm"
}, Lo = async () => WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 5, 1, 96, 0, 1, 123, 3, 2, 1, 0, 10, 10, 1, 8, 0, 65, 0, 253, 15, 253, 98, 11])), Zt = {
  LEFT: "Left",
  RIGHT: "Right"
}, Kt = {
  PALMAR: "Palmar",
...
class G extends Error {
  ...
  static fromCameraError(s) {
    if (this.logError(s), s instanceof G)
      return s;
    let r;
    switch (s.name) {
...
class Wo {
  ...
  async getSamWasmFileName() {
    return await Lo() ? Jt.simd : Jt.sam;
  }
  ...
  writeImageToMemory(s) {
    ...
    const r = new No(this.samWasmModule, s);
...
const Fe = (y, s) => Math.hypot(s.x - y.x, s.y - y.y), Vo = (y) => {
  const { bottomLeft: s, bottomRight: r, topLeft: t, topRight: e } = y, n = Fe(t, e), o = Fe(e, r), u = Fe(s, r), a = Fe(t, s);
...
function Uo() {
  return er || (er = 1, (function(y) {
    ...
    s.encode = function(o, u, a) {
      for (var h = null, S = [], g = 0, w = 0, I; u < a; ) {
        var j = o[u++];
        switch (w) {
          case 0:
    ...
    s.decode = function(o, u, a) {
      for (var h = a, S = 0, g, w = 0; w < o.length; ) {
...
function $o() {
  ...
  function y(n) {
    return typeof Float32Array < "u" ? (function() {
      ...
      n.readFloatLE = a ? g : w, n.readFloatBE = a ? w : g;
    })() : (function() {
      function o(a, h, S, g) {
        var w = h < 0 ? 1 : 0;
        if (w && (h = -h), h === 0)
      ...
      n.readDoubleLE = a ? g : w, n.readDoubleBE = a ? w : g;
    })() : (function() {
      function o(a, h, S, g, w, I) {
        var j = g < 0 ? 1 : 0;
        if (j && (g = -g), g === 0)
          a(0, w, I + h), a(1 / g > 0 ? (
            /* positive */
          ...
          if (g < 22250738585072014e-324)
            R = g / 5e-324, a(R >>> 0, w, I + h), a((j << 31 | R / 4294967296) >>> 0, w, I + S);
          else {
            var O = Math.floor(Math.log(g) / Math.LN2);
            O === 1024 && (O = 1023), R = g * Math.pow(2, -O), a(R * 4503599627370496 >>> 0, w, I + h), a((j << 31 | O + 1023 << 20 | R * 1048576 & 1048575) >>> 0, w, I + S);
          }
        }
      }
      n.writeDoubleLE = o.bind(null, s, 0, 4), n.writeDoubleBE = o.bind(null, r, 4, 0);
      function u(a, h, S, g, w) {
        var I = a(g, w + h), j = a(g, w + S), R = (j >> 31) * 2 + 1, O = j >>> 20 & 2047, T = 4294967296 * (j & 1048575) + I;
        return O === 2047 ? T ? NaN : R * (1 / 0) : O === 0 ? R * 5e-324 * T : R * Math.pow(2, O - 1075) * (T + 4503599627370496);
      }
...
function ue() {
  return cr || (cr = 1, (function(y) {
    var s = y;
    s.asPromise = zo(), s.base64 = Uo(), s.EventEmitter = Go(), s.float = $o(), s.inquire = Bo(), s.utf8 = Ho(), s.pool = Yo(), s.LongBits = Jo(), s.isNode = !!(typeof ye < "u" && ye && ye.process && ye.process.versions && ye.process.versions.node), s.global = s.isNode && ye || typeof window < "u" && window || typeof self < "u" && self || Qe, s.emptyArray = Object.freeze ? Object.freeze([]) : (
...
function Ar() {
  ...
  }, y.Array !== Array && (a.alloc = y.pool(a.alloc, y.Array.prototype.subarray)), a.prototype._push = function(O, T, _) {
  ...
  w.prototype = Object.create(n.prototype), w.prototype.fn = g, a.prototype.uint32 = function(O) {
  ...
  var R = y.Array.prototype.set ? function(O, T, _) {
    T.set(O, _);
  } : function(O, T, _) {
  ...
  return a.prototype.bytes = function(O) {
    ...
    if (y.isString(O)) {
      var _ = a.alloc(T = t.length(O));
      t.decode(O, _, 0), O = _;
    }
    return this.uint32(T)._push(R, T, O);
  ...
  var o = typeof Uint8Array < "u" ? function(g) {
    ...
    return y.Buffer ? function(g) {
      return (n.create = function(w) {
        return y.Buffer.isBuffer(w) ? new s(w) : o(w);
      })(g);
    } : o;
  };
...
function ei() {
  return vr || (vr = 1, (function(y) {
    var s = y;
    s.build = "minimal", s.Writer = Ar(), s.BufferWriter = Zo(), s.Reader = Tr(), s.BufferReader = Ko(), s.util = ue(), s.rpc = Xo(), s.roots = Qo(), s.configure = r;
    function r() {
...
var ri = (() => {
  ...
  return (async function(s = {}) {
    ...
    var I, j;
    (u || a) && (a ? g = self.location.href : typeof document < "u" && document.currentScript && (g = document.currentScript.src), y && (g = y), g.startsWith("blob:") ? g = "" : g = g.slice(0, g.replace(/[?#].*/, "").lastIndexOf("/") + 1), a && (j = (c) => {
    ...
    async function Nr(c, l) {
      try {
        ...
        R(`failed to asynchronously prepare wasm: ${b}`), Pe(b);
      }
    }
    ...
    async function zr() {
      function c(P, C) {
        return F = P.exports, F = D.instrumentWasmExports(F), T = F.B, bt(), F.H, Lr(), F;
      }
      Rr();
      function l(P) {
        return c(P.instance);
    ...
    function rn(c) {
      ...
      var k = Dt(l, this.registeredClass, v.registeredClass);
    ...
    var ve = (c) => typeof FinalizationRegistry > "u" ? (ve = (l) => l, c) : ($e = new FinalizationRegistry((l) => {
      ...
      Object.assign(ke.prototype, { isAliasOf(c) {
        ...
        this.$$.ptr || Ge(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && x("Object already scheduled for deletion"), At(this), Tt(this.$$), this.$$.preservePointerOnDelete || (this.$$.smartPtr = void 0, this.$$.ptr = void 0);
      }, isDeleted() {
        return !this.$$.ptr;
      }, deleteLater() {
    ...
    var Ae = (c, l) => Object.defineProperty(l, "name", { value: c }), on = (c, l, p) => {
    ...
    function un(c, l) {
      ...
      var p = l.$$.ptrType.registeredClass, m = Te(l.$$.ptr, p, this.registeredClass);
      return m;
    }
    function dn(c, l) {
      var p;
      ...
      if (p = Te(l.$$.ptr, m, this.registeredClass), this.isSmartPointer)
    ...
    var fn = () => {
      ...
      }, argPackAdvance: J, readValueFromPointer: De, fromWireType: rn });
    };
    function Ee(c, l, p, m, b, P, C, v, k, L, M) {
      this.name = c, this.registeredClass = l, this.isReference = p, this.isConst = m, this.isSmartPointer = b, this.pointeeType = P, this.sharingPolicy = C, this.rawGetPointee = v, this.rawConstructor = k, this.rawShare = L, this.rawDestructor = M, !b && l.baseClass === void 0 ? m ? (this.toWireType = un, this.destructorFunction = null) : (this.toWireType = pn, this.destructorFunction = null) : this.toWireType = dn;
    }
    var Mt = (c, l, p) => {
...
` + b.replace(/^Error(:[^\n]*)?\n/, ""));
      ...
      throw l.forEach(b), new Rt(`${c}: ` + p.map(Lt).join([", "]));
    }, bn = (c, l, p, m, b, P, C, v, k, L, M, N, z) => {
      ...
      Be(Z, function() {
        ...
        q.prototype = ie;
        var U = new cn(M, q, ie, z, oe, P, v, L);
        U.baseClass && (U.baseClass.__derivedClasses ??= [], U.baseClass.__derivedClasses.push(U));
        var ae = new Ee(M, U, !0, !1, !1), Re = new Ee(M + "*", U, !1, !1, !1), Bt = new Ee(M + " const*", U, !1, !0, !1);
        return Et[c] = { pointerType: Re, constPointerType: Bt }, Mt(Z, q), [ae, Re, Bt];
      });
    }, _t = (c, l) => {
      for (var p = [], m = 0; m < c; m++)
        p.push(W[l + m * 4 >> 2]);
    ...
    var Me = (c) => {
      ...
      D.currData && D.state === D.State.Unwinding && D.exportCallStack.length === 0 && (D.state = D.State.Normal, Me(bo), typeof Fibers < "u" && Fibers.trampoline());
    }, whenDone() {
      return new Promise((c, l) => {
        D.asyncPromiseHandlers = { resolve: c, reject: l };
      });
    }, allocateData() {
      var c = Ke(12 + D.StackSize);
      ...
      if (!_) {
        if (D.state === D.State.Normal) {
          var l = !1, p = !1;
          c((m = 0) => {
            if (!_ && (D.handleSleepReturnValue = m, l = !0, !!p)) {
              D.state = D.State.Rewinding, Me(() => vo(D.currData)), typeof MainLoop < "u" && MainLoop.func && MainLoop.resume();
              var b, P = !1;
              try {
          ...
          }), p = !0, l || (D.state = D.State.Unwinding, D.currData = D.allocateData(), typeof MainLoop < "u" && MainLoop.func && MainLoop.pause(), Me(() => ho(D.currData)));
        } else D.state === D.State.Rewinding ? (D.state = D.State.Normal, Me(Oo), Q(D.currData), D.currData = null, D.sleepCallbacks.forEach(Vt)) : Pe(`invalid state: ${D.state}`);
    ...
    function zt(c, l, p, m, b, P) {
      ...
      var v = vn(l), k = l[0].name !== "void", L = C - 2, M = new Array(L), N = [], z = [], Z = function(...K) {
        z.length = 0;
        var oe;
        N.length = 1, N[0] = b;
        for (var B = 0; B < L; ++B)
    ...
    var In = (c, l, p, m, b, P) => {
      ...
      b = re(m, b), me([], [c], (v) => {
        ...
        }, me([], C, (L) => (L.splice(1, 0, null), v.registeredClass.constructor_body[l - 1] = zt(k, L, null, b, P), [])), [];
      });
    }, Ut = (c, l, p) => (c instanceof Object || x(`${p} with invalid "this": ${c}`), c instanceof l.registeredClass.constructor || x(`${p} incompatible with "this" of type ${c.constructor.name}`), c.$$.ptr || x(`cannot call emscripten binding method ${p} on deleted object`), Te(c.$$.ptr, c.$$.ptrType.registeredClass, l.registeredClass)), jn = (c, l, p, m, b, P, C, v, k, L) => {
      ...
      var l = Y.toValue(c);
      return Je(c), l;
    }, toWireType: (c, l) => Y.toHandle(l), argPackAdvance: J, readValueFromPointer: De, destructorFunction: null }, An = (c) => H(c, kn), Tn = (c, l, p) => {
      switch (l) {
        case 1:
          return p ? function(m) {
      ...
      }, toWireType: (P, C) => C.value, argPackAdvance: J, readValueFromPointer: Tn(l, p, m), destructorFunction: null }), Be(l, b);
    }, Ze = (c, l) => {
      var p = le[c];
      return p === void 0 && x(`${l} has unknown type ${Lt(c)}`), p;
    }, En = (c, l, p) => {
      var m = Ze(c, "enum");
      l = V(l);
      var b = m.constructor, P = Object.create(m.constructor.prototype, { value: { value: p }, constructor: { value: Ae(`${m.name}_${l}`, function() {
      }) } });
      b.values[p] = P, b[l] = P;
    }, Mn = (c, l) => {
      switch (l) {
      ...
      var k = _t(l, p);
      c = V(c), c = Ln(c), b = re(m, b), Be(c, function() {
      ...
      }, H(c, { name: l, fromWireType: P, toWireType: L, argPackAdvance: J, readValueFromPointer: kt(l, p, m !== 0), destructorFunction: null });
    }, xn = (c, l, p) => {
      ...
      l = V(l), H(c, { name: l, fromWireType(p) {
        ...
        if (W[C >> 2] = b, P)
          ...
          for (var k = 0; k < b; ++k) {
            ...
            L > 255 && (Q(C), x("String has UTF-16 code units that do not fit in 8 bits")), $[v + k] = L;
          }
        else
          for (var k = 0; k < b; ++k)
            $[v + k] = m[k];
        return p !== null && p.push(Q, C), C;
      }, argPackAdvance: J, readValueFromPointer: De, destructorFunction(p) {
        Q(p);
      } });
      ...
      l === 2 ? (m = $n, b = Bn, C = Hn, P = (v) => he[v >> 1]) : l === 4 && (m = Yn, b = Jn, C = Zn, P = (v) => W[v >> 2]), H(c, { name: p, fromWireType: (v) => {
        ...
        var L = C(k), M = Ke(4 + L + l);
        return W[M >> 2] = L / l, b(k, M + 4, L + l), v !== null && v.push(Q, M), M;
      }, argPackAdvance: J, readValueFromPointer: De, destructorFunction(v) {
        Q(v);
      } });
    }, qn = (c, l) => {
    ...
    }, nn(), fn(), Rt = t.UnboundTypeError = hn(Error, "UnboundTypeError"), Cn();
    var mo = { g: Br, s: Hr, n: Zr, w: Kr, f: bn, d: In, a: jn, u: An, l: Dn, h: En, m: Rn, b: _n, e: Fn, c: xn, v: Gn, i: Kn, x: qn, q: Xn, j: eo, y: Je, k: to, o: oo, A: io, z: ao, r: lo, t: fo, p: Wt }, F = await zr();
    F.C;
