...
function Yt(y) {
  const s = y.map(ze);
  return [s.map((r) => r[0]), Ao(s.map((r) => r[1]))];
}
  ...
  function y(n) {
    return typeof Float32Array < "u" ? (function() {
      ...
      function u(a, h, S, g, w) {
        var I = a(g, w + h), j = a(g, w + S), R = (j >> 31) * 2 + 1, O = j >>> 20 & 2047, D = 4294967296 * (j & 1048575) + I;
        return O === 2047 ? D ? NaN : R * (1 / 0) : O === 0 ? R * 5e-324 * D : R * Math.pow(2, O - 1075) * (D + 4503599627370496);
      }
...
function Tr() {
  ...
  function n(O, D, _) {
    this.fn = O, this.len = D, this.next = void 0, this.val = _;
  }
  function o() {
  }
  function u(O) {
  ...
  }, y.Array !== Array && (a.alloc = y.pool(a.alloc, y.Array.prototype.subarray)), a.prototype._push = function(O, D, _) {
    return this.tail = this.tail.next = new n(O, D, _), this.len += D, this;
  };
  function S(O, D, _) {
    D[_] = O & 255;
  }
  ...
  function I(O, D, _) {
    for (; O.hi; )
      D[_++] = O.lo & 127 | 128, O.lo = (O.lo >>> 7 | O.hi << 25) >>> 0, O.hi >>>= 7;
    for (; O.lo > 127; )
      D[_++] = O.lo & 127 | 128, O.lo = O.lo >>> 7;
    D[_++] = O.lo;
  }
  a.prototype.uint64 = function(O) {
    ...
    var D = r.from(O).zzEncode();
    return this._push(I, D.length(), D);
  }, a.prototype.bool = function(O) {
    return this._push(S, 1, O ? 1 : 0);
  };
  function j(O, D, _) {
    D[_] = O & 255, D[_ + 1] = O >>> 8 & 255, D[_ + 2] = O >>> 16 & 255, D[_ + 3] = O >>> 24;
  }
  ...
  var R = y.Array.prototype.set ? function(O, D, _) {
    D.set(O, _);
  } : function(O, D, _) {
  ...
  return a.prototype.bytes = function(O) {
    ...
    if (y.isString(O)) {
      var _ = a.alloc(D = t.length(O));
      t.decode(O, _, 0), O = _;
    }
    return this.uint32(D)._push(R, D, O);
    ...
    var O = this.head, D = this.tail, _ = this.len;
    return this.reset().uint32(_), _ && (this.tail.next = O.next, this.tail = D, this.len += _), this;
  }, a.prototype.finish = function() {
    for (var O = this.head.next, D = this.constructor.alloc(this.len), _ = 0; O; )
      O.fn(O.val, D, _), _ += O.len, O = O.next;
    return D;
...
var ri = (() => {
  ...
  return (async function(s = {}) {
    ...
    var O = t.wasmBinary, D, _ = !1, X, ee, $, de, he, te, W, ft, mt, yt, gt, ht = (c) => c.startsWith("file://");
    function bt() {
      var c = D.buffer;
    ...
    async function zr() {
      function c(P, C) {
        return F = P.exports, F = A.instrumentWasmExports(F), D = F.B, bt(), F.H, Lr(), F;
      }
      Rr();
      function l(P) {
        return c(P.instance);
...
` + b.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    }, Ut = (c, l, p) => (c instanceof Object || x(`${p} with invalid "this": ${c}`), c instanceof l.registeredClass.constructor || x(`${p} incompatible with "this" of type ${c.constructor.name}`), c.$$.ptr || x(`cannot call emscripten binding method ${p} on deleted object`), De(c.$$.ptr, c.$$.ptrType.registeredClass, l.registeredClass)), jn = (c, l, p, m, b, P, C, v, k, L) => {
    ...
    var mo = { g: Br, s: Hr, n: Zr, w: Kr, f: bn, d: In, a: jn, u: Tn, l: An, h: En, m: Rn, b: _n, e: Fn, c: xn, v: Gn, i: Kn, x: qn, q: Xn, j: eo, y: Je, k: to, o: oo, A: io, z: ao, r: lo, t: fo, p: Wt }, F = await zr();
    F.C;
