...
var Mo = (f, a, r) => a in f ? Eo(f, a, { enumerable: !0, configurable: !0, writable: !0, value: r }) : f[a] = r;
var Ne = (f, a, r) => Mo(f, typeof a != "symbol" ? a + "" : a, r), rr = (f, a, r) => a.has(f) || tr("Cannot " + r);
var X = (f, a, r) => (rr(f, a, "read from private field"), r ? r.call(f) : a.get(f)), We = (f, a, r) => a.has(f) ? tr("Cannot add the same private member more than once") : a instanceof WeakSet ? a.add(f) : a.set(f, r), Ve = (f, a, r, t) => (rr(f, a, "write to private field"), t ? t.call(f, r) : a.set(f, r), r);
/**
 * @license
...
function vt(f, a = globalThis, r = ["*"]) {
  a.addEventListener("message", function t(e) {
    ...
    let h;
    try {
      const S = u.slice(0, -1).reduce((w, j) => w[j], f), g = u.reduce((w, j) => w[j], f);
      switch (o) {
        case "GET":
          h = g;
          break;
    ...
    Promise.resolve(h).catch((S) => ({ value: S, [Be]: 0 })).then((S) => {
      const [g, w] = Je(S);
      a.postMessage(Object.assign(Object.assign({}, g), { id: n }), w), o === "RELEASE" && (a.removeEventListener("message", t), _r(a), $e in f && typeof f[$e] == "function" && f[$e]());
    }).catch((S) => {
      const [g, w] = Je({
...
const He = /* @__PURE__ */ new WeakMap(), Ye = "FinalizationRegistry" in globalThis && new FinalizationRegistry((f) => {
  const a = (He.get(f) || 0) - 1;
  He.set(f, a), a === 0 && Fr(f);
});
function Vo(f, a) {
  const r = (He.get(a) || 0) + 1;
  He.set(a, r), Ye && Ye.register(f, a, f);
}
function zo(f) {
  Ye && Ye.unregister(f);
}
function bt(f, a, r = [], t = function() {
}) {
  let e = !1;
  const n = new Proxy(t, {
    get(o, u) {
...
function nr(f) {
  const a = f.map(Je);
  return [a.map((r) => r[0]), Uo(a.map((r) => r[1]))];
}
...
class Ko {
  constructor(a, r) {
    ...
    We(this, pe);
    We(this, Oe);
    Ve(this, le, a), Ve(this, pe, this.allocate(r.length * r.BYTES_PER_ELEMENT)), Ve(this, Oe, this.allocate(r.length * r.BYTES_PER_ELEMENT));
  }
  ...
  writeDataToMemory(a) {
    X(this, le).HEAPU8.set(a, X(this, pe));
  }
}
...
class qo {
  ...
  writeImageToMemory(a) {
    ...
    const r = new Ko(this.samWasmModule, a);
...
const Ge = (f, a) => Math.hypot(a.x - f.x, a.y - f.y), Xo = (f) => {
  const { bottomLeft: a, bottomRight: r, topLeft: t, topRight: e } = f, n = Ge(t, e), o = Ge(e, r), u = Ge(a, r), s = Ge(t, a);
...
function ei() {
  return ur || (ur = 1, function(f) {
    ...
    a.encode = function(o, u, s) {
      for (var h = null, S = [], g = 0, w = 0, j; u < s; ) {
        var I = o[u++];
        switch (w) {
          case 0:
            S[g++] = r[I >> 2], j = (I & 3) << 4, w = 1;
            break;
          case 1:
            S[g++] = r[j | I >> 4], j = (I & 15) << 2, w = 2;
            break;
          case 2:
            S[g++] = r[j | I >> 6], S[g++] = r[I & 63], w = 0;
            break;
        }
        g > 8191 && ((h || (h = [])).push(String.fromCharCode.apply(String, S)), g = 0);
      }
      return w && (S[g++] = r[j], S[g++] = 61, w === 1 && (S[g++] = 61)), h ? (g && h.push(String.fromCharCode.apply(String, S.slice(0, g))), h.join("")) : String.fromCharCode.apply(String, S.slice(0, g));
    };
    ...
    return typeof Float32Array < "u" ? function() {
      ...
      function o(s, h, S, g) {
        ...
        if (w && (h = -h), h === 0)
          ...
          s((w << 31 | j + 127 << 23 | I) >>> 0, S, g);
        }
      }
      n.writeFloatLE = o.bind(null, a), n.writeFloatBE = o.bind(null, r);
      function u(s, h, S) {
        var g = s(h, S), w = (g >> 31) * 2 + 1, j = g >>> 23 & 255, I = g & 8388607;
      ...
      function o(s, h, S, g, w, j) {
        ...
        if (I && (g = -g), g === 0)
          ...
          s(0, w, j + h), s(2146959360, w, j + S);
        else if (g > 17976931348623157e292)
          s(0, w, j + h), s((I << 31 | 2146435072) >>> 0, w, j + S);
        else {
          var L;
          if (g < 22250738585072014e-324)
            L = g / 5e-324, s(L >>> 0, w, j + h), s((I << 31 | L / 4294967296) >>> 0, w, j + S);
          else {
            var O = Math.floor(Math.log(g) / Math.LN2);
            O === 1024 && (O = 1023), L = g * Math.pow(2, -O), s(L * 4503599627370496 >>> 0, w, j + h), s((I << 31 | O + 1023 << 20 | L * 1048576 & 1048575) >>> 0, w, j + S);
          }
        }
      }
      n.writeDoubleLE = o.bind(null, a, 0, 4), n.writeDoubleBE = o.bind(null, r, 4, 0);
      function u(s, h, S, g, w) {
        var j = s(g, w + h), I = s(g, w + S), L = (I >> 31) * 2 + 1, O = I >>> 20 & 2047, T = 4294967296 * (I & 1048575) + j;
...
function fe() {
  return vr || (vr = 1, function(f) {
    var a = f;
    a.asPromise = Qo(), a.base64 = ei(), a.EventEmitter = ti(), a.float = ri(), a.inquire = ni(), a.utf8 = oi(), a.pool = ii(), a.LongBits = ai(), a.isNode = !!(typeof be < "u" && be && be.process && be.process.versions && be.process.versions.node), a.global = a.isNode && be || typeof window < "u" && window || typeof self < "u" && self || at, a.emptyArray = Object.freeze ? Object.freeze([]) : (
...
function Nr() {
  ...
  }, f.Array !== Array && (s.alloc = f.pool(s.alloc, f.Array.prototype.subarray)), s.prototype._push = function(O, T, _) {
  ...
  w.prototype = Object.create(n.prototype), w.prototype.fn = g, s.prototype.uint32 = function(O) {
    ...
    return O < 0 ? this._push(j, 10, r.fromNumber(O)) : this.uint32(O);
  ...
  var L = f.Array.prototype.set ? function(O, T, _) {
    T.set(O, _);
  } : function(O, T, _) {
...
function Wr() {
  ...
  var o = typeof Uint8Array < "u" ? function(g) {
    ...
    return f.Buffer ? function(g) {
      return (n.create = function(w) {
        return f.Buffer.isBuffer(w) ? new a(w) : o(w);
      })(g);
    } : o;
  };
  ...
  return n.prototype.float = function() {
    if (this.pos + 4 > this.len)
      throw e(this, 4);
    var g = f.float.readFloatLE(this.buf, this.pos);
    return this.pos += 4, g;
  }, n.prototype.double = function() {
    if (this.pos + 8 > this.len)
      throw e(this, 4);
    var g = f.float.readDoubleLE(this.buf, this.pos);
    return this.pos += 8, g;
  }, n.prototype.bytes = function() {
    var g = this.uint32(), w = this.pos, j = this.pos + g;
    if (j > this.len)
      throw e(this, g);
...
var kr, Tr;
function di() {
  return Tr || (Tr = 1, kr = {}), kr;
}
var Dr;
function pi() {
  return Dr || (Dr = 1, function(f) {
    var a = f;
    a.build = "minimal", a.Writer = Nr(), a.BufferWriter = si(), a.Reader = Wr(), a.BufferReader = li(), a.util = fe(), a.rpc = ui(), a.roots = di(), a.configure = r;
    function r() {
...
var mi = (() => {
  ...
  return async function(a = {}) {
    ...
    var j, I;
    (u || s) && (s ? g = self.location.href : typeof document < "u" && document.currentScript && (g = document.currentScript.src), f && (g = f), g.startsWith("blob:") ? g = "" : g = g.slice(0, g.replace(/[?#].*/, "").lastIndexOf("/") + 1), s && (I = (c) => {
    ...
    var O = t.wasmBinary, T, _ = !1, Q, te, $, me, we, re, W, Ot, wt, Pt, jt, It = (c) => c.startsWith("file://");
    function St() {
      var c = T.buffer;
      t.HEAP8 = te = new Int8Array(c), t.HEAP16 = me = new Int16Array(c), t.HEAPU8 = $ = new Uint8Array(c), t.HEAPU16 = we = new Uint16Array(c), t.HEAP32 = re = new Int32Array(c), t.HEAPU32 = W = new Uint32Array(c), t.HEAPF32 = Ot = new Float32Array(c), t.HEAPF64 = jt = new Float64Array(c), t.HEAP64 = wt = new BigInt64Array(c), t.HEAPU64 = Pt = new BigUint64Array(c);
    }
    function Vr() {
      if (t.preRun)
    ...
    async function Jr(c, l) {
      try {
        var p = await Yr(c), y = await WebAssembly.instantiate(p, l);
        return y;
      } catch (b) {
    ...
    async function Zr(c, l, p) {
      if (!c && typeof WebAssembly.instantiateStreaming == "function" && !It(l))
        try {
    ...
    async function qr() {
      function c(P, C) {
        return F = P.exports, F = A.instrumentWasmExports(F), T = F.B, St(), F.H, $r(), F;
      }
      Gr();
      function l(P) {
        return c(P.instance);
    ...
    var kt = (c) => {
      for (; c.length > 0; )
        c.shift()(t);
    }, Tt = [], Xr = (c) => Tt.unshift(c), Dt = [], Qr = (c) => Dt.unshift(c), At = t.noExitRuntime || !0;
    class en {
      constructor(l) {
    ...
    function on(c, l, p = {}) {
      ...
      if (ue[c] = l, delete Te[c], ye.hasOwnProperty(c)) {
        var b = ye[c];
    ...
    var Rt = (c, l, p) => {
      switch (l) {
        ...
        case 4:
          return p ? (y) => re[y >> 2] : (y) => W[y >> 2];
        case 8:
          return p ? (y) => wt[y >> 3] : (y) => Pt[y >> 3];
        default:
      ...
      return p !== y && De("Both smartPtrType and smartPtr must be specified"), l.count = { value: 1 }, je(Object.create(c, { $$: { value: l, writable: !0 } }));
    };
    function fn(c) {
      ...
      var k = xt(l, this.registeredClass, v.registeredClass);
      return k === null ? b.call(this) : this.isSmartPointer ? Ae(v.registeredClass.instancePrototype, { ptrType: v, ptr: k, smartPtrType: this, smartPtr: c }) : Ae(v.registeredClass.instancePrototype, { ptrType: v, ptr: k });
    }
    var je = (c) => typeof FinalizationRegistry > "u" ? (je = (l) => l, c) : (qe = new FinalizationRegistry((l) => {
      ...
      Object.assign(Ee.prototype, { isAliasOf(c) {
        ...
        var c = je(Object.create(Object.getPrototypeOf(this), { $$: { value: ln(this.$$) } }));
    ...
    var Me = (c, l) => Object.defineProperty(l, "name", { value: c }), yn = (c, l, p) => {
      ...
      return l >= gn && l <= hn ? `_${c}` : c;
    };
    function vn(c, l, p, y, b, P, C, v) {
    ...
    function On(c, l) {
      ...
      var p = l.$$.ptrType.registeredClass, y = Le(l.$$.ptr, p, this.registeredClass);
      return y;
    }
    function wn(c, l) {
      var p;
      ...
      if (p = Le(l.$$.ptr, y, this.registeredClass), this.isSmartPointer)
...
` + b.replace(/^Error(:[^\n]*)?\n/, ""));
      ...
      throw l.forEach(b), new Vt(`${c}: ` + p.map(zt).join([", "]));
    }, Tn = (c, l, p, y, b, P, C, v, k, R, M, N, z) => {
      M = V(M), P = ne(b, P), v && (v = ne(C, v)), R && (R = ne(k, R)), z = ne(N, z);
      var Z = bn(M);
      Xe(Z, function() {
        ...
        K = K[0];
        var ie, B;
        y ? (ie = K.registeredClass, B = ie.instancePrototype) : B = Ee.prototype;
        var q = Me(M, function(...it) {
          ...
          if (er === void 0)
            throw new ge(`Tried to invoke ctor of ${M} with invalid number of parameters (${it.length}) - expected (${Object.keys(U.constructor_body).toString()}) parameters instead!`);
          return er.apply(this, it);
        }), ae = Object.create(B, { constructor: { value: q } });
        q.prototype = ae;
        var U = new vn(M, q, ae, z, ie, P, v, R);
    ...
    var Fe = (c) => {
      ...
      A.currData && A.state === A.State.Unwinding && A.exportCallStack.length === 0 && (A.state = A.State.Normal, Fe(To), typeof Fibers < "u" && Fibers.trampoline());
    }, whenDone() {
      ...
      if (!_) {
        if (A.state === A.State.Normal) {
          ...
          }), p = !0, l || (A.state = A.State.Unwinding, A.currData = A.allocateData(), typeof MainLoop < "u" && MainLoop.func && MainLoop.pause(), Fe(() => ko(A.currData)));
    ...
    function Jt(c, l, p, y, b, P) {
      var C = l.length;
      C < 2 && x("argTypes array size mismatch! Must at least get return value and 'this' types!"), l[1];
      var v = Dn(l), k = l[0].name !== "void", R = C - 2, M = new Array(R), N = [], z = [], Z = function(...K) {
        z.length = 0;
        var ie;
        N.length = 1, N[0] = b;
        for (var B = 0; B < R; ++B)
    ...
    var Ln = (c, l, p, y, b, P) => {
      ...
      b = ne(y, b), he([], [c], (v) => {
        ...
        }, he([], C, (R) => (R.splice(1, 0, null), v.registeredClass.constructor_body[l - 1] = Jt(k, R, null, b, P), [])), [];
      });
    }, Zt = (c, l, p) => (c instanceof Object || x(`${p} with invalid "this": ${c}`), c instanceof l.registeredClass.constructor || x(`${p} incompatible with "this" of type ${c.constructor.name}`), c.$$.ptr || x(`cannot call emscripten binding method ${p} on deleted object`), Le(c.$$.ptr, c.$$.ptrType.registeredClass, l.registeredClass)), Rn = (c, l, p, y, b, P, C, v, k, R) => {
      l = V(l), b = ne(y, b), he([], [c], (M) => {
        M = M[0];
        var N = `${M.name}.${l}`, z = { get() {
          Ie(`Cannot access ${N} due to unbound types`, [p, C]);
        }, enumerable: !0, configurable: !0 };
        return k ? z.set = () => Ie(`Cannot access ${N} due to unbound types`, [p, C]) : z.set = (Z) => x(N + " is a read-only property"), Object.defineProperty(M.registeredClass.instancePrototype, l, z), he([], k ? [p, C] : [p], (Z) => {
          var K = Z[0], ie = { get() {
      ...
      }, toWireType: (P, C) => C.value, argPackAdvance: J, readValueFromPointer: Wn(l, p, y), destructorFunction: null }), Xe(l, b);
    }, rt = (c, l) => {
      var p = ue[c];
      return p === void 0 && x(`${l} has unknown type ${zt(c)}`), p;
    }, zn = (c, l, p) => {
      var y = rt(c, "enum");
      l = V(l);
      var b = y.constructor, P = Object.create(y.constructor.prototype, { value: { value: p }, constructor: { value: Me(`${y.name}_${l}`, function() {
      }) } });
      b.values[p] = P, b[l] = P;
    }, Un = (c, l) => {
      switch (l) {
      ...
      l = V(l), H(c, { name: l, fromWireType: (y) => y, toWireType: (y, b) => b, argPackAdvance: J, readValueFromPointer: Un(l, p), destructorFunction: null });
    }, $n = (c) => {
      c = c.trim();
      const l = c.indexOf("(");
      ...
      var k = Ut(l, p);
      c = V(c), c = $n(c), b = ne(y, b), Xe(c, function() {
      ...
      }, H(c, { name: l, fromWireType: P, toWireType: R, argPackAdvance: J, readValueFromPointer: Rt(l, p, y !== 0), destructorFunction: null });
    }, Yn = (c, l, p) => {
      ...
      l = V(l), H(c, { name: l, fromWireType(p) {
        ...
        P || y instanceof Uint8Array || y instanceof Uint8ClampedArray || y instanceof Int8Array || x("Cannot pass non-string to std::string"), P ? b = Kn(y) : b = y.length;
        ...
        if (W[C >> 2] = b, P)
          ...
          for (var k = 0; k < b; ++k) {
            ...
            R > 255 && (ee(C), x("String has UTF-16 code units that do not fit in 8 bits")), $[v + k] = R;
          }
        else
          for (var k = 0; k < b; ++k)
            $[v + k] = y[k];
      ...
      if (p = y << 1, p - c > 32 && qt) return qt.decode($.subarray(c, p));
      ...
      p = V(p);
      var y, b, P, C;
      l === 2 ? (y = eo, b = to, C = ro, P = (v) => we[v >> 1]) : l === 4 && (y = no, b = oo, C = io, P = (v) => W[v >> 2]), H(c, { name: p, fromWireType: (v) => {
    ...
    nn(), ge = t.BindingError = class extends Error {
      constructor(l) {
    ...
    }, mn(), jn(), Vt = t.UnboundTypeError = kn(Error, "UnboundTypeError"), Fn();
    var Io = { g: tn, s: rn, n: an, w: sn, f: Tn, d: Ln, a: Rn, u: Nn, l: Vn, h: zn, m: Gn, b: Bn, e: Hn, c: Yn, v: Qn, i: ao, x: so, q: lo, j: uo, y: tt, k: po, o: yo, A: go, z: ho, r: vo, t: jo, p: Ht }, F = await qr();
    F.C;
    ...
    var ko = F.ca, To = F.da, Do = F.ea, Ao = F.fa;
    function ot() {
      if (ce > 0) {
        Pe = ot;
        return;
      ...
      function c() {
        var l;
        t.calledRun = !0, !_ && (zr(), e(t), (l = t.onRuntimeInitialized) == null || l.call(t), Ur());
      }
...
let yi = class extends qo {
  ...
  parseRawData({ rawDetectedPalm: a, rawPalmAttributes: r }) {
    ...
    return {
      ...
      templateExtractionQuality: r.quality / Ue
    };
  }
