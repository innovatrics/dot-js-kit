...
var Fo = (p, l, n) => l in p ? Eo(p, l, { enumerable: !0, configurable: !0, writable: !0, value: n }) : p[l] = n;
var Ne = (p, l, n) => Fo(p, typeof l != "symbol" ? l + "" : l, n), rr = (p, l, n) => l.has(p) || tr("Cannot " + n);
var X = (p, l, n) => (rr(p, l, "read from private field"), n ? n.call(p) : l.get(p)), We = (p, l, n) => l.has(p) ? tr("Cannot add the same private member more than once") : l instanceof WeakSet ? l.add(p) : l.set(p, n), ze = (p, l, n, t) => (rr(p, l, "write to private field"), t ? t.call(p, n) : l.set(p, n), n);
/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */
const Fr = Symbol("Comlink.proxy"), _o = Symbol("Comlink.endpoint"), Lo = Symbol("Comlink.releaseProxy"), $e = Symbol("Comlink.finalizer"), Be = Symbol("Comlink.thrown"), _r = (p) => typeof p == "object" && p !== null || typeof p == "function", Mo = {
  canHandle: (p) => _r(p) && p[Fr],
  serialize(p) {
...
function vt(p, l = globalThis, n = ["*"]) {
  l.addEventListener("message", function t(e) {
    ...
    Promise.resolve(g).catch((S) => ({ value: S, [Be]: 0 })).then((S) => {
      const [y, P] = Je(S);
      l.postMessage(Object.assign(Object.assign({}, y), { id: r }), P), o === "RELEASE" && (l.removeEventListener("message", t), Mr(l), $e in p && typeof p[$e] == "function" && p[$e]());
    }).catch((S) => {
      const [y, P] = Je({
...
const He = /* @__PURE__ */ new WeakMap(), Ye = "FinalizationRegistry" in globalThis && new FinalizationRegistry((p) => {
  const l = (He.get(p) || 0) - 1;
  He.set(p, l), l === 0 && Rr(p);
});
function zo(p, l) {
  const n = (He.get(l) || 0) + 1;
  He.set(l, n), Ye && Ye.register(p, l, p);
}
function Vo(p) {
  Ye && Ye.unregister(p);
}
function bt(p, l, n = [], t = function() {
}) {
  let e = !1;
  const r = new Proxy(t, {
    get(o, u) {
...
function nr(p) {
  const l = p.map(Je);
  return [l.map((n) => n[0]), Uo(l.map((n) => n[1]))];
}
...
class qo {
  ...
  writeImageToMemory(l) {
    ...
    const n = new Zo(this.samWasmModule, l);
...
const Ge = (p, l) => Math.hypot(l.x - p.x, l.y - p.y), Xo = (p) => {
  const { bottomLeft: l, bottomRight: n, topLeft: t, topRight: e } = p, r = Ge(t, e), o = Ge(e, n), u = Ge(l, n), a = Ge(t, l);
  ...
  function p(r) {
    return typeof Float32Array < "u" ? function() {
      ...
      function u(a, g, S, y, P) {
        var I = a(y, P + g), j = a(y, P + S), F = (j >> 31) * 2 + 1, O = j >>> 20 & 2047, A = 4294967296 * (j & 1048575) + I;
        return O === 2047 ? A ? NaN : F * (1 / 0) : O === 0 ? F * 5e-324 * A : F * Math.pow(2, O - 1075) * (A + 4503599627370496);
      }
...
var vr;
function pe() {
  return vr || (vr = 1, function(p) {
    var l = p;
    l.asPromise = Qo(), l.base64 = ei(), l.EventEmitter = ti(), l.float = ri(), l.inquire = ni(), l.utf8 = oi(), l.pool = ii(), l.LongBits = ai(), l.isNode = !!(typeof be < "u" && be && be.process && be.process.versions && be.process.versions.node), l.global = l.isNode && be || typeof window < "u" && window || typeof self < "u" && self || at, l.emptyArray = Object.freeze ? Object.freeze([]) : (
...
function Nr() {
  ...
  function r(O, A, M) {
    this.fn = O, this.len = A, this.next = void 0, this.val = M;
  }
  function o() {
  }
  function u(O) {
  ...
  }, p.Array !== Array && (a.alloc = p.pool(a.alloc, p.Array.prototype.subarray)), a.prototype._push = function(O, A, M) {
    return this.tail = this.tail.next = new r(O, A, M), this.len += A, this;
  };
  function S(O, A, M) {
    A[M] = O & 255;
  }
  ...
  function P(O, A) {
    this.len = O, this.next = void 0, this.val = A;
  }
  ...
  function I(O, A, M) {
    for (; O.hi; )
      A[M++] = O.lo & 127 | 128, O.lo = (O.lo >>> 7 | O.hi << 25) >>> 0, O.hi >>>= 7;
    for (; O.lo > 127; )
      A[M++] = O.lo & 127 | 128, O.lo = O.lo >>> 7;
    A[M++] = O.lo;
  }
  a.prototype.uint64 = function(O) {
    ...
    var A = n.from(O).zzEncode();
    return this._push(I, A.length(), A);
  }, a.prototype.bool = function(O) {
    return this._push(S, 1, O ? 1 : 0);
  };
  function j(O, A, M) {
    A[M] = O & 255, A[M + 1] = O >>> 8 & 255, A[M + 2] = O >>> 16 & 255, A[M + 3] = O >>> 24;
  }
  ...
  var F = p.Array.prototype.set ? function(O, A, M) {
    A.set(O, M);
  } : function(O, A, M) {
  ...
  return a.prototype.bytes = function(O) {
    ...
    if (p.isString(O)) {
      var M = a.alloc(A = t.length(O));
      t.decode(O, M, 0), O = M;
    }
    return this.uint32(A)._push(F, A, O);
  }, a.prototype.string = function(O) {
    var A = e.length(O);
    return A ? this.uint32(A)._push(e.write, A, O) : this._push(S, 1, 0);
    ...
    var O = this.head, A = this.tail, M = this.len;
    return this.reset().uint32(M), M && (this.tail.next = O.next, this.tail = A, this.len += M), this;
  }, a.prototype.finish = function() {
    for (var O = this.head.next, A = this.constructor.alloc(this.len), M = 0; O; )
      O.fn(O.val, A, M), M += O.len, O = O.next;
    return A;
...
function fi() {
  return Dr || (Dr = 1, function(p) {
    var l = p;
    l.build = "minimal", l.Writer = Nr(), l.BufferWriter = si(), l.Reader = Wr(), l.BufferReader = li(), l.util = pe(), l.rpc = ui(), l.roots = di(), l.configure = n;
    function n() {
...
var mi = (() => {
  ...
  return async function(l = {}) {
    ...
    var O = t.wasmBinary, A, M = !1, Q, te, $, me, we, re, W, Ot, wt, Pt, It, jt = (c) => c.startsWith("file://");
    function Ct() {
      var c = A.buffer;
    ...
    async function Jr(c, s) {
      try {
        var f = await Yr(c), m = await WebAssembly.instantiate(f, s);
        return m;
      } catch (b) {
        F(`failed to asynchronously prepare wasm: ${b}`), Se(b);
      }
    }
    async function Kr(c, s, f) {
      if (!c && typeof WebAssembly.instantiateStreaming == "function" && !jt(s))
        try {
    ...
    async function qr() {
      function c(w, C) {
        return R = w.exports, R = D.instrumentWasmExports(R), A = R.B, Ct(), R.H, $r(), R;
      }
      Gr();
      function s(w) {
        return c(w.instance);
    ...
    var kt = (c) => {
      for (; c.length > 0; )
        c.shift()(t);
    }, At = [], Xr = (c) => At.unshift(c), Dt = [], Qr = (c) => Dt.unshift(c), Tt = t.noExitRuntime || !0;
    class en {
      constructor(s) {
    ...
    var Et = 0, tn = (c, s, f) => {
      ...
      function m(v) {
        var k = f(v);
        k.length !== c.length && De("Mismatched type converter count");
        for (var _ = 0; _ < c.length; ++_)
          H(c[_], k[_]);
      }
      var b = new Array(s.length), w = [], C = 0;
      s.forEach((v, k) => {
        ue.hasOwnProperty(v) ? b[k] = ue[v] : (w.push(v), ye.hasOwnProperty(v) || (ye[v] = []), ye[v].push(() => {
          b[k] = ue[v], ++C, C === w.length && m(b);
        }));
      }), w.length === 0 && m(b);
    };
    function on(c, s, f = {}) {
      ...
      if (ue[c] = s, delete Ae[c], ye.hasOwnProperty(c)) {
        var b = ye[c];
    ...
    var Lt = (c, s, f) => {
      ...
      }, argPackAdvance: J, readValueFromPointer: Lt(s, f, !w), destructorFunction: null });
    }, J = 8, sn = (c, s, f, m) => {
    ...
    }, ln = (c) => ({ count: c.count, deleteScheduled: c.deleteScheduled, preservePointerOnDelete: c.preservePointerOnDelete, ptr: c.ptr, ptrType: c.ptrType, smartPtr: c.smartPtr, smartPtrType: c.smartPtrType }), Ze = (c) => {
      function s(f) {
      ...
      if (f.baseClass === void 0)
        return null;
      var m = xt(c, s, f.baseClass);
      return m === null ? null : f.downcast(m);
    }, Nt = {}, un = {}, dn = (c, s) => {
      for (s === void 0 && x("ptr should not be undefined"); c.baseClass; )
        s = c.upcast(s), c = c.baseClass;
      return s;
    }, fn = (c, s) => (s = dn(c, s), un[s]), Te = (c, s) => {
      (!s.ptrType || !s.ptr) && De("makeClassHandle requires ptr and ptrType");
      var f = !!s.smartPtrType, m = !!s.smartPtr;
      return f !== m && De("Both smartPtrType and smartPtr must be specified"), s.count = { value: 1 }, Ie(Object.create(c, { $$: { value: s, writable: !0 } }));
    };
    function pn(c) {
      var s = this.getPointee(c);
      if (!s)
        return this.destructor(c), null;
      var f = fn(this.registeredClass, s);
      if (f !== void 0) {
        if (f.$$.count.value === 0)
      ...
      var w = this.registeredClass.getActualType(s), C = Nt[w];
      if (!C)
        return b.call(this);
      var v;
      this.isConst ? v = C.constPointerType : v = C.pointerType;
      var k = xt(s, this.registeredClass, v.registeredClass);
      return k === null ? b.call(this) : this.isSmartPointer ? Te(v.registeredClass.instancePrototype, { ptrType: v, ptr: k, smartPtrType: this, smartPtr: c }) : Te(v.registeredClass.instancePrototype, { ptrType: v, ptr: k });
    }
    var Ie = (c) => typeof FinalizationRegistry > "u" ? (Ie = (s) => s, c) : (qe = new FinalizationRegistry((s) => {
      Rt(s.$$);
    }), Ie = (s) => {
      ...
      Object.assign(Ee.prototype, { isAliasOf(c) {
        ...
        this.$$.ptr || Ze(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && x("Object already scheduled for deletion"), Mt(this), Rt(this.$$), this.$$.preservePointerOnDelete || (this.$$.smartPtr = void 0, this.$$.ptr = void 0);
      }, isDeleted() {
        return !this.$$.ptr;
      }, deleteLater() {
    ...
    var Fe = (c, s) => Object.defineProperty(s, "name", { value: c }), yn = (c, s, f) => {
      ...
      t.hasOwnProperty(c) ? ((f === void 0 || t[c].overloadTable !== void 0 && t[c].overloadTable[f] !== void 0) && x(`Cannot register public name '${c}' twice`), yn(t, c, c), t[c].overloadTable.hasOwnProperty(f) && x(`Cannot register multiple overloads of a function with the same number of arguments (${f})!`), t[c].overloadTable[f] = s) : (t[c] = s, t[c].argCount = f);
    }, hn = 48, gn = 57, bn = (c) => {
      c = c.replace(/[^a-zA-Z0-9_]/g, "$");
      var s = c.charCodeAt(0);
      return s >= hn && s <= gn ? `_${c}` : c;
    };
    function vn(c, s, f, m, b, w, C, v) {
    ...
    var In = () => {
      ...
      }, argPackAdvance: J, readValueFromPointer: Le, fromWireType: pn });
    };
    function Me(c, s, f, m, b, w, C, v, k, _, T) {
      this.name = c, this.registeredClass = s, this.isReference = f, this.isConst = m, this.isSmartPointer = b, this.pointeeType = w, this.sharingPolicy = C, this.rawGetPointee = v, this.rawConstructor = k, this.rawShare = _, this.rawDestructor = T, !b && s.baseClass === void 0 ? m ? (this.toWireType = On, this.destructorFunction = null) : (this.toWireType = Pn, this.destructorFunction = null) : this.toWireType = wn;
    }
    var Wt = (c, s, f) => {
      t.hasOwnProperty(c) || De("Replacing nonexistent public symbol"), t[c].overloadTable !== void 0 && f !== void 0 ? t[c].overloadTable[f] = s : (t[c] = s, t[c].argCount = f);
    }, jn = (c, s, f) => {
      c = c.replace(/p/g, "i");
      var m = t["dynCall_" + c];
      return m(s, ...f);
...
` + b.replace(/^Error(:[^\n]*)?\n/, ""));
      ...
      throw s.forEach(b), new zt(`${c}: ` + f.map(Vt).join([", "]));
    }, An = (c, s, f, m, b, w, C, v, k, _, T, N, V) => {
      T = z(T), w = ne(b, w), v && (v = ne(C, v)), _ && (_ = ne(k, _)), V = ne(N, V);
      var K = bn(T);
      Xe(K, function() {
        ...
        Z = Z[0];
        var ie, B;
        m ? (ie = Z.registeredClass, B = ie.instancePrototype) : B = Ee.prototype;
        var q = Fe(T, function(...it) {
          ...
          if (er === void 0)
            throw new he(`Tried to invoke ctor of ${T} with invalid number of parameters (${it.length}) - expected (${Object.keys(U.constructor_body).toString()}) parameters instead!`);
        ...
        var se = new Me(T, U, !0, !1, !1), xe = new Me(T + "*", U, !1, !1, !1), Xt = new Me(T + " const*", U, !1, !0, !1);
        return Nt[c] = { pointerType: xe, constPointerType: Xt }, Wt(K, q), [se, xe, Xt];
      });
    }, Ut = (c, s) => {
      for (var f = [], m = 0; m < c; m++)
        f.push(W[s + m * 4 >> 2]);
    ...
    var Re = (c) => {
      ...
      if (c instanceof St || c == "unwind")
        return Q;
      S(1, c);
    }, $t = 0, Bt = () => Tt || $t > 0, Ht = (c) => {
      var s;
      Q = c, Bt() || ((s = t.onExit) == null || s.call(t, c), M = !0), S(c, new St(c));
    }, Tn = (c, s) => {
      Q = c, Ht(c);
    }, En = Tn, Fn = () => {
      if (!Bt())
      ...
      for (let [f, m] of Object.entries(c))
        typeof m == "function" ? s[f] = (...b) => {
          ...
          try {
            ...
            M || (D.exportCallStack.pop(), D.maybeStopUnwind());
          }
        } : s[f] = m;
      return s;
      ...
      var s = D.callStackNameToId[c];
      return s === void 0 && (s = D.callStackId++, D.callStackNameToId[c] = s, D.callStackIdToName[s] = c), s;
    }, maybeStopUnwind() {
      D.currData && D.state === D.State.Unwinding && D.exportCallStack.length === 0 && (D.state = D.State.Normal, Re(Ao), typeof Fibers < "u" && Fibers.trampoline());
    }, whenDone() {
      return new Promise((c, s) => {
        D.asyncPromiseHandlers = { resolve: c, reject: s };
      });
    }, allocateData() {
      var c = nt(12 + D.StackSize);
      return D.setDataHeader(c, c + 12, D.StackSize), D.setDataRewindFunc(c), c;
    }, setDataHeader(c, s, f) {
      W[c >> 2] = s, W[c + 4 >> 2] = s + f;
    }, setDataRewindFunc(c) {
      var s = D.exportCallStack[0], f = D.getCallStackId(s);
      re[c + 8 >> 2] = f;
    }, getDataRewindFuncName(c) {
      var s = re[c + 8 >> 2], f = D.callStackIdToName[s];
      return f;
    }, getDataRewindFunc(c) {
      var s = R[c];
      return s;
    }, doRewind(c) {
      var s = D.getDataRewindFuncName(c), f = D.getDataRewindFunc(s);
      return f();
    }, handleSleep(c) {
      if (!M) {
        if (D.state === D.State.Normal) {
          var s = !1, f = !1;
          c((m = 0) => {
            if (!M && (D.handleSleepReturnValue = m, s = !0, !!f)) {
              D.state = D.State.Rewinding, Re(() => Do(D.currData)), typeof MainLoop < "u" && MainLoop.func && MainLoop.resume();
              var b, w = !1;
              try {
              ...
              if (!D.currData) {
                ...
                v && (D.asyncPromiseHandlers = null, (w ? v.reject : v.resolve)(b), C = !0);
              }
              if (w && !C)
                throw b;
            }
          }), f = !0, s || (D.state = D.State.Unwinding, D.currData = D.allocateData(), typeof MainLoop < "u" && MainLoop.func && MainLoop.pause(), Re(() => ko(D.currData)));
        } else D.state === D.State.Rewinding ? (D.state = D.State.Normal, Re(To), ee(D.currData), D.currData = null, D.sleepCallbacks.forEach(Yt)) : Se(`invalid state: ${D.state}`);
        return D.handleSleepReturnValue;
      }
    }, handleAsync(c) {
      return D.handleSleep((s) => {
        c().then(s);
      });
    } };
    function Jt(c, s, f, m, b, w) {
      var C = s.length;
      C < 2 && x("argTypes array size mismatch! Must at least get return value and 'this' types!"), s[1];
      var v = Dn(s), k = s[0].name !== "void", _ = C - 2, T = new Array(_), N = [], V = [], K = function(...Z) {
        V.length = 0;
        var ie;
        N.length = 1, N[0] = b;
        for (var B = 0; B < _; ++B)
        ...
        return D.currData ? D.whenDone().then(ae) : ae(q);
      };
      return Fe(c, K);
    }
    var _n = (c, s, f, m, b, w) => {
      ...
      b = ne(m, b), ge([], [c], (v) => {
        ...
        }, ge([], C, (_) => (_.splice(1, 0, null), v.registeredClass.constructor_body[s - 1] = Jt(k, _, null, b, w), [])), [];
      });
    }, Kt = (c, s, f) => (c instanceof Object || x(`${f} with invalid "this": ${c}`), c instanceof s.registeredClass.constructor || x(`${f} incompatible with "this" of type ${c.constructor.name}`), c.$$.ptr || x(`cannot call emscripten binding method ${f} on deleted object`), _e(c.$$.ptr, c.$$.ptrType.registeredClass, s.registeredClass)), Ln = (c, s, f, m, b, w, C, v, k, _) => {
      s = z(s), b = ne(m, b), ge([], [c], (T) => {
        T = T[0];
        var N = `${T.name}.${s}`, V = { get() {
          je(`Cannot access ${N} due to unbound types`, [f, C]);
        }, enumerable: !0, configurable: !0 };
        return k ? V.set = () => je(`Cannot access ${N} due to unbound types`, [f, C]) : V.set = (K) => x(N + " is a read-only property"), Object.defineProperty(T.registeredClass.instancePrototype, s, V), ge([], k ? [f, C] : [f], (K) => {
          var Z = K[0], ie = { get() {
            var q = Kt(this, T, N + " getter");
            return Z.fromWireType(b(w, q));
          }, enumerable: !0 };
          if (k) {
            k = ne(v, k);
            var B = K[1];
      ...
      var s = Y.toValue(c);
      return tt(c), s;
    }, toWireType: (c, s) => Y.toHandle(s), argPackAdvance: J, readValueFromPointer: Le, destructorFunction: null }, Nn = (c) => H(c, xn), Wn = (c, s, f) => {
      switch (s) {
        case 1:
          return f ? function(m) {
      ...
      }, toWireType: (w, C) => C.value, argPackAdvance: J, readValueFromPointer: Wn(s, f, m), destructorFunction: null }), Xe(s, b);
    }, rt = (c, s) => {
      var f = ue[c];
      return f === void 0 && x(`${s} has unknown type ${Vt(c)}`), f;
    }, Vn = (c, s, f) => {
      var m = rt(c, "enum");
      s = z(s);
      ...
      s = z(s), H(c, { name: s, fromWireType: (m) => m, toWireType: (m, b) => b, argPackAdvance: J, readValueFromPointer: Un(s, f), destructorFunction: null });
    }, $n = (c) => {
      c = c.trim();
      const s = c.indexOf("(");
      ...
      var k = Ut(s, f);
      c = z(c), c = $n(c), b = ne(m, b), Xe(c, function() {
        je(`Cannot call ${c} due to unbound types`, k);
      }, s - 1), ge([], k, (_) => {
        var T = [_[0], null].concat(_.slice(1));
        return Wt(c, Jt(c, T, null, b, w), s - 1), [];
      });
    }, Hn = (c, s, f, m, b) => {
      s = z(s);
      var w = (T) => T;
      ...
      var v = s.includes("unsigned"), k = (T, N) => {
      }, _;
      v ? _ = function(T, N) {
        return k(N, this.name), N >>> 0;
      } : _ = function(T, N) {
        return k(N, this.name), N;
      }, H(c, { name: s, fromWireType: w, toWireType: _, argPackAdvance: J, readValueFromPointer: Lt(s, f, m !== 0), destructorFunction: null });
    }, Yn = (c, s, f) => {
      ...
      for (var w = ""; s < b; ) {
        ...
        var k = c[s++] & 63;
        if ((C & 240) == 224 ? C = (C & 15) << 12 | v << 6 | k : C = (C & 7) << 18 | v << 12 | k << 6 | c[s++] & 63, C < 65536)
          w += String.fromCharCode(C);
        else {
          var _ = C - 65536;
      ...
      s = z(s), H(c, { name: s, fromWireType(f) {
        ...
        if (W[C >> 2] = b, w)
          ...
          for (var k = 0; k < b; ++k) {
            ...
            _ > 255 && (ee(C), x("String has UTF-16 code units that do not fit in 8 bits")), $[v + k] = _;
          }
        else
          for (var k = 0; k < b; ++k)
            $[v + k] = m[k];
    ...
    }, qt = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, eo = (c, s) => {
      for (var f = c, m = f >> 1, b = m + s / 2; !(m >= b) && we[m]; ) ++m;
      if (f = m << 1, f - c > 32 && qt) return qt.decode($.subarray(c, f));
      ...
      f = z(f);
      var m, b, w, C;
      s === 2 ? (m = eo, b = to, C = ro, w = (v) => we[v >> 1]) : s === 4 && (m = no, b = oo, C = io, w = (v) => W[v >> 2]), H(c, { name: f, fromWireType: (v) => {
        for (var k = W[v >> 2], _, T = v + 4, N = 0; N <= k; ++N) {
          var V = v + 4 + N * s;
          if (N == k || w(V) == 0) {
            var K = V - T, Z = m(T, K);
        ...
        var _ = C(k), T = nt(4 + _ + s);
        return W[T >> 2] = _ / s, b(k, T + 4, _ + s), v !== null && v.push(ee, T), T;
    ...
    }, uo = (c, s, f) => (c = Y.toValue(c), s = rt(s, "emval::as"), co(s, f, c)), fo = (c, s) => (c = Y.toValue(c), s = Y.toValue(s), Y.toHandle(c[s])), po = {}, mo = (c) => {
      var s = po[c];
      return s === void 0 ? z(c) : s;
    }, yo = (c) => Y.toHandle(mo(c)), ho = (c) => {
      var s = Y.toValue(c);
      Qe(s), tt(c);
    }, go = (c, s) => {
      ...
      return Y.toHandle(f);
    }, Ce = {}, bo = () => performance.now(), vo = (c, s) => {
      if (Ce[c] && (clearTimeout(Ce[c].id), delete Ce[c]), !s) return 0;
      var f = setTimeout(() => {
        delete Ce[c], Yt(() => So(c, bo()));
      }, s);
      return Ce[c] = { id: f, timeout_ms: s }, 0;
    }, Oo = () => 2147483648, wo = (c, s) => Math.ceil(c / s) * s, Po = (c) => {
      var s = A.buffer, f = (c - s.byteLength + 65535) / 65536 | 0;
      try {
        return A.grow(f), Ct(), 1;
      } catch {
      }
    }, Io = (c) => {
      var s = $.length;
      ...
      for (var m = 1; m <= 4; m *= 2) {
        ...
        var w = Math.min(f, wo(Math.max(c, b), 65536)), C = Po(w);
        if (C)
          return !0;
      }
      return !1;
    ...
    }, mn(), In(), zt = t.UnboundTypeError = kn(Error, "UnboundTypeError"), Rn();
    var jo = { n: tn, u: rn, m: an, x: sn, f: An, e: _n, a: Ln, v: Nn, k: zn, g: Vn, l: Gn, b: Bn, d: Hn, c: Yn, w: Qn, h: ao, y: so, r: lo, i: uo, z: tt, j: fo, p: yo, o: ho, A: go, s: vo, t: Io, q: Ht }, R = await qr();
    R.C;
    var Co = R.D, nt = t._malloc = R.E, ee = t._free = R.F, So = R.G;
    ...
    var ko = R.ca, Ao = R.da, Do = R.ea, To = R.fa;
    function ot() {
      if (ce > 0) {
        Pe = ot;
        return;
      ...
      function c() {
        var s;
        t.calledRun = !0, !M && (Vr(), e(t), (s = t.onRuntimeInitialized) == null || s.call(t), Ur());
      }
...
let yi = class extends qo {
  ...
  parseRawData({ rawDetectedPalm: l, rawPalmAttributes: n }) {
    ...
    return {
      ...r,
      smallestEdge: Xo(r),
      handOrientation: this.mapHandValue(n.handOrientation, Ko),
      handPosition: this.mapHandValue(n.handPosition, Jo),
      quality: n.quality / Ue
    };
  }
