...
var No = (c, i, r) => i in c ? xo(c, i, { enumerable: !0, configurable: !0, writable: !0, value: r }) : c[i] = r;
var Ye = (c, i, r) => No(c, typeof i != "symbol" ? i + "" : i, r), mr = (c, i, r) => i.has(c) || fr("Cannot " + r);
var K = (c, i, r) => (mr(c, i, "read from private field"), r ? r.call(c) : i.get(c)), Ze = (c, i, r) => i.has(c) ? fr("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(c) : i.set(c, r), Ke = (c, i, r, t) => (mr(c, i, "write to private field"), t ? t.call(c, r) : i.set(c, r), r);
const hr = {
  simd: "sam_simd.wasm",
  sam: "sam.wasm"
...
class Uo {
  constructor(i, r) {
    ...
    Ze(this, ge);
    Ze(this, je);
    Ke(this, ae, i), Ke(this, ge, this.allocate(r.length * r.BYTES_PER_ELEMENT)), Ke(this, je, this.allocate(r.length * r.BYTES_PER_ELEMENT));
  }
  ...
  allocate(i) {
    return K(this, ae)._malloc(i);
  }
  free() {
    K(this, ae)._free(K(this, ge)), K(this, ae)._free(K(this, je));
  }
  writeDataToMemory(i) {
    K(this, ae).HEAPU8.set(i, K(this, ge));
  }
}
ae = new WeakMap(), ge = new WeakMap(), je = new WeakMap();
class $o {
  constructor() {
    Ye(this, "samWasmModule");
  }
  ...
  async getSamWasmFileName() {
    return await Wo() ? hr.simd : hr.sam;
  }
  ...
  writeImageToMemory(i) {
    ...
    const r = new Uo(this.samWasmModule, i);
...
const qe = (c, i) => Math.hypot(i.x - c.x, i.y - c.y), Go = (c) => {
  const { bottomLeft: i, bottomRight: r, topLeft: t, topRight: e } = c, n = qe(t, e), o = qe(e, r), d = qe(i, r), f = qe(t, i);
  return Math.min(n, o, d, f);
};
var me = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Er = {}, gr = {}, Bo = Ho;
function Ho(c, i) {
    ...
    r[t] = function(f) {
      if (n)
        if (n = !1, f)
          ...
          for (var g = new Array(arguments.length - 1), O = 0; O < g.length; )
            g[O++] = arguments[O];
          o.apply(null, g);
        }
    };
...
(function(c) {
  ...
  i.encode = function(o, d, f) {
    for (var g = null, O = [], j = 0, k = 0, _; d < f; ) {
      var J = o[d++];
      switch (k) {
        case 0:
          O[j++] = r[J >> 2], _ = (J & 3) << 4, k = 1;
          break;
        case 1:
          O[j++] = r[_ | J >> 4], _ = (J & 15) << 2, k = 2;
          break;
        case 2:
          O[j++] = r[_ | J >> 6], O[j++] = r[J & 63], k = 0;
          break;
      }
      j > 8191 && ((g || (g = [])).push(String.fromCharCode.apply(String, O)), j = 0);
    }
    return k && (O[j++] = r[_], O[j++] = 61, k === 1 && (O[j++] = 61)), g ? (j && g.push(String.fromCharCode.apply(String, O.slice(0, j))), g.join("")) : String.fromCharCode.apply(String, O.slice(0, j));
  };
  var n = "invalid encoding";
  i.decode = function(o, d, f) {
    for (var g = f, O = 0, j, k = 0; k < o.length; ) {
      var _ = o.charCodeAt(k++);
      if (_ === 61 && O > 1)
        break;
      if ((_ = t[_]) === void 0)
        throw Error(n);
...
function yr(c) {
  return typeof Float32Array < "u" ? function() {
    ...
    function e(f, g, O) {
      i[0] = f, g[O] = r[0], g[O + 1] = r[1], g[O + 2] = r[2], g[O + 3] = r[3];
    }
    function n(f, g, O) {
      i[0] = f, g[O] = r[3], g[O + 1] = r[2], g[O + 2] = r[1], g[O + 3] = r[0];
    }
    c.writeFloatLE = t ? e : n, c.writeFloatBE = t ? n : e;
    function o(f, g) {
      return r[0] = f[g], r[1] = f[g + 1], r[2] = f[g + 2], r[3] = f[g + 3], i[0];
    }
    function d(f, g) {
      return r[3] = f[g], r[2] = f[g + 1], r[1] = f[g + 2], r[0] = f[g + 3], i[0];
    }
    ...
    function i(t, e, n, o) {
      ...
      if (d && (e = -e), e === 0)
        ...
        var f = Math.floor(Math.log(e) / Math.LN2), g = Math.round(e * Math.pow(2, -f) * 8388608) & 8388607;
        t((d << 31 | f + 127 << 23 | g) >>> 0, n, o);
      }
    }
    c.writeFloatLE = i.bind(null, br), c.writeFloatBE = i.bind(null, vr);
    function r(t, e, n) {
      var o = t(e, n), d = (o >> 31) * 2 + 1, f = o >>> 23 & 255, g = o & 8388607;
      return f === 255 ? g ? NaN : d * (1 / 0) : f === 0 ? d * 1401298464324817e-60 * g : d * Math.pow(2, f - 150) * (g + 8388608);
    }
    c.readFloatLE = r.bind(null, Or), c.readFloatBE = r.bind(null, wr);
  }(), typeof Float64Array < "u" ? function() {
    var i = new Float64Array([-0]), r = new Uint8Array(i.buffer), t = r[7] === 128;
    function e(f, g, O) {
      i[0] = f, g[O] = r[0], g[O + 1] = r[1], g[O + 2] = r[2], g[O + 3] = r[3], g[O + 4] = r[4], g[O + 5] = r[5], g[O + 6] = r[6], g[O + 7] = r[7];
    }
    function n(f, g, O) {
      i[0] = f, g[O] = r[7], g[O + 1] = r[6], g[O + 2] = r[5], g[O + 3] = r[4], g[O + 4] = r[3], g[O + 5] = r[2], g[O + 6] = r[1], g[O + 7] = r[0];
    }
    c.writeDoubleLE = t ? e : n, c.writeDoubleBE = t ? n : e;
    function o(f, g) {
      return r[0] = f[g], r[1] = f[g + 1], r[2] = f[g + 2], r[3] = f[g + 3], r[4] = f[g + 4], r[5] = f[g + 5], r[6] = f[g + 6], r[7] = f[g + 7], i[0];
    }
    function d(f, g) {
      return r[7] = f[g], r[6] = f[g + 1], r[5] = f[g + 2], r[4] = f[g + 3], r[3] = f[g + 4], r[2] = f[g + 5], r[1] = f[g + 6], r[0] = f[g + 7], i[0];
    }
    ...
    function i(t, e, n, o, d, f) {
      ...
      if (g && (o = -o), o === 0)
        ...
        t(0, d, f + e), t((g << 31 | 2146435072) >>> 0, d, f + n);
      else {
        var O;
        if (o < 22250738585072014e-324)
          O = o / 5e-324, t(O >>> 0, d, f + e), t((g << 31 | O / 4294967296) >>> 0, d, f + n);
        else {
          var j = Math.floor(Math.log(o) / Math.LN2);
          j === 1024 && (j = 1023), O = o * Math.pow(2, -j), t(O * 4503599627370496 >>> 0, d, f + e), t((g << 31 | j + 1023 << 20 | O * 1048576 & 1048575) >>> 0, d, f + n);
        }
      }
    }
    c.writeDoubleLE = i.bind(null, br, 0, 4), c.writeDoubleBE = i.bind(null, vr, 4, 0);
    function r(t, e, n, o, d) {
      var f = t(o, d + e), g = t(o, d + n), O = (g >> 31) * 2 + 1, j = g >>> 20 & 2047, k = 4294967296 * (g & 1048575) + f;
      return j === 2047 ? k ? NaN : O * (1 / 0) : j === 0 ? O * 5e-324 * k : O * Math.pow(2, j - 1075) * (k + 4503599627370496);
    }
    c.readDoubleLE = r.bind(null, Or, 0, 4), c.readDoubleBE = r.bind(null, wr, 4, 0);
  }(), c;
}
function br(c, i, r) {
...
(function(c) {
  ...
  i.length = function(r) {
    ...
    if (n < 1)
      return "";
    for (var o = null, d = [], f = 0, g; t < e; )
      g = r[t++], g < 128 ? d[f++] = g : g > 191 && g < 224 ? d[f++] = (g & 31) << 6 | r[t++] & 63 : g > 239 && g < 365 ? (g = ((g & 7) << 18 | (r[t++] & 63) << 12 | (r[t++] & 63) << 6 | r[t++] & 63) - 65536, d[f++] = 55296 + (g >> 10), d[f++] = 56320 + (g & 1023)) : d[f++] = (g & 15) << 12 | (r[t++] & 63) << 6 | r[t++] & 63, f > 8191 && ((o || (o = [])).push(String.fromCharCode.apply(String, d)), f = 0);
...
function be() {
  return Ir || (Ir = 1, function(c) {
    var i = c;
    i.asPromise = Bo, i.base64 = Fr, i.EventEmitter = Vo, i.float = Jo, i.inquire = Yo, i.utf8 = _r, i.pool = Ko, i.LongBits = Xo(), i.isNode = !!(typeof me < "u" && me && me.process && me.process.versions && me.process.versions.node), i.global = i.isNode && me || typeof window < "u" && window || typeof self < "u" && self || me, i.emptyArray = Object.freeze ? Object.freeze([]) : (
...
var Mr = F, B = be(), Ot, it = B.LongBits, Sr = B.base64, Cr = B.utf8;
function ke(c, i, r) {
...
function F() {
  this.len = 0, this.head = new ke(It, 0, 0), this.tail = this.head, this.states = null;
}
var Rr = function() {
...
F.prototype._push = function(c, i, r) {
  return this.tail = this.tail.next = new ke(c, i, r), this.len += i, this;
};
function St(c, i, r) {
  i[r] = c & 255;
}
...
Ct.prototype = Object.create(ke.prototype);
Ct.prototype.fn = ei;
F.prototype.uint32 = function(c) {
  return this.len += (this.tail = this.tail.next = new Ct(
    (c = c >>> 0) < 128 ? 1 : c < 16384 ? 2 : c < 2097152 ? 3 : c < 268435456 ? 4 : 5,
    c
  )).len, this;
};
F.prototype.int32 = function(c) {
  return c < 0 ? this._push(At, 10, it.fromNumber(c)) : this.uint32(c);
};
...
F.prototype.uint64 = function(c) {
  var i = it.from(c);
  return this._push(At, i.length(), i);
};
...
var ti = B.Array.prototype.set ? function(c, i, r) {
  i.set(c, r);
} : function(c, i, r) {
...
F.prototype.bytes = function(c) {
  var i = c.length >>> 0;
  if (!i)
    return this._push(St, 1, 0);
  if (B.isString(c)) {
    var r = F.alloc(i = Sr.length(c));
    Sr.decode(c, r, 0), c = r;
  }
  return this.uint32(i)._push(ti, i, c);
};
F.prototype.string = function(c) {
  var i = Cr.length(c);
  return i ? this.uint32(i)._push(Cr.write, i, c) : this._push(St, 1, 0);
};
F.prototype.fork = function() {
  return this.states = new Qo(this), this.head = this.tail = new ke(It, 0, 0), this.len = 0, this;
};
F.prototype.reset = function() {
  return this.states ? (this.head = this.states.head, this.tail = this.states.tail, this.len = this.states.len, this.states = this.states.next) : (this.head = this.tail = new ke(It, 0, 0), this.len = 0), this;
};
...
F._configure = function(c) {
  Ot = c, F.create = Rr(), Ot._configure();
};
var ri = q, Lr = Mr;
(q.prototype = Object.create(Lr.prototype)).constructor = q;
var se = be();
function q() {
  Lr.call(this);
}
...
q.prototype.string = function(c) {
  ...
  return this.uint32(i), i && this._push(ni, i, c), this;
};
q._configure();
var xr = R, X = be(), Pt, Nr = X.LongBits, oi = X.utf8;
function V(c, i) {
...
var Ar = typeof Uint8Array < "u" ? function(c) {
  ...
  return X.Buffer ? function(c) {
    return (R.create = function(i) {
      return X.Buffer.isBuffer(i) ? new Pt(i) : Ar(i);
    })(c);
  } : Ar;
};
R.create = Wr();
...
R.prototype.fixed32 = function() {
  if (this.pos + 4 > this.len)
    throw V(this, 4);
  return et(this.buf, this.pos += 4);
};
R.prototype.sfixed32 = function() {
  if (this.pos + 4 > this.len)
    throw V(this, 4);
  return et(this.buf, this.pos += 4) | 0;
};
function Dr() {
  if (this.pos + 8 > this.len)
    throw V(this, 8);
  return new Nr(et(this.buf, this.pos += 4), et(this.buf, this.pos += 4));
}
...
R._configure = function(c) {
  Pt = c, R.create = Wr(), Pt._configure();
  var i = X.Long ? "toLong" : (
    /* istanbul ignore next */
    "toNumber"
  );
  X.merge(R.prototype, {
    ...
    sfixed64: function() {
      return Dr.call(this)[i](!1);
    }
  });
};
var ii = ye, zr = xr;
(ye.prototype = Object.create(zr.prototype)).constructor = ye;
var Tr = be();
function ye(c) {
  zr.call(this, c);
}
ye._configure = function() {
  Tr.Buffer && (ye.prototype._slice = Tr.Buffer.prototype.slice);
};
...
ye._configure();
var Ur = {}, ai = Te, Dt = be();
(Te.prototype = Object.create(Dt.EventEmitter.prototype)).constructor = Te;
function Te(c, i, r) {
  if (typeof c != "function")
    throw TypeError("rpcImpl must be a function");
  Dt.EventEmitter.call(this), this.rpcImpl = c, this.requestDelimited = !!i, this.responseDelimited = !!r;
}
Te.prototype.rpcCall = function c(i, r, t, e, n) {
  if (!e)
    throw TypeError("request must be specified");
  var o = this;
  if (!n)
    return Dt.asPromise(c, o, i, r, t, e);
  if (!o.rpcImpl) {
    setTimeout(function() {
...
(function(c) {
  var i = c;
  i.build = "minimal", i.Writer = Mr, i.BufferWriter = ri, i.Reader = xr, i.BufferReader = ii, i.util = be(), i.rpc = Ur, i.roots = si, i.configure = r;
  function r() {
  ...
  return c.Content = function() {
    ...
    return i.MagnifEyeLivenessContent = function() {
      ...
      return Object.defineProperty(r.prototype, "_device", {
        ...
        e instanceof h || (e = h.create(e));
        let o = n === void 0 ? e.len : e.pos + n, d = new a.dot.v4.AndroidMetadata(), f, g;
        for (; e.pos < o; ) {
          let O = e.uint32();
          switch (O >>> 3) {
            case 1: {
            ...
            case 4: {
              ...
              for (f = "", g = null; e.pos < j; ) {
                ...
                switch (k >>> 3) {
                  case 1:
                    ...
                    break;
                  case 2:
                    g = a.dot.Int32List.decode(e, e.uint32());
                    break;
                  default:
                    e.skipType(k & 7);
                    break;
              ...
              d.dynamicCameraFrameProperties[f] = g;
              break;
            }
            case 8: {
      ...
      return Object.defineProperty(r.prototype, "_camera", {
        ...
        e instanceof h || (e = h.create(e));
        let o = n === void 0 ? e.len : e.pos + n, d = new a.dot.v4.IosMetadata(), f, g;
        for (; e.pos < o; ) {
          let O = e.uint32();
          switch (O >>> 3) {
            case 1: {
 ...
 */
const $r = Symbol("Comlink.proxy"), li = Symbol("Comlink.endpoint"), ci = Symbol("Comlink.releaseProxy"), vt = Symbol("Comlink.finalizer"), Qe = Symbol("Comlink.thrown"), Gr = (c) => typeof c == "object" && c !== null || typeof c == "function", di = {
  canHandle: (c) => Gr(c) && c[$r],
  serialize(c) {
...
function Tt(c, i = globalThis, r = ["*"]) {
  i.addEventListener("message", function t(e) {
    ...
    let g;
    try {
      const O = d.slice(0, -1).reduce((k, _) => k[_], c), j = d.reduce((k, _) => k[_], c);
      switch (o) {
        case "GET":
          g = j;
          break;
        case "SET":
          O[d.slice(-1)[0]] = he(e.data.value), g = !0;
          break;
        case "APPLY":
          g = j.apply(O, f);
          break;
        ...
        case "ENDPOINT":
          {
            const { port1: k, port2: _ } = new MessageChannel();
            Tt(c, _), g = bi(k, [k]);
          }
          break;
        case "RELEASE":
    ...
    Promise.resolve(g).catch((O) => ({ value: O, [Qe]: 0 })).then((O) => {
      const [j, k] = nt(O);
      i.postMessage(Object.assign(Object.assign({}, j), { id: n }), k), o === "RELEASE" && (i.removeEventListener("message", t), Hr(i), vt in c && typeof c[vt] == "function" && c[vt]());
    }).catch((O) => {
      const [j, k] = nt({
        value: new TypeError("Unserializable return value"),
        [Qe]: 0
      });
      i.postMessage(Object.assign(Object.assign({}, j), { id: n }), k);
    });
  }), i.start && i.start();
}
function fi(c) {
...
const tt = /* @__PURE__ */ new WeakMap(), rt = "FinalizationRegistry" in globalThis && new FinalizationRegistry((c) => {
  const i = (tt.get(c) || 0) - 1;
  tt.set(c, i), i === 0 && Vr(c);
});
function hi(c, i) {
  const r = (tt.get(i) || 0) + 1;
  tt.set(i, r), rt && rt.register(c, i, c);
}
function gi(c) {
  rt && rt.unregister(c);
}
function jt(c, i = [], r = function() {
}) {
  let t = !1;
  const e = new Proxy(r, {
    get(n, o) {
...
function kr(c) {
  const i = c.map(nt);
  return [i.map((r) => r[0]), yi(i.map((r) => r[1]))];
}
...
function he(c) {
  switch (c.type) {
    case "HANDLER":
      return Br.get(c.name).deserialize(c.value);
    case "RAW":
      return c.value;
  }
}
...
var wi = (() => {
  ...
  return async function(i = {}) {
    ...
    var _, J;
    (d || f) && (f ? j = self.location.href : typeof document < "u" && document.currentScript && (j = document.currentScript.src), c && (j = c), j.startsWith("blob:") ? j = "" : j = j.slice(0, j.replace(/[?#].*/, "").lastIndexOf("/") + 1), f && (J = (l) => {
      ...
      if (Mt(l))
        return new Promise((u, m) => {
          ...
          y.open("GET", l, !0), y.responseType = "arraybuffer", y.onload = () => {
    ...
    var Ee = t.printErr || console.error.bind(console);
    Object.assign(t, g), g = null, t.arguments && t.arguments, t.thisProgram && t.thisProgram;
    var Fe = t.wasmBinary, _e, le = !1, Me, ce, $, Ie, Re, de, L, kt, Et, Ft, _t, Mt = (l) => l.startsWith("file://");
    function Rt() {
      var l = _e.buffer;
      t.HEAP8 = ce = new Int8Array(l), t.HEAP16 = Ie = new Int16Array(l), t.HEAPU8 = $ = new Uint8Array(l), t.HEAPU16 = Re = new Uint16Array(l), t.HEAP32 = de = new Int32Array(l), t.HEAPU32 = L = new Uint32Array(l), t.HEAPF32 = kt = new Float32Array(l), t.HEAPF64 = _t = new Float64Array(l), t.HEAP64 = Et = new BigInt64Array(l), t.HEAPU64 = Ft = new BigUint64Array(l);
    }
    function Yr() {
      if (t.preRun)
    ...
    function Le(l) {
      var u;
      (u = t.onAbort) == null || u.call(t, l), l = "Aborted(" + l + ")", Ee(l), le = !0, l += ". Build with -sASSERTIONS for more info.";
    ...
    async function rn(l, s) {
      try {
        var u = await tn(l), m = await WebAssembly.instantiate(u, s);
        return m;
      } catch (y) {
        Ee(`failed to asynchronously prepare wasm: ${y}`), Le(y);
      }
    }
    async function nn(l, s, u) {
      if (!l && typeof WebAssembly.instantiateStreaming == "function" && !Mt(s))
        try {
          var m = fetch(s, { credentials: "same-origin" }), y = await WebAssembly.instantiateStreaming(m, u);
          return y;
        } catch (v) {
          Ee(`wasm streaming compile failed: ${v}`), Ee("falling back to ArrayBuffer instantiation");
        }
      return rn(s, u);
    }
    function on() {
    ...
    async function an() {
      function l(v, w) {
        return A = v.exports, A = I.instrumentWasmExports(A), _e = A.z, Rt(), A.F, Xr(), A;
      }
      qr();
      function s(v) {
        return l(v.instance);
    ...
    var xt = (l) => {
      for (; l.length > 0; )
        l.shift()(t);
    }, Nt = [], sn = (l) => Nt.unshift(l), Wt = [], ln = (l) => Wt.unshift(l), zt = t.noExitRuntime || !0;
    class cn {
      constructor(s) {
    ...
    var Ut = 0, dn = (l, s, u) => {
      ...
      function m(b) {
        var P = u(b);
        P.length !== l.length && We("Mismatched type converter count");
        for (var C = 0; C < l.length; ++C)
          Y(l[C], P[C]);
      }
      var y = new Array(s.length), v = [], w = 0;
      s.forEach((b, P) => {
        pe.hasOwnProperty(b) ? y[P] = pe[b] : (v.push(b), ve.hasOwnProperty(b) || (ve[b] = []), ve[b].push(() => {
          y[P] = pe[b], ++w, w === v.length && m(y);
        }));
      }), v.length === 0 && m(y);
    };
    function fn(l, s, u = {}) {
      var m = s.name;
      if (l || T(`type "${m}" must have a positive integer typeid pointer`), pe.hasOwnProperty(l)) {
        if (u.ignoreDuplicateRegistrations)
          return;
        T(`Cannot register type '${m}' twice`);
      }
      if (pe[l] = s, delete Ne[l], ve.hasOwnProperty(l)) {
        var y = ve[l];
        delete ve[l], y.forEach((v) => v());
      }
    }
    function Y(l, s, u = {}) {
      return fn(l, s, u);
    ...
    var Bt = (l, s, u) => {
      switch (s) {
        case 1:
          return u ? (m) => ce[m] : (m) => $[m];
        case 2:
          return u ? (m) => Ie[m >> 1] : (m) => Re[m >> 1];
        case 4:
          return u ? (m) => de[m >> 2] : (m) => L[m >> 2];
        case 8:
          return u ? (m) => Et[m >> 3] : (m) => Ft[m >> 3];
        default:
      ...
      Y(l, { name: s, fromWireType: (w) => w, toWireType: function(w, b) {
        if (typeof b != "bigint" && typeof b != "number")
          throw new TypeError(`Cannot convert "${xe(b)}" to ${this.name}`);
        return typeof b == "number" && (b = BigInt(b)), b;
      }, argPackAdvance: Q, readValueFromPointer: Bt(s, u, !v), destructorFunction: null });
    }, Q = 8, hn = (l, s, u, m) => {
      s = z(s), Y(l, { name: s, fromWireType: function(y) {
        return !!y;
      }, toWireType: function(y, v) {
        return v ? u : m;
      }, argPackAdvance: Q, readValueFromPointer: function(y) {
        return this.fromWireType($[y]);
      }, destructorFunction: null });
    }, gn = (l) => ({ count: l.count, deleteScheduled: l.deleteScheduled, preservePointerOnDelete: l.preservePointerOnDelete, ptr: l.ptr, ptrType: l.ptrType, smartPtr: l.smartPtr, smartPtrType: l.smartPtrType }), st = (l) => {
      function s(u) {
        return u.$$.ptrType.registeredClass.name;
      }
      T(s(l) + " instance already deleted");
    }, lt = !1, Ht = (l) => {
    }, yn = (l) => {
      ...
      if (u.baseClass === void 0)
        return null;
      var m = Jt(l, s, u.baseClass);
      return m === null ? null : u.downcast(m);
    }, Yt = {}, bn = {}, vn = (l, s) => {
      for (s === void 0 && T("ptr should not be undefined"); l.baseClass; )
        s = l.upcast(s), l = l.baseClass;
      return s;
    }, On = (l, s) => (s = vn(l, s), bn[s]), ze = (l, s) => {
      (!s.ptrType || !s.ptr) && We("makeClassHandle requires ptr and ptrType");
      var u = !!s.smartPtrType, m = !!s.smartPtr;
      return u !== m && We("Both smartPtrType and smartPtr must be specified"), s.count = { value: 1 }, Ce(Object.create(l, { $$: { value: s, writable: !0 } }));
    };
    function wn(l) {
      var s = this.getPointee(l);
      if (!s)
        return this.destructor(l), null;
      var u = On(this.registeredClass, s);
      if (u !== void 0) {
        if (u.$$.count.value === 0)
      ...
      function y() {
        return this.isSmartPointer ? ze(this.registeredClass.instancePrototype, { ptrType: this.pointeeType, ptr: s, smartPtrType: this, smartPtr: l }) : ze(this.registeredClass.instancePrototype, { ptrType: this, ptr: l });
      }
      var v = this.registeredClass.getActualType(s), w = Yt[v];
      if (!w)
        return y.call(this);
      var b;
      this.isConst ? b = w.constPointerType : b = w.pointerType;
      var P = Jt(s, this.registeredClass, b.registeredClass);
      return P === null ? y.call(this) : this.isSmartPointer ? ze(b.registeredClass.instancePrototype, { ptrType: b, ptr: P, smartPtrType: this, smartPtr: l }) : ze(b.registeredClass.instancePrototype, { ptrType: b, ptr: P });
    }
    var Ce = (l) => typeof FinalizationRegistry > "u" ? (Ce = (s) => s, l) : (lt = new FinalizationRegistry((s) => {
      ...
      return s;
    }, Ht = (s) => lt.unregister(s), Ce(l)), Ue = [], Pn = () => {
      for (; Ue.length; ) {
        var l = Ue.pop();
        l.$$.deleteScheduled = !1, l.delete();
      }
    }, Zt, jn = () => {
      Object.assign($e.prototype, { isAliasOf(l) {
        if (!(this instanceof $e) || !(l instanceof $e))
          return !1;
        var s = this.$$.ptrType.registeredClass, u = this.$$.ptr;
        l.$$ = l.$$;
        for (var m = l.$$.ptrType.registeredClass, y = l.$$.ptr; s.baseClass; )
          u = s.upcast(u), s = s.baseClass;
        for (; m.baseClass; )
          y = m.upcast(y), m = m.baseClass;
        return s === m && u === y;
      }, clone() {
        if (this.$$.ptr || st(this), this.$$.preservePointerOnDelete)
          return this.$$.count.value += 1, this;
        var l = Ce(Object.create(Object.getPrototypeOf(this), { $$: { value: gn(this.$$) } }));
        return l.$$.count.value += 1, l.$$.deleteScheduled = !1, l;
      }, delete() {
        this.$$.ptr || st(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && T("Object already scheduled for deletion"), Ht(this), Vt(this.$$), this.$$.preservePointerOnDelete || (this.$$.smartPtr = void 0, this.$$.ptr = void 0);
      }, isDeleted() {
        return !this.$$.ptr;
      }, deleteLater() {
        return this.$$.ptr || st(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && T("Object already scheduled for deletion"), Ue.push(this), Ue.length === 1 && Zt && Zt(Pn), this.$$.deleteScheduled = !0, this;
      } });
    };
    function $e() {
    }
    var ct = (l, s) => Object.defineProperty(s, "name", { value: l }), In = (l, s, u) => {
      if (l[s].overloadTable === void 0) {
        var m = l[s];
        l[s] = function(...y) {
          return l[s].overloadTable.hasOwnProperty(y.length) || T(`Function '${u}' called with an invalid number of arguments (${y.length}) - expects one of (${l[s].overloadTable})!`), l[s].overloadTable[y.length].apply(this, y);
        }, l[s].overloadTable = [], l[s].overloadTable[m.argCount] = m;
      }
    }, Kt = (l, s, u) => {
      t.hasOwnProperty(l) ? ((u === void 0 || t[l].overloadTable !== void 0 && t[l].overloadTable[u] !== void 0) && T(`Cannot register public name '${l}' twice`), In(t, l, l), t[l].overloadTable.hasOwnProperty(u) && T(`Cannot register multiple overloads of a function with the same number of arguments (${u})!`), t[l].overloadTable[u] = s) : (t[l] = s, t[l].argCount = u);
    }, Sn = 48, Cn = 57, An = (l) => {
      l = l.replace(/[^a-zA-Z0-9_]/g, "$");
      var s = l.charCodeAt(0);
      return s >= Sn && s <= Cn ? `_${l}` : l;
    };
    function Dn(l, s, u, m, y, v, w, b) {
      this.name = l, this.constructor = s, this.instancePrototype = u, this.rawDestructor = m, this.baseClass = y, this.getActualType = v, this.upcast = w, this.downcast = b, this.pureVirtualFunctions = [];
    }
    var Ge = (l, s, u) => {
      for (; s !== u; )
        s.upcast || T(`Expected null or instance of ${u.name}, got an instance of ${s.name}`), l = s.upcast(l), s = s.baseClass;
      return l;
    };
    function Tn(l, s) {
      if (s === null)
        return this.isReference && T(`null is not a valid ${this.name}`), 0;
      s.$$ || T(`Cannot pass "${xe(s)}" as a ${this.name}`), s.$$.ptr || T(`Cannot pass deleted object as a pointer of type ${this.name}`);
      var u = s.$$.ptrType.registeredClass, m = Ge(s.$$.ptr, u, this.registeredClass);
      return m;
    }
    function kn(l, s) {
      var u;
      if (s === null)
        return this.isReference && T(`null is not a valid ${this.name}`), this.isSmartPointer ? (u = this.rawConstructor(), l !== null && l.push(this.rawDestructor, u), u) : 0;
      (!s || !s.$$) && T(`Cannot pass "${xe(s)}" as a ${this.name}`), s.$$.ptr || T(`Cannot pass deleted object as a pointer of type ${this.name}`), !this.isConst && s.$$.ptrType.isConst && T(`Cannot convert argument of type ${s.$$.smartPtrType ? s.$$.smartPtrType.name : s.$$.ptrType.name} to parameter type ${this.name}`);
      var m = s.$$.ptrType.registeredClass;
      if (u = Ge(s.$$.ptr, m, this.registeredClass), this.isSmartPointer)
        switch (s.$$.smartPtr === void 0 && T("Passing raw pointer to smart pointer is illegal"), this.sharingPolicy) {
          case 0:
            s.$$.smartPtrType === this ? u = s.$$.smartPtr : T(`Cannot convert argument of type ${s.$$.smartPtrType ? s.$$.smartPtrType.name : s.$$.ptrType.name} to parameter type ${this.name}`);
            break;
          case 1:
            u = s.$$.smartPtr;
            break;
          case 2:
            if (s.$$.smartPtrType === this)
              ...
              var y = s.clone();
              u = this.rawShare(u, H.toHandle(() => y.delete())), l !== null && l.push(this.rawDestructor, u);
            }
            break;
          default:
    ...
    function En(l, s) {
      if (s === null)
        return this.isReference && T(`null is not a valid ${this.name}`), 0;
      s.$$ || T(`Cannot pass "${xe(s)}" as a ${this.name}`), s.$$.ptr || T(`Cannot pass deleted object as a pointer of type ${this.name}`), s.$$.ptrType.isConst && T(`Cannot convert argument of type ${s.$$.ptrType.name} to parameter type ${this.name}`);
      var u = s.$$.ptrType.registeredClass, m = Ge(s.$$.ptr, u, this.registeredClass);
      return m;
    }
    function Be(l) {
    ...
    var Fn = () => {
      Object.assign(He.prototype, { getPointee(l) {
        return this.rawGetPointee && (l = this.rawGetPointee(l)), l;
      }, destructor(l) {
        var s;
        (s = this.rawDestructor) == null || s.call(this, l);
      }, argPackAdvance: Q, readValueFromPointer: Be, fromWireType: wn });
    };
    function He(l, s, u, m, y, v, w, b, P, C, S) {
      this.name = l, this.registeredClass = s, this.isReference = u, this.isConst = m, this.isSmartPointer = y, this.pointeeType = v, this.sharingPolicy = w, this.rawGetPointee = b, this.rawConstructor = P, this.rawShare = C, this.rawDestructor = S, !y && s.baseClass === void 0 ? m ? (this.toWireType = Tn, this.destructorFunction = null) : (this.toWireType = En, this.destructorFunction = null) : this.toWireType = kn;
    }
    var qt = (l, s, u) => {
      t.hasOwnProperty(l) || We("Replacing nonexistent public symbol"), t[l].overloadTable !== void 0 && u !== void 0 ? t[l].overloadTable[u] = s : (t[l] = s, t[l].argCount = u);
    }, _n = (l, s, u) => {
      l = l.replace(/p/g, "i");
      var m = t["dynCall_" + l];
      return m(s, ...u);
      ...
      var m = _n(l, s, u);
      return m;
    }, Rn = (l, s) => (...u) => Mn(l, s, u), ne = (l, s) => {
      l = z(l);
      function u() {
        return Rn(l, s);
      }
      var m = u();
      return typeof m != "function" && T(`unknown function pointer with signature ${l}: ${s}`), m;
    }, Ln = (l, s) => {
      var u = ct(s, function(m) {
        this.name = s, this.message = m;
        var y = new Error(m).stack;
...
` + y.replace(/^Error(:[^\n]*)?\n/, ""));
      ...
      throw s.forEach(y), new Xt(`${l}: ` + u.map(Qt).join([", "]));
    }, xn = (l, s, u, m, y, v, w, b, P, C, S, M, x) => {
      S = z(S), v = ne(y, v), b && (b = ne(w, b)), C && (C = ne(P, C)), x = ne(M, x);
      var U = An(S);
      Kt(U, function() {
        ...
        Z = Z[0];
        var ie, te;
        m ? (ie = Z.registeredClass, te = ie.instancePrototype) : te = $e.prototype;
        var W = ct(S, function(...gt) {
          ...
          var pr = N.constructor_body[gt.length];
          if (pr === void 0)
            throw new Oe(`Tried to invoke ctor of ${S} with invalid number of parameters (${gt.length}) - expected (${Object.keys(N.constructor_body).toString()}) parameters instead!`);
          return pr.apply(this, gt);
        }), fe = Object.create(te, { constructor: { value: W } });
        W.prototype = fe;
        var N = new Dn(S, W, fe, x, ie, v, b, C);
        N.baseClass && ((ur = N.baseClass).__derivedClasses ?? (ur.__derivedClasses = []), N.baseClass.__derivedClasses.push(N));
        var ht = new He(S, N, !0, !1, !1), re = new He(S + "*", N, !1, !1, !1), Je = new He(S + " const*", N, !1, !0, !1);
        return Yt[l] = { pointerType: re, constPointerType: Je }, qt(U, W), [ht, re, Je];
      });
    }, er = (l, s) => {
      for (var u = [], m = 0; m < l; m++)
        u.push(L[s + m * 4 >> 2]);
    ...
    var Ve = (l) => {
      ...
      if (l instanceof Lt || l == "unwind")
        return Me;
      O(1, l);
    }, rr = 0, nr = () => zt || rr > 0, or = (l) => {
      var s;
      Me = l, nr() || ((s = t.onExit) == null || s.call(t, l), le = !0), O(l, new Lt(l));
    }, Wn = (l, s) => {
      Me = l, or(l);
    }, zn = Wn, Un = () => {
      if (!nr())
      ...
      I.currData && I.state === I.State.Unwinding && I.exportCallStack.length === 0 && (I.state = I.State.Normal, Ve(Mo), typeof Fibers < "u" && Fibers.trampoline());
    }, whenDone() {
        ...
        if (I.state === I.State.Normal) {
          ...
          l((m = 0) => {
            if (!le && (I.handleSleepReturnValue = m, s = !0, !!u)) {
              I.state = I.State.Rewinding, Ve(() => Ro(I.currData)), typeof MainLoop < "u" && MainLoop.func && MainLoop.resume();
              var y, v = !1;
              try {
                y = I.doRewind(I.currData);
              } catch (P) {
                y = P, v = !0;
              }
              var w = !1;
              if (!I.currData) {
                ...
                b && (I.asyncPromiseHandlers = null, (v ? b.reject : b.resolve)(y), w = !0);
              }
              if (v && !w)
                throw y;
            }
          }), u = !0, s || (I.state = I.State.Unwinding, I.currData = I.allocateData(), typeof MainLoop < "u" && MainLoop.func && MainLoop.pause(), Ve(() => _o(I.currData)));
        } else I.state === I.State.Rewinding ? (I.state = I.State.Normal, Ve(Lo), ee(I.currData), I.currData = null, I.sleepCallbacks.forEach(ir)) : Le(`invalid state: ${I.state}`);
    ...
    function ar(l, s, u, m, y, v) {
      var w = s.length;
      w < 2 && T("argTypes array size mismatch! Must at least get return value and 'this' types!");
      var b = s[1] !== null && u !== null, P = Nn(s), C = s[0].name !== "void", S = w - 2, M = new Array(S), x = [], U = [], Z = function(...ie) {
        U.length = 0;
        var te;
        x.length = b ? 2 : 1, x[0] = y, b && (te = s[1].toWireType(U, this), x[1] = te);
        for (var W = 0; W < S; ++W)
        ...
        function N(ht) {
          if (P)
            ...
            for (var re = b ? 1 : 2; re < s.length; re++) {
              var Je = re === 1 ? te : M[re - 2];
              s[re].destructorFunction !== null && s[re].destructorFunction(Je);
            }
          if (C)
    ...
    var $n = (l, s, u, m, y, v) => {
      ...
      y = ne(m, y), we([], [l], (b) => {
        ...
        }, we([], w, (C) => (C.splice(1, 0, null), b.registeredClass.constructor_body[s - 1] = ar(P, C, null, y, v), [])), [];
      });
    }, sr = (l, s, u) => (l instanceof Object || T(`${u} with invalid "this": ${l}`), l instanceof s.registeredClass.constructor || T(`${u} incompatible with "this" of type ${l.constructor.name}`), l.$$.ptr || T(`cannot call emscripten binding method ${u} on deleted object`), Ge(l.$$.ptr, l.$$.ptrType.registeredClass, s.registeredClass)), Gn = (l, s, u, m, y, v, w, b, P, C) => {
      s = z(s), y = ne(m, y), we([], [l], (S) => {
        S = S[0];
        var M = `${S.name}.${s}`, x = { get() {
          Ae(`Cannot access ${M} due to unbound types`, [u, w]);
        }, enumerable: !0, configurable: !0 };
        return P ? x.set = () => Ae(`Cannot access ${M} due to unbound types`, [u, w]) : x.set = (U) => T(M + " is a read-only property"), Object.defineProperty(S.registeredClass.instancePrototype, s, x), we([], P ? [u, w] : [u], (U) => {
          var Z = U[0], ie = { get() {
            var W = sr(this, S, M + " getter");
            return Z.fromWireType(y(v, W));
          }, enumerable: !0 };
          if (P) {
            P = ne(b, P);
            var te = U[1];
            ie.set = function(W) {
              var fe = sr(this, S, M + " setter"), N = [];
    ...
    }, Bn = () => oe.length / 2 - 5 - ut.length, Hn = () => {
      oe.push(0, 1, void 0, 1, null, 1, !0, 1, !1, 1), t.count_emval_handles = Bn;
    }, H = { toValue: (l) => (l || T("Cannot use deleted val. handle = " + l), oe[l]), toHandle: (l) => {
      switch (l) {
        case void 0:
          return 2;
        case null:
    ...
    } }, Vn = { name: "emscripten::val", fromWireType: (l) => {
      var s = H.toValue(l);
      return pt(l), s;
    }, toWireType: (l, s) => H.toHandle(s), argPackAdvance: Q, readValueFromPointer: Be, destructorFunction: null }, Jn = (l) => Y(l, Vn), Yn = (l, s) => {
      switch (s) {
        case 4:
          return function(u) {
            return this.fromWireType(kt[u >> 2]);
          };
        case 8:
          return function(u) {
            return this.fromWireType(_t[u >> 3]);
          };
        default:
          throw new TypeError(`invalid float width (${s}): ${l}`);
      }
    }, Zn = (l, s, u) => {
      s = z(s), Y(l, { name: s, fromWireType: (m) => m, toWireType: (m, y) => y, argPackAdvance: Q, readValueFromPointer: Yn(s, u), destructorFunction: null });
    }, Kn = (l) => {
      l = l.trim();
      const s = l.indexOf("(");
      ...
      }, Y(l, { name: s, fromWireType: v, toWireType: C, argPackAdvance: Q, readValueFromPointer: Bt(s, u, m !== 0), destructorFunction: null });
    }, Qn = (l, s, u) => {
      var m = [Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array, BigInt64Array, BigUint64Array], y = m[s];
      function v(w) {
        var b = L[w >> 2], P = L[w + 4 >> 2];
        return new y(ce.buffer, P, b);
      }
      u = z(u), Y(l, { name: u, fromWireType: v, argPackAdvance: Q, readValueFromPointer: v }, { ignoreDuplicateRegistrations: !0 });
    }, eo = (l, s, u, m) => {
      if (!(m > 0)) return 0;
      for (var y = u, v = u + m - 1, w = 0; w < l.length; ++w) {
      ...
      return s[u] = 0, u - y;
    }, to = (l, s, u) => eo(l, $, s, u), ro = (l) => {
      for (var s = 0, u = 0; u < l.length; ++u) {
        var m = l.charCodeAt(u);
        m <= 127 ? s++ : m <= 2047 ? s += 2 : m >= 55296 && m <= 57343 ? (s += 4, ++u) : s += 3;
      }
      return s;
    }, lr = typeof TextDecoder < "u" ? new TextDecoder() : void 0, no = (l, s = 0, u = NaN) => {
      for (var m = s + u, y = s; l[y] && !(y >= m); ) ++y;
      if (y - s > 16 && l.buffer && lr)
        return lr.decode(l.subarray(s, y));
      for (var v = ""; s < y; ) {
        var w = l[s++];
        if (!(w & 128)) {
      ...
      return v;
    }, oo = (l, s) => l ? no($, l, s) : "", io = (l, s) => {
      s = z(s), Y(l, { name: s, fromWireType(u) {
        for (var m = L[u >> 2], y = u + 4, v, w, b = y, w = 0; w <= m; ++w) {
          var P = y + w;
          if (w == m || $[P] == 0) {
            var C = P - b, S = oo(b, C);
        ...
        var y, v = typeof m == "string";
        v || m instanceof Uint8Array || m instanceof Uint8ClampedArray || m instanceof Int8Array || T("Cannot pass non-string to std::string"), v ? y = ro(m) : y = m.length;
        var w = ft(4 + y + 1), b = w + 4;
        if (L[w >> 2] = y, v)
          to(m, b, y + 1);
        else if (v)
          for (var P = 0; P < y; ++P) {
            var C = m.charCodeAt(P);
            C > 255 && (ee(w), T("String has UTF-16 code units that do not fit in 8 bits")), $[b + P] = C;
          }
        else
          for (var P = 0; P < y; ++P)
            $[b + P] = m[P];
        return u !== null && u.push(ee, w), w;
      }, argPackAdvance: Q, readValueFromPointer: Be, destructorFunction(u) {
        ee(u);
      } });
    }, cr = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, ao = (l, s) => {
      for (var u = l, m = u >> 1, y = m + s / 2; !(m >= y) && Re[m]; ) ++m;
      if (u = m << 1, u - l > 32 && cr) return cr.decode($.subarray(l, u));
      ...
      u -= 2;
      for (var m = s, y = u < l.length * 2 ? u / 2 : l.length, v = 0; v < y; ++v) {
        var w = l.charCodeAt(v);
        Ie[s >> 1] = w, s += 2;
      }
      return Ie[s >> 1] = 0, s - m;
    }, lo = (l) => l.length * 2, co = (l, s) => {
      for (var u = 0, m = ""; !(u >= s / 4); ) {
        var y = de[l + u * 4 >> 2];
        if (y == 0) break;
        if (++u, y >= 65536) {
      ...
      for (var m = s, y = m + u - 4, v = 0; v < l.length; ++v) {
        var w = l.charCodeAt(v);
        if (w >= 55296 && w <= 57343) {
          var b = l.charCodeAt(++v);
          w = 65536 + ((w & 1023) << 10) | b & 1023;
        }
        if (de[s >> 2] = w, s += 4, s + 4 > y) break;
      }
      return de[s >> 2] = 0, s - m;
    }, po = (l) => {
      for (var s = 0, u = 0; u < l.length; ++u) {
      ...
      u = z(u);
      var m, y, v, w;
      s === 2 ? (m = ao, y = so, w = lo, v = (b) => Re[b >> 1]) : s === 4 && (m = co, y = uo, w = po, v = (b) => L[b >> 2]), Y(l, { name: u, fromWireType: (b) => {
        for (var P = L[b >> 2], C, S = b + 4, M = 0; M <= P; ++M) {
          var x = b + 4 + M * s;
          if (M == P || v(x) == 0) {
            var U = x - S, Z = m(S, U);
            C === void 0 ? C = Z : (C += "\0", C += Z), S = x + s;
          }
        }
        return ee(b), C;
      }, toWireType: (b, P) => {
        typeof P != "string" && T(`Cannot pass non-string to C++ string type ${u}`);
        var C = w(P), S = ft(4 + C + s);
        return L[S >> 2] = C / s, y(P, S + 4, C + s), b !== null && b.push(ee, S), S;
      }, argPackAdvance: Q, readValueFromPointer: Be, destructorFunction(b) {
        ee(b);
      } });
    }, mo = (l, s) => {
      ...
      var u = pe[l];
      return u === void 0 && T(`${s} has unknown type ${Qt(l)}`), u;
    }, go = (l, s, u) => {
      var m = [], y = l.toWireType(m, u);
      return m.length && (L[s >> 2] = H.toHandle(m)), y;
    }, yo = (l, s, u) => (l = H.toValue(l), s = dr(s, "emval::as"), go(s, u, l)), bo = (l, s) => (l = H.toValue(l), s = H.toValue(s), H.toHandle(l[s])), vo = {}, Oo = (l) => {
      var s = vo[l];
      return s === void 0 ? z(l) : s;
    }, wo = (l) => H.toHandle(Oo(l)), Po = (l) => {
      var s = H.toValue(l);
      dt(s), pt(l);
    }, jo = (l, s) => {
      l = dr(l, "_emval_take_value");
      var u = l.readValueFromPointer(s);
      return H.toHandle(u);
    }, De = {}, Io = () => performance.now(), So = (l, s) => {
      if (De[l] && (clearTimeout(De[l].id), delete De[l]), !s) return 0;
      var u = setTimeout(() => {
        delete De[l], ir(() => Fo(l, Io()));
      }, s);
      return De[l] = { id: u, timeout_ms: s }, 0;
    }, Co = () => 2147483648, Ao = (l, s) => Math.ceil(l / s) * s, Do = (l) => {
      var s = _e.buffer, u = (l - s.byteLength + 65535) / 65536 | 0;
      try {
        return _e.grow(u), Rt(), 1;
      } catch {
      }
    }, To = (l) => {
      var s = $.length;
      ...
      for (var m = 1; m <= 4; m *= 2) {
        ...
        var v = Math.min(u, Ao(Math.max(l, y), 65536)), w = Do(v);
        if (w)
          return !0;
      }
      return !1;
    };
    pn(), Oe = t.BindingError = class extends Error {
      constructor(s) {
        super(s), this.name = "BindingError";
      }
    }, Gt = t.InternalError = class extends Error {
      constructor(s) {
        super(s), this.name = "InternalError";
      }
    }, jn(), Fn(), Xt = t.UnboundTypeError = Ln(Error, "UnboundTypeError"), Hn();
    var ko = { h: dn, t: un, l: mn, w: hn, f: xn, e: $n, a: Gn, u: Jn, k: Zn, b: qn, d: Xn, c: Qn, v: io, g: fo, x: mo, q: ho, i: yo, y: pt, j: bo, o: wo, n: Po, m: jo, r: So, s: To, p: or }, A = await an();
    A.A;
    var Eo = A.B, ft = t._malloc = A.C, ee = t._free = A.D, Fo = A.E;
    ...
    var _o = A.aa, Mo = A.ba, Ro = A.ca, Lo = A.da;
    function mt() {
      if (ue > 0) {
        Se = mt;
        return;
      ...
      function l() {
        var s;
        t.calledRun = !0, !le && (Zr(), e(t), (s = t.onRuntimeInitialized) == null || s.call(t), Kr());
      }
...
class Pi extends $o {
  getSamWasmFilePath(i, r) {
    return `${i}/palm/wasm/${r}`;
  }
  fetchSamModule(i) {
    return wi(i);
  }
  parseRawData(i) {
    const { brightness: r, sharpness: t } = i.params, e = {
  ...
  async detect(i, r) {
    if (!this.samWasmModule)
      throw new G("SAM WASM module is not initialized");
    const t = this.convertToSamColorImage(i, r), e = this.samWasmModule.detectPalmWithImageParameters(
      r.width,
      r.height,
      t.bgr0ImagePointer,
      0,
