...
var ci = (() => {
  ...
  return async function(c = {}) {
    ...
    var w = t.wasmBinary, D, M = !1, X, se, G, Oe, Ce, le, W, bt, vt, Ot, wt, Pt = (s) => s.startsWith("file://");
    function jt() {
      var s = D.buffer;
      t.HEAP8 = se = new Int8Array(s), t.HEAP16 = Oe = new Int16Array(s), t.HEAPU8 = G = new Uint8Array(s), t.HEAPU16 = Ce = new Uint16Array(s), t.HEAP32 = le = new Int32Array(s), t.HEAPU32 = W = new Uint32Array(s), t.HEAPF32 = bt = new Float32Array(s), t.HEAPF64 = wt = new Float64Array(s), t.HEAP64 = vt = new BigInt64Array(s), t.HEAPU64 = Ot = new BigUint64Array(s);
    }
    function Wr() {
      if (t.preRun)
    ...
    async function Yr(s, a) {
      try {
        var f = await Hr(s), h = await WebAssembly.instantiate(f, a);
        return h;
      } catch (b) {
        E(`failed to asynchronously prepare wasm: ${b}`), Ae(b);
      }
    }
    async function Jr(s, a, f) {
      if (!s && typeof WebAssembly.instantiateStreaming == "function" && !Pt(a))
        try {
          var h = fetch(a, { credentials: "same-origin" }), b = await WebAssembly.instantiateStreaming(h, f);
          return b;
        } catch (j) {
          E(`wasm streaming compile failed: ${j}`), E("falling back to ArrayBuffer instantiation");
        }
      return Yr(a, f);
    }
    function Kr() {
    ...
    async function Zr() {
      function s(j, C) {
        return R = j.exports, R = k.instrumentWasmExports(R), D = R.z, jt(), R.F, Gr(), R;
      }
      $r();
      function a(j) {
        return s(j.instance);
      ...
      He ?? (He = Br());
      try {
        var h = await Jr(w, He, f), b = a(h);
        return b;
      } catch (j) {
        return r(j), Promise.reject(j);
      }
    }
    class It {
      constructor(a) {
    ...
    var St = (s) => {
      for (; s.length > 0; )
        s.shift()(t);
    }, Ct = [], qr = (s) => Ct.unshift(s), At = [], Xr = (s) => At.unshift(s), Dt = t.noExitRuntime || !0;
    class Qr {
      constructor(a) {
    ...
    var kt = 0, en = (s, a, f) => {
      ...
      var b = new Array(a.length), j = [], C = 0;
      a.forEach((v, A) => {
        de.hasOwnProperty(v) ? b[A] = de[v] : (j.push(v), me.hasOwnProperty(v) || (me[v] = []), me[v].push(() => {
          b[A] = de[v], ++C, C === j.length && h(b);
        }));
      }), j.length === 0 && h(b);
    };
    function nn(s, a, f = {}) {
    ...
    var Ft = (s, a, f) => {
      switch (a) {
        ...
        case 2:
          return f ? (h) => Oe[h >> 1] : (h) => Ce[h >> 1];
        case 4:
          return f ? (h) => le[h >> 2] : (h) => W[h >> 2];
        case 8:
          return f ? (h) => vt[h >> 3] : (h) => Ot[h >> 3];
        default:
      ...
      }, argPackAdvance: Q, readValueFromPointer: Ft(a, f, !j), destructorFunction: null });
    }, Q = 8, an = (s, a, f, h) => {
      a = $(a), Y(s, { name: a, fromWireType: function(b) {
        return !!b;
      }, toWireType: function(b, j) {
        return j ? f : h;
      }, argPackAdvance: Q, readValueFromPointer: function(b) {
        return this.fromWireType(G[b]);
      }, destructorFunction: null });
    }, sn = (s) => ({ count: s.count, deleteScheduled: s.deleteScheduled, preservePointerOnDelete: s.preservePointerOnDelete, ptr: s.ptr, ptrType: s.ptrType, smartPtr: s.smartPtr, smartPtrType: s.smartPtrType }), Ye = (s) => {
      function a(f) {
    ...
    function fn(s) {
      ...
      var f = un(this.registeredClass, a);
      if (f !== void 0) {
        if (f.$$.count.value === 0)
      ...
      function b() {
        return this.isSmartPointer ? Ee(this.registeredClass.instancePrototype, { ptrType: this.pointeeType, ptr: a, smartPtrType: this, smartPtr: s }) : Ee(this.registeredClass.instancePrototype, { ptrType: this, ptr: s });
      }
      var j = this.registeredClass.getActualType(a), C = Lt[j];
      if (!C)
        return b.call(this);
      var v;
      this.isConst ? v = C.constPointerType : v = C.pointerType;
      var A = Rt(a, this.registeredClass, v.registeredClass);
      return A === null ? b.call(this) : this.isSmartPointer ? Ee(v.registeredClass.instancePrototype, { ptrType: v, ptr: A, smartPtrType: this, smartPtr: s }) : Ee(v.registeredClass.instancePrototype, { ptrType: v, ptr: A });
    }
    var Pe = (s) => typeof FinalizationRegistry > "u" ? (Pe = (a) => a, s) : (Je = new FinalizationRegistry((a) => {
      Mt(a.$$);
    }), Pe = (a) => {
      ...
      return a;
    }, _t = (a) => Je.unregister(a), Pe(s)), pn = () => {
      Object.assign(Fe.prototype, { isAliasOf(s) {
        if (!(this instanceof Fe) || !(s instanceof Fe))
          return !1;
        ...
        var s = Pe(Object.create(Object.getPrototypeOf(this), { $$: { value: sn(this.$$) } }));
        return s.$$.count.value += 1, s.$$.deleteScheduled = !1, s;
      }, delete() {
        this.$$.ptr || Ye(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && x("Object already scheduled for deletion"), _t(this), Mt(this.$$), this.$$.preservePointerOnDelete || (this.$$.smartPtr = void 0, this.$$.ptr = void 0);
      }, isDeleted() {
        return !this.$$.ptr;
      }, deleteLater() {
        return this.$$.ptr || Ye(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && x("Object already scheduled for deletion"), this.$$.deleteScheduled = !0, this;
      } });
    };
    function Fe() {
    }
    var Ke = (s, a) => Object.defineProperty(a, "name", { value: s }), mn = (s, a, f) => {
      ...
      t.hasOwnProperty(s) ? ((f === void 0 || t[s].overloadTable !== void 0 && t[s].overloadTable[f] !== void 0) && x(`Cannot register public name '${s}' twice`), mn(t, s, s), t[s].overloadTable.hasOwnProperty(f) && x(`Cannot register multiple overloads of a function with the same number of arguments (${f})!`), t[s].overloadTable[f] = a) : (t[s] = a, t[s].argCount = f);
    }, hn = 48, yn = 57, gn = (s) => {
      s = s.replace(/[^a-zA-Z0-9_]/g, "$");
      var a = s.charCodeAt(0);
      return a >= hn && a <= yn ? `_${s}` : s;
    };
    function bn(s, a, f, h, b, j, C, v) {
      this.name = s, this.constructor = a, this.instancePrototype = f, this.rawDestructor = h, this.baseClass = b, this.getActualType = j, this.upcast = C, this.downcast = v, this.pureVirtualFunctions = [];
    }
    var _e = (s, a, f) => {
      for (; a !== f; )
    ...
    function vn(s, a) {
      ...
      var f = a.$$.ptrType.registeredClass, h = _e(a.$$.ptr, f, this.registeredClass);
      return h;
    }
    function On(s, a) {
      var f;
      ...
      if (f = _e(a.$$.ptr, h, this.registeredClass), this.isSmartPointer)
    ...
    var Pn = () => {
      Object.assign(Re.prototype, { getPointee(s) {
        return this.rawGetPointee && (s = this.rawGetPointee(s)), s;
      }, destructor(s) {
        var a;
        (a = this.rawDestructor) == null || a.call(this, s);
      }, argPackAdvance: Q, readValueFromPointer: Me, fromWireType: fn });
    };
    function Re(s, a, f, h, b, j, C, v, A, F, T) {
      this.name = s, this.registeredClass = a, this.isReference = f, this.isConst = h, this.isSmartPointer = b, this.pointeeType = j, this.sharingPolicy = C, this.rawGetPointee = v, this.rawConstructor = A, this.rawShare = F, this.rawDestructor = T, !b && a.baseClass === void 0 ? h ? (this.toWireType = vn, this.destructorFunction = null) : (this.toWireType = wn, this.destructorFunction = null) : this.toWireType = On;
    }
    var Nt = (s, a, f) => {
...
` + b.replace(/^Error(:[^\n]*)?\n/, ""));
      ...
      throw a.forEach(b), new Wt(`${s}: ` + f.map(zt).join([", "]));
    }, An = (s, a, f, h, b, j, C, v, A, F, T, N, z) => {
      T = $(T), j = te(b, j), v && (v = te(C, v)), F && (F = te(A, F)), z = te(N, z);
      var J = gn(T);
      xt(J, function() {
        je(`Cannot construct ${T} due to unbound types`, [h]);
      }), ye([s, a, f], h ? [h] : [], (K) => {
        var Qt;
        K = K[0];
        var ne, B;
        h ? (ne = K.registeredClass, B = ne.instancePrototype) : B = Fe.prototype;
        var Z = Ke(T, function(...tt) {
          ...
          var er = U.constructor_body[tt.length];
          if (er === void 0)
            throw new he(`Tried to invoke ctor of ${T} with invalid number of parameters (${tt.length}) - expected (${Object.keys(U.constructor_body).toString()}) parameters instead!`);
          return er.apply(this, tt);
        }), oe = Object.create(B, { constructor: { value: Z } });
        Z.prototype = oe;
        var U = new bn(T, Z, oe, z, ne, j, v, F);
        U.baseClass && ((Qt = U.baseClass).__derivedClasses ?? (Qt.__derivedClasses = []), U.baseClass.__derivedClasses.push(U));
        var ie = new Re(T, U, !0, !1, !1), xe = new Re(T + "*", U, !1, !1, !1), Xt = new Re(T + " const*", U, !1, !0, !1);
        return Lt[s] = { pointerType: xe, constPointerType: Xt }, Nt(J, Z), [ie, xe, Xt];
      });
    }, Ut = (s, a) => {
      for (var f = [], h = 0; h < s; h++)
        f.push(W[a + h * 4 >> 2]);
    ...
    var Le = (s) => {
      ...
      if (s instanceof It || s == "unwind")
        return X;
      S(1, s);
    }, Gt = 0, Bt = () => Dt || Gt > 0, Vt = (s) => {
      var a;
      X = s, Bt() || ((a = t.onExit) == null || a.call(t, s), M = !0), S(s, new It(s));
    }, kn = (s, a) => {
      X = s, Vt(s);
    }, Tn = kn, En = () => {
      if (!Bt())
      ...
      var a = k.callStackNameToId[s];
      return a === void 0 && (a = k.callStackId++, k.callStackNameToId[s] = a, k.callStackIdToName[a] = s), a;
    }, maybeStopUnwind() {
      k.currData && k.state === k.State.Unwinding && k.exportCallStack.length === 0 && (k.state = k.State.Normal, Le(Io), typeof Fibers < "u" && Fibers.trampoline());
    }, whenDone() {
      return new Promise((s, a) => {
        k.asyncPromiseHandlers = { resolve: s, reject: a };
      });
    }, allocateData() {
      var s = Qe(12 + k.StackSize);
      return k.setDataHeader(s, s + 12, k.StackSize), k.setDataRewindFunc(s), s;
    }, setDataHeader(s, a, f) {
      W[s >> 2] = a, W[s + 4 >> 2] = a + f;
    }, setDataRewindFunc(s) {
      ...
      var a = le[s + 8 >> 2], f = k.callStackIdToName[a];
      return f;
    }, getDataRewindFunc(s) {
      var a = R[s];
      return a;
    }, doRewind(s) {
      var a = k.getDataRewindFuncName(s), f = k.getDataRewindFunc(a);
      return f();
    }, handleSleep(s) {
      if (!M) {
        if (k.state === k.State.Normal) {
          var a = !1, f = !1;
          s((h = 0) => {
            if (!M && (k.handleSleepReturnValue = h, a = !0, !!f)) {
              k.state = k.State.Rewinding, Le(() => So(k.currData)), typeof MainLoop < "u" && MainLoop.func && MainLoop.resume();
              var b, j = !1;
              try {
              ...
              if (!k.currData) {
                ...
                v && (k.asyncPromiseHandlers = null, (j ? v.reject : v.resolve)(b), C = !0);
              }
              if (j && !C)
                throw b;
            }
          }), f = !0, a || (k.state = k.State.Unwinding, k.currData = k.allocateData(), typeof MainLoop < "u" && MainLoop.func && MainLoop.pause(), Le(() => jo(k.currData)));
        } else k.state === k.State.Rewinding ? (k.state = k.State.Normal, Le(Co), ee(k.currData), k.currData = null, k.sleepCallbacks.forEach(Ht)) : Ae(`invalid state: ${k.state}`);
    ...
    function Yt(s, a, f, h, b, j) {
      var C = a.length;
      C < 2 && x("argTypes array size mismatch! Must at least get return value and 'this' types!"), a[1];
      var v = Dn(a), A = a[0].name !== "void", F = C - 2, T = new Array(F), N = [], z = [], J = function(...K) {
        z.length = 0;
        var ne;
        N.length = 1, N[0] = b;
        for (var B = 0; B < F; ++B)
          T[B] = a[B + 2].toWireType(z, K[B]), N.push(T[B]);
        var Z = h(...N);
        function oe(U) {
          if (v)
            Ze(z);
            ...
            for (var ie = 2; ie < a.length; ie++) {
              var xe = ie === 1 ? ne : T[ie - 2];
              a[ie].destructorFunction !== null && a[ie].destructorFunction(xe);
            }
          if (A)
            return a[0].fromWireType(U);
        }
        return k.currData ? k.whenDone().then(oe) : oe(Z);
      };
      return Ke(s, J);
    }
    var Fn = (s, a, f, h, b, j) => {
      ...
      b = te(h, b), ye([], [s], (v) => {
        ...
        }, ye([], C, (F) => (F.splice(1, 0, null), v.registeredClass.constructor_body[a - 1] = Yt(A, F, null, b, j), [])), [];
      });
    }, Jt = (s, a, f) => (s instanceof Object || x(`${f} with invalid "this": ${s}`), s instanceof a.registeredClass.constructor || x(`${f} incompatible with "this" of type ${s.constructor.name}`), s.$$.ptr || x(`cannot call emscripten binding method ${f} on deleted object`), _e(s.$$.ptr, s.$$.ptrType.registeredClass, a.registeredClass)), _n = (s, a, f, h, b, j, C, v, A, F) => {
      a = $(a), b = te(h, b), ye([], [s], (T) => {
        T = T[0];
        var N = `${T.name}.${a}`, z = { get() {
          je(`Cannot access ${N} due to unbound types`, [f, C]);
        }, enumerable: !0, configurable: !0 };
        return A ? z.set = () => je(`Cannot access ${N} due to unbound types`, [f, C]) : z.set = (J) => x(N + " is a read-only property"), Object.defineProperty(T.registeredClass.instancePrototype, a, z), ye([], A ? [f, C] : [f], (J) => {
          var K = J[0], ne = { get() {
            var Z = Jt(this, T, N + " getter");
            return K.fromWireType(b(j, Z));
          }, enumerable: !0 };
          if (A) {
            A = te(v, A);
            var B = J[1];
            ne.set = function(Z) {
              var oe = Jt(this, T, N + " setter"), U = [];
              A(F, oe, B.toWireType(U, Z)), Ze(U);
            };
          }
          return Object.defineProperty(T.registeredClass.instancePrototype, a, ne), [];
        }), [];
      });
    }, qe = [], re = [], Xe = (s) => {
      s > 9 && --re[s + 1] === 0 && (re[s] = void 0, qe.push(s));
    }, Mn = () => re.length / 2 - 5 - qe.length, Rn = () => {
      re.push(0, 1, void 0, 1, null, 1, !0, 1, !1, 1), t.count_emval_handles = Mn;
    ...
    } }, Ln = { name: "emscripten::val", fromWireType: (s) => {
      var a = H.toValue(s);
      return Xe(s), a;
    }, toWireType: (s, a) => H.toHandle(a), argPackAdvance: Q, readValueFromPointer: Me, destructorFunction: null }, xn = (s) => Y(s, Ln), Nn = (s, a) => {
      switch (a) {
        case 4:
          return function(f) {
            return this.fromWireType(bt[f >> 2]);
          };
        case 8:
          return function(f) {
            return this.fromWireType(wt[f >> 3]);
          };
        default:
          throw new TypeError(`invalid float width (${a}): ${s}`);
      }
    }, Wn = (s, a, f) => {
      a = $(a), Y(s, { name: a, fromWireType: (h) => h, toWireType: (h, b) => b, argPackAdvance: Q, readValueFromPointer: Nn(a, f), destructorFunction: null });
    }, zn = (s) => {
      s = s.trim();
      const a = s.indexOf("(");
      ...
      var A = Ut(a, f);
      s = $(s), s = zn(s), b = te(h, b), xt(s, function() {
        je(`Cannot call ${s} due to unbound types`, A);
      }, a - 1), ye([], A, (F) => {
        var T = [F[0], null].concat(F.slice(1));
        return Nt(s, Yt(s, T, null, b, j), a - 1), [];
      });
    }, $n = (s, a, f, h, b) => {
      a = $(a);
      var j = (T) => T;
      ...
      var v = a.includes("unsigned"), A = (T, N) => {
      }, F;
      v ? F = function(T, N) {
        return A(N, this.name), N >>> 0;
      } : F = function(T, N) {
        return A(N, this.name), N;
      }, Y(s, { name: a, fromWireType: j, toWireType: F, argPackAdvance: Q, readValueFromPointer: Ft(a, f, h !== 0), destructorFunction: null });
    }, Gn = (s, a, f) => {
      ...
      f = $(f), Y(s, { name: f, fromWireType: j, argPackAdvance: Q, readValueFromPointer: j }, { ignoreDuplicateRegistrations: !0 });
    }, Bn = (s, a, f, h) => {
      if (!(h > 0)) return 0;
      for (var b = f, j = f + h - 1, C = 0; C < s.length; ++C) {
      ...
      return a[f] = 0, f - b;
    }, Vn = (s, a, f) => Bn(s, G, a, f), Hn = (s) => {
      for (var a = 0, f = 0; f < s.length; ++f) {
        var h = s.charCodeAt(f);
        h <= 127 ? a++ : h <= 2047 ? a += 2 : h >= 55296 && h <= 57343 ? (a += 4, ++f) : a += 3;
      }
      return a;
    }, Kt = typeof TextDecoder < "u" ? new TextDecoder() : void 0, Yn = (s, a = 0, f = NaN) => {
      for (var h = a + f, b = a; s[b] && !(b >= h); ) ++b;
      if (b - a > 16 && s.buffer && Kt)
        return Kt.decode(s.subarray(a, b));
      for (var j = ""; a < b; ) {
        var C = s[a++];
        if (!(C & 128)) {
        ...
        var v = s[a++] & 63;
        if ((C & 224) == 192) {
          j += String.fromCharCode((C & 31) << 6 | v);
          continue;
        }
        var A = s[a++] & 63;
        if ((C & 240) == 224 ? C = (C & 15) << 12 | v << 6 | A : C = (C & 7) << 18 | v << 12 | A << 6 | s[a++] & 63, C < 65536)
          ...
          var F = C - 65536;
          j += String.fromCharCode(55296 | F >> 10, 56320 | F & 1023);
        }
      }
      return j;
    }, Jn = (s, a) => s ? Yn(G, s, a) : "", Kn = (s, a) => {
      a = $(a), Y(s, { name: a, fromWireType(f) {
        for (var h = W[f >> 2], b = f + 4, j, C, v = b, C = 0; C <= h; ++C) {
          var A = b + C;
          if (C == h || G[A] == 0) {
            var F = A - v, T = Jn(v, F);
            j === void 0 ? j = T : (j += "\0", j += T), v = A + 1;
          }
        }
        return ee(f), j;
      }, toWireType(f, h) {
        h instanceof ArrayBuffer && (h = new Uint8Array(h));
        var b, j = typeof h == "string";
        j || h instanceof Uint8Array || h instanceof Uint8ClampedArray || h instanceof Int8Array || x("Cannot pass non-string to std::string"), j ? b = Hn(h) : b = h.length;
      ...
      }, argPackAdvance: Q, readValueFromPointer: Me, destructorFunction(f) {
        ee(f);
      } });
    }, Zt = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, Zn = (s, a) => {
      for (var f = s, h = f >> 1, b = h + a / 2; !(h >= b) && Ce[h]; ) ++h;
      if (f = h << 1, f - s > 32 && Zt) return Zt.decode(G.subarray(s, f));
      for (var j = "", C = 0; !(C >= a / 2); ++C) {
        var v = Oe[s + C * 2 >> 1];
        if (v == 0) break;
        j += String.fromCharCode(v);
      }
      return j;
    }, qn = (s, a, f) => {
      if (f ?? (f = 2147483647), f < 2) return 0;
      f -= 2;
      for (var h = a, b = f < s.length * 2 ? f / 2 : s.length, j = 0; j < b; ++j) {
        var C = s.charCodeAt(j);
        Oe[a >> 1] = C, a += 2;
      }
      return Oe[a >> 1] = 0, a - h;
    }, Xn = (s) => s.length * 2, Qn = (s, a) => {
      for (var f = 0, h = ""; !(f >= a / 4); ) {
        var b = le[s + f * 4 >> 2];
        if (b == 0) break;
        if (++f, b >= 65536) {
          var j = b - 65536;
          h += String.fromCharCode(55296 | j >> 10, 56320 | j & 1023);
        } else
      ...
      for (var h = a, b = h + f - 4, j = 0; j < s.length; ++j) {
        var C = s.charCodeAt(j);
        if (C >= 55296 && C <= 57343) {
          var v = s.charCodeAt(++j);
      ...
      f = $(f);
      var h, b, j, C;
      a === 2 ? (h = Zn, b = qn, C = Xn, j = (v) => Ce[v >> 1]) : a === 4 && (h = Qn, b = eo, C = to, j = (v) => W[v >> 2]), Y(s, { name: f, fromWireType: (v) => {
        for (var A = W[v >> 2], F, T = v + 4, N = 0; N <= A; ++N) {
          var z = v + 4 + N * a;
          if (N == A || j(z) == 0) {
            var J = z - T, K = h(T, J);
            F === void 0 ? F = K : (F += "\0", F += K), T = z + a;
          }
        }
        return ee(v), F;
      }, toWireType: (v, A) => {
        typeof A != "string" && x(`Cannot pass non-string to C++ string type ${f}`);
        var F = C(A), T = Qe(4 + F + a);
        return W[T >> 2] = F / a, b(A, T + 4, F + a), v !== null && v.push(ee, T), T;
      }, argPackAdvance: Q, readValueFromPointer: Me, destructorFunction(v) {
        ee(v);
      } });
    }, no = (s, a) => {
      ...
      var f = de[s];
      return f === void 0 && x(`${a} has unknown type ${zt(s)}`), f;
    }, io = (s, a, f) => {
      var h = [], b = s.toWireType(h, f);
      return h.length && (W[a >> 2] = H.toHandle(h)), b;
    }, ao = (s, a, f) => (s = H.toValue(s), a = qt(a, "emval::as"), io(a, f, s)), so = (s, a) => (s = H.toValue(s), a = H.toValue(a), H.toHandle(s[a])), lo = {}, co = (s) => {
      var a = lo[s];
      return a === void 0 ? $(s) : a;
    }, uo = (s) => H.toHandle(co(s)), fo = (s) => {
      var a = H.toValue(s);
      Ze(a), Xe(s);
    }, po = (s, a) => {
      ...
      return H.toHandle(f);
    }, Ie = {}, mo = () => performance.now(), ho = (s, a) => {
      if (Ie[s] && (clearTimeout(Ie[s].id), delete Ie[s]), !a) return 0;
      var f = setTimeout(() => {
        delete Ie[s], Ht(() => Po(s, mo()));
      }, a);
      return Ie[s] = { id: f, timeout_ms: a }, 0;
    }, yo = () => 2147483648, go = (s, a) => Math.ceil(s / a) * a, bo = (s) => {
      ...
      for (var h = 1; h <= 4; h *= 2) {
        ...
        var j = Math.min(f, go(Math.max(s, b), 65536)), C = bo(j);
        if (C)
          return !0;
      }
      return !1;
    ...
    }, Et = t.InternalError = class extends Error {
      constructor(a) {
        super(a), this.name = "InternalError";
      }
    }, pn(), Pn(), Wt = t.UnboundTypeError = Cn(Error, "UnboundTypeError"), Rn();
    var Oo = { h: en, t: tn, l: on, w: an, f: An, e: Fn, a: _n, u: xn, k: Wn, b: Un, d: $n, c: Gn, v: Kn, g: ro, x: no, q: oo, i: ao, y: Xe, j: so, o: uo, n: fo, m: po, r: ho, s: vo, p: Vt }, R = await Zr();
    R.A;
    var wo = R.B, Qe = t._malloc = R.C, ee = t._free = R.D, Po = R.E;
    ...
    var jo = R.aa, Io = R.ba, So = R.ca, Co = R.da;
    function et() {
      if (ce > 0) {
        we = et;
        return;
      ...
      function s() {
        var a;
        t.calledRun = !0, !M && (zr(), e(t), (a = t.onRuntimeInitialized) == null || a.call(t), Ur());
      }
...
function ui(p, c) {
  if (p.confidence <= 0 || c.confidence <= 0)
    return { x: 0, y: 0 };
  const n = Nr(p.center, c.center), t = di(p.center, c.center);
  return {
    x: t.x,
    y: t.y + n / 4
...
function fi(p, c, n) {
  if (p.confidence <= 0 || c.confidence <= 0)
    return 0;
  const t = Nr(p.center, c.center), e = Yo(n.width, n.height);
  return Ho(t / e);
}
function ht(p) {
...
let pi = class extends Vo {
  ...
  parseRawData(c, n) {
    const { brightness: t, sharpness: e } = c.params, { bottomRightX: r, bottomRightY: o, leftEye: d, mouth: l, rightEye: y, topLeftX: S, topLeftY: m } = c, O = ht(d), P = ht(y), I = ht(l);
    return {
