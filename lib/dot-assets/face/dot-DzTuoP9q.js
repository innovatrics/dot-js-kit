 ...
 */
const Tr = Symbol("Comlink.proxy"), Fo = Symbol("Comlink.endpoint"), _o = Symbol("Comlink.releaseProxy"), $e = Symbol("Comlink.finalizer"), Ge = Symbol("Comlink.thrown"), Er = (p) => typeof p == "object" && p !== null || typeof p == "function", Mo = {
...
function vt(p, c = globalThis, n = ["*"]) {
  c.addEventListener("message", function t(e) {
    ...
    Promise.resolve(g).catch((C) => ({ value: C, [Ge]: 0 })).then((C) => {
      const [y, O] = Ye(C);
      c.postMessage(Object.assign(Object.assign({}, y), { id: r }), O), o === "RELEASE" && (c.removeEventListener("message", t), _r(c), $e in p && typeof p[$e] == "function" && p[$e]());
    }).catch((C) => {
      const [y, O] = Ye({
...
const Be = /* @__PURE__ */ new WeakMap(), He = "FinalizationRegistry" in globalThis && new FinalizationRegistry((p) => {
  const c = (Be.get(p) || 0) - 1;
  Be.set(p, c), c === 0 && Mr(p);
});
function Wo(p, c) {
  const n = (Be.get(c) || 0) + 1;
  Be.set(c, n), He && He.register(p, c, p);
}
function zo(p) {
  He && He.unregister(p);
}
...
var fi = (() => {
  ...
  return async function(c = {}) {
    ...
    }, sn = (l) => ({ count: l.count, deleteScheduled: l.deleteScheduled, preservePointerOnDelete: l.preservePointerOnDelete, ptr: l.ptr, ptrType: l.ptrType, smartPtr: l.smartPtr, smartPtrType: l.smartPtrType }), Ke = (l) => {
      function s(f) {
    ...
    var Ie = (l) => typeof FinalizationRegistry > "u" ? (Ie = (s) => s, l) : (Ze = new FinalizationRegistry((s) => {
      Rt(s.$$);
    }), Ie = (s) => {
      ...
      Object.assign(Fe.prototype, { isAliasOf(l) {
        ...
        this.$$.ptr || Ke(this), this.$$.deleteScheduled && !this.$$.preservePointerOnDelete && x("Object already scheduled for deletion"), Lt(this), Rt(this.$$), this.$$.preservePointerOnDelete || (this.$$.smartPtr = void 0, this.$$.ptr = void 0);
      }, isDeleted() {
        return !this.$$.ptr;
      }, deleteLater() {
...
` + b.replace(/^Error(:[^\n]*)?\n/, ""));
      ...
      qe(K, function() {
        ...
        var q = _e(T, function(...ot) {
          ...
          var er = U.constructor_body[ot.length];
          if (er === void 0)
            throw new he(`Tried to invoke ctor of ${T} with invalid number of parameters (${ot.length}) - expected (${Object.keys(U.constructor_body).toString()}) parameters instead!`);
          return er.apply(this, ot);
    ...
    var Fn = (l, s, f, m, b, P) => {
      ...
      l > 9 && --oe[l + 1] === 0 && (oe[l] = void 0, Qe.push(l));
    }, Mn = () => oe.length / 2 - 5 - Qe.length, Ln = () => {
      ...
      }, toWireType: (P, S) => S.value, argPackAdvance: J, readValueFromPointer: Nn(s, f, m), destructorFunction: null }), qe(s, b);
    }, tt = (l, s) => {
      var f = ue[l];
      ...
      var D = Ut(s, f);
      l = z(l), l = $n(l), b = ne(m, b), qe(l, function() {
    ...
    }, co = (l, s, f) => (l = Y.toValue(l), s = tt(s, "emval::as"), lo(s, f, l)), uo = (l, s) => (l = Y.toValue(l), s = Y.toValue(s), Y.toHandle(l[s])), fo = {}, po = (l) => {
      var s = fo[l];
    ...
    var Io = { n: en, u: tn, m: on, x: an, f: Dn, e: Fn, a: _n, v: xn, k: Wn, g: zn, l: Un, b: Gn, d: Bn, c: Hn, w: Xn, h: io, y: ao, r: so, i: co, z: et, j: uo, p: mo, o: yo, A: ho, s: bo, t: Po, q: Ht }, R = await Zr();
    R.C;
    var jo = R.D, rt = t._malloc = R.E, ee = t._free = R.F, Co = R.G;
